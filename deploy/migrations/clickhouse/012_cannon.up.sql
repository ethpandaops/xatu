CREATE TABLE default.beacon_api_eth_v2_beacon_block_proposer_slashing_local on cluster '{cluster}'
(
...
ALTER TABLE default.beacon_api_eth_v2_beacon_block_proposer_slashing_local ON CLUSTER '{cluster}'
...
CREATE TABLE beacon_api_eth_v2_beacon_block_proposer_slashing on cluster '{cluster}' AS beacon_api_eth_v2_beacon_block_proposer_slashing_local
ENGINE = Distributed('{cluster}', default, beacon_api_eth_v2_beacon_block_proposer_slashing_local, rand());

CREATE TABLE default.beacon_api_eth_v2_beacon_block_attester_slashing_local on cluster '{cluster}'
(
    event_date_time DateTime64(3) CODEC(DoubleDelta, ZSTD(1)),
    slot UInt32 CODEC(DoubleDelta, ZSTD(1)),
    slot_start_date_time DateTime CODEC(DoubleDelta, ZSTD(1)),
...
ALTER TABLE default.beacon_api_eth_v2_beacon_block_attester_slashing_local ON CLUSTER '{cluster}'
...
CREATE TABLE beacon_api_eth_v2_beacon_block_attester_slashing on cluster '{cluster}' AS beacon_api_eth_v2_beacon_block_attester_slashing_local
ENGINE = Distributed('{cluster}', default, beacon_api_eth_v2_beacon_block_attester_slashing_local, rand());

CREATE TABLE default.beacon_api_eth_v2_beacon_block_bls_to_execution_change_local on cluster '{cluster}'
(
    event_date_time DateTime64(3) CODEC(DoubleDelta, ZSTD(1)),
    slot UInt32 CODEC(DoubleDelta, ZSTD(1)),
    slot_start_date_time DateTime CODEC(DoubleDelta, ZSTD(1)),
...
ALTER TABLE default.beacon_api_eth_v2_beacon_block_bls_to_execution_change_local ON CLUSTER '{cluster}'
...
CREATE TABLE beacon_api_eth_v2_beacon_block_bls_to_execution_change on cluster '{cluster}' AS beacon_api_eth_v2_beacon_block_bls_to_execution_change_local
ENGINE = Distributed('{cluster}', default, beacon_api_eth_v2_beacon_block_bls_to_execution_change_local, rand());

CREATE TABLE default.beacon_api_eth_v2_beacon_block_execution_transaction_local on cluster '{cluster}'
(
    event_date_time DateTime64(3) CODEC(DoubleDelta, ZSTD(1)),
    slot UInt32 CODEC(DoubleDelta, ZSTD(1)),
    slot_start_date_time DateTime CODEC(DoubleDelta, ZSTD(1)),
...
ALTER TABLE default.beacon_api_eth_v2_beacon_block_execution_transaction_local ON CLUSTER '{cluster}'
...
CREATE TABLE beacon_api_eth_v2_beacon_block_execution_transaction on cluster '{cluster}' AS beacon_api_eth_v2_beacon_block_execution_transaction_local
ENGINE = Distributed('{cluster}', default, beacon_api_eth_v2_beacon_block_execution_transaction_local, rand());

CREATE TABLE default.beacon_api_eth_v2_beacon_block_voluntary_exit_local on cluster '{cluster}'
(
    event_date_time DateTime64(3) CODEC(DoubleDelta, ZSTD(1)),
    slot UInt32 CODEC(DoubleDelta, ZSTD(1)),
    slot_start_date_time DateTime CODEC(DoubleDelta, ZSTD(1)),
...
ALTER TABLE default.beacon_api_eth_v2_beacon_block_voluntary_exit_local ON CLUSTER '{cluster}'
...
CREATE TABLE beacon_api_eth_v2_beacon_block_voluntary_exit on cluster '{cluster}' AS beacon_api_eth_v2_beacon_block_voluntary_exit_local
ENGINE = Distributed('{cluster}', default, beacon_api_eth_v2_beacon_block_voluntary_exit_local, rand());

CREATE TABLE default.beacon_api_eth_v2_beacon_block_deposit_local on cluster '{cluster}'
(
    event_date_time DateTime64(3) CODEC(DoubleDelta, ZSTD(1)),
    slot UInt32 CODEC(DoubleDelta, ZSTD(1)),
    slot_start_date_time DateTime CODEC(DoubleDelta, ZSTD(1)),
...
ALTER TABLE default.beacon_api_eth_v2_beacon_block_deposit_local ON CLUSTER '{cluster}'
...
CREATE TABLE beacon_api_eth_v2_beacon_block_deposit on cluster '{cluster}' AS beacon_api_eth_v2_beacon_block_deposit_local
ENGINE = Distributed('{cluster}', default, beacon_api_eth_v2_beacon_block_deposit_local, rand());
