...
ENGINE = Distributed('{cluster}', default, canonical_beacon_block_proposer_slashing_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_block_attester_slashing_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_block_bls_to_execution_change_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_block_execution_transaction_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_block_voluntary_exit_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_block_deposit_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_block_withdrawal_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_blob_sidecar_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, mempool_dumpster_transaction_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, block_native_mempool_transaction_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, beacon_p2p_attestation_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_proposer_duty_local, unique_key);
...
ENGINE = Distributed('{cluster}', default, canonical_beacon_elaborated_attestation_local, unique_key);
