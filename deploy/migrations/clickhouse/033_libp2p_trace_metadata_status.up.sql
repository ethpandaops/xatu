...
(
    ...
    protocol_layer String CODEC(ZSTD(1)),
    protocol_type String CODEC(ZSTD(1)),
    protocol_name String CODEC(ZSTD(1)),
    protocol_version String CODEC(ZSTD(1)),
    protocol_encoding String CODEC(ZSTD(1)),
    request_finalized_epoch  Nullable(UInt32) Codec(DoubleDelta, ZSTD(1)),
    request_finalized_root Nullable(String),
    request_fork_digest Nullable(LowCardinality(String)),
...
COMMENT COLUMN protocol_layer 'Network part of the protocol ID. Eg. `eth2`',
COMMENT COLUMN protocol_type 'Type part of the protocol ID',
COMMENT COLUMN protocol_name 'Name part of the protocol ID',
COMMENT COLUMN protocol_version 'Version part of the protocol ID',
COMMENT COLUMN protocol_encoding 'Encoding part of the protocol ID',
...
COMMENT COLUMN latency_seconds 'Latency of the status handling in seconds';
...
COMMENT COLUMN latency_seconds 'Latency of the metadata handling in seconds',
