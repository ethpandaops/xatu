CREATE TABLE default.beacon_api_eth_v1_events_block_gossip_local ON CLUSTER '{cluster}' (
...
CREATE TABLE default.beacon_api_eth_v1_events_block_gossip ON CLUSTER '{cluster}' AS default.beacon_api_eth_v1_events_block_gossip_local ENGINE = Distributed(
    '{cluster}',
    default,
