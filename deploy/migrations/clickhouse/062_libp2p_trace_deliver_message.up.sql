...
(
    ...
    message_topic_name LowCardinality(String) COMMENT 'Name of the topic that the message was delivered to',
    message_topic_encoding LowCardinality(String) COMMENT 'Encoding of the topic that the message was delivered to',
    message_topic_fork_digest_value LowCardinality(String) COMMENT 'Fork digest value of the topic that the message was delivered to',
    message_topic_layer LowCardinality(String) COMMENT 'Layer of the topic that the message was delivered to',
