...
(
    ...
    message_topic_name LowCardinality(String) COMMENT 'Name of the topic that the message was rejected from',
    message_topic_encoding LowCardinality(String) COMMENT 'Encoding of the topic that the message was rejected from',
    message_topic_fork_digest_value LowCardinality(String) COMMENT 'Fork digest value of the topic that the message was rejected from',
    message_topic_layer LowCardinality(String) COMMENT 'Layer of the topic that the message was rejected from',
...
CREATE TABLE libp2p_reject_message ON CLUSTER '{cluster}' AS libp2p_reject_message_local ENGINE = Distributed(
    '{cluster}',
    default,
    libp2p_reject_message_local,
    cityHash64(
        event_date_time,
        meta_network_name,
        meta_client_name,
