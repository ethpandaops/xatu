...
(
    ...
    message_topic_name LowCardinality(String) COMMENT 'Name of the topic that the message was published to',
    message_topic_encoding LowCardinality(String) COMMENT 'Encoding of the topic that the message was published to',
    message_topic_fork_digest_value LowCardinality(String) COMMENT 'Fork digest value of the topic that the message was published to',
    message_topic_layer LowCardinality(String) COMMENT 'Layer of the topic that the message was published to',
...
CREATE TABLE libp2p_publish_message ON CLUSTER '{cluster}' AS libp2p_publish_message_local ENGINE = Distributed(
    '{cluster}',
    default,
    libp2p_publish_message_local,
    cityHash64(
        event_date_time,
        meta_network_name,
        meta_client_name,
