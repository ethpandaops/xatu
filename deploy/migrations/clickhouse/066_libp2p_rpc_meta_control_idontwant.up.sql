CREATE TABLE libp2p_rpc_meta_control_idontwant_local ON CLUSTER '{cluster}'
(
...
ORDER BY (event_date_time, unique_key, control_index, peer_id_unique_key, message_id, message_index, meta_network_name, meta_client_name)
COMMENT 'Contains the details of the IDONTWANT control messages from the peer.';

CREATE TABLE libp2p_rpc_meta_control_idontwant ON CLUSTER '{cluster}' AS libp2p_rpc_meta_control_idontwant_local
