...
DROP COLUMN execution_client_version_patch;

ALTER TABLE default.consensus_engine_api_new_payload ON CLUSTER '{cluster}'
DROP COLUMN execution_client_version_minor;

ALTER TABLE default.consensus_engine_api_new_payload ON CLUSTER '{cluster}'
DROP COLUMN execution_client_version_major;

ALTER TABLE default.consensus_engine_api_new_payload ON CLUSTER '{cluster}'
DROP COLUMN execution_client_implementation;

ALTER TABLE default.consensus_engine_api_new_payload ON CLUSTER '{cluster}'
DROP COLUMN execution_client_version;
