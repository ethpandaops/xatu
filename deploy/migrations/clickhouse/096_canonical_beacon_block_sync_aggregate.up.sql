CREATE TABLE default.canonical_beacon_block_sync_aggregate_local ON CLUSTER '{cluster}' (
...
CREATE TABLE default.canonical_beacon_block_sync_aggregate ON CLUSTER '{cluster}' AS default.canonical_beacon_block_sync_aggregate_local ENGINE = Distributed(
    '{cluster}',
    default,
    canonical_beacon_block_sync_aggregate_local,
    cityHash64(
        slot_start_date_time,
        meta_network_name,
        slot
