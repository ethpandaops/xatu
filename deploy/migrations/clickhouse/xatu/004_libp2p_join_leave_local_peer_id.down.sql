...
ENGINE = Distributed('{cluster}', 'default', 'libp2p_join_migrate_bak_local', cityHash64(event_date_time, meta_network_name, meta_client_name, local_peer_id_unique_key, topic_fork_digest_value, topic_name));
...
ENGINE = Distributed('{cluster}', 'default', 'libp2p_leave_migrate_bak_local', cityHash64(event_date_time, meta_network_name, meta_client_name, local_peer_id_unique_key, topic_fork_digest_value, topic_name));
