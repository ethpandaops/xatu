...
// ConvertKzgCommitmentToVersionedHash converts a KZG commitment to a versioned hash.
...
// CountConsecutiveEmptyBytes counts the total number of consecutive zero bytes
// in the array that exceed the given threshold length.
