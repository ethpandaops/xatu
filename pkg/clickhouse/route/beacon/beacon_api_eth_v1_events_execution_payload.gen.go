...
const beaconApiEthV1EventsExecutionPayloadTableName route.TableName = "beacon_api_eth_v1_events_execution_payload"

type beaconApiEthV1EventsExecutionPayloadBatch struct {
...
func newbeaconApiEthV1EventsExecutionPayloadBatch() *beaconApiEthV1EventsExecutionPayloadBatch {
...
func (b *beaconApiEthV1EventsExecutionPayloadBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsExecutionPayloadBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsExecutionPayloadBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsExecutionPayloadBatch) Reset() {
...
func (b *beaconApiEthV1EventsExecutionPayloadBatch) Snapshot() []map[string]any {
	n := b.rows
