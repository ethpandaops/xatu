...
const beaconApiEthV1EventsExecutionPayloadAvailableTableName route.TableName = "beacon_api_eth_v1_events_execution_payload_available"

type beaconApiEthV1EventsExecutionPayloadAvailableBatch struct {
...
func newbeaconApiEthV1EventsExecutionPayloadAvailableBatch() *beaconApiEthV1EventsExecutionPayloadAvailableBatch {
	return &beaconApiEthV1EventsExecutionPayloadAvailableBatch{
...
func (b *beaconApiEthV1EventsExecutionPayloadAvailableBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsExecutionPayloadAvailableBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsExecutionPayloadAvailableBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsExecutionPayloadAvailableBatch) Reset() {
...
func (b *beaconApiEthV1EventsExecutionPayloadAvailableBatch) Snapshot() []map[string]any {
	n := b.rows
