...
const beaconApiEthV1EventsFastConfirmationTableName route.TableName = "beacon_api_eth_v1_events_fast_confirmation"

type beaconApiEthV1EventsFastConfirmationBatch struct {
...
func (b *beaconApiEthV1EventsFastConfirmationBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsFastConfirmationBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsFastConfirmationBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsFastConfirmationBatch) Reset() {
...
func (b *beaconApiEthV1EventsFastConfirmationBatch) Snapshot() []map[string]any {
	n := b.rows
