...
const beaconApiEthV1EventsHeadV2TableName route.TableName = "beacon_api_eth_v1_events_head_v2"

type beaconApiEthV1EventsHeadV2Batch struct {
	...
	PayloadStatus                             proto.ColStr
	EpochTransition                           proto.ColBool
	ExecutionOptimistic                       proto.ColBool
	CurrentEpochDependentRoot                 route.SafeColFixedStr
	NextEpochDependentRoot                    route.SafeColFixedStr
...
func newbeaconApiEthV1EventsHeadV2Batch() *beaconApiEthV1EventsHeadV2Batch {
	return &beaconApiEthV1EventsHeadV2Batch{
		...
		CurrentEpochDependentRoot:                 func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
		NextEpochDependentRoot:                    func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
...
func (b *beaconApiEthV1EventsHeadV2Batch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsHeadV2Batch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsHeadV2Batch) Input() proto.Input {
	return proto.Input{
		...
		{Name: "payload_status", Data: &b.PayloadStatus},
		{Name: "epoch_transition", Data: &b.EpochTransition},
		{Name: "execution_optimistic", Data: &b.ExecutionOptimistic},
		{Name: "current_epoch_dependent_root", Data: &b.CurrentEpochDependentRoot},
		{Name: "next_epoch_dependent_root", Data: &b.NextEpochDependentRoot},
...
func (b *beaconApiEthV1EventsHeadV2Batch) Reset() {
	...
	b.PayloadStatus.Reset()
	b.EpochTransition.Reset()
	b.ExecutionOptimistic.Reset()
	b.CurrentEpochDependentRoot.Reset()
	b.NextEpochDependentRoot.Reset()
...
func (b *beaconApiEthV1EventsHeadV2Batch) Snapshot() []map[string]any {
	n := b.rows
	...
	for i := 0; i < n; i++ {
		...
		row["payload_status"] = b.PayloadStatus.Row(i)
		row["epoch_transition"] = b.EpochTransition.Row(i)
		row["execution_optimistic"] = b.ExecutionOptimistic.Row(i)
		row["current_epoch_dependent_root"] = string(b.CurrentEpochDependentRoot.Row(i))
		row["next_epoch_dependent_root"] = string(b.NextEpochDependentRoot.Row(i))
