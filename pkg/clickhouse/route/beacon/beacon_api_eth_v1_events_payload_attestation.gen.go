...
const beaconApiEthV1EventsPayloadAttestationTableName route.TableName = "beacon_api_eth_v1_events_payload_attestation"

type beaconApiEthV1EventsPayloadAttestationBatch struct {
...
func newbeaconApiEthV1EventsPayloadAttestationBatch() *beaconApiEthV1EventsPayloadAttestationBatch {
	return &beaconApiEthV1EventsPayloadAttestationBatch{
...
func (b *beaconApiEthV1EventsPayloadAttestationBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsPayloadAttestationBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsPayloadAttestationBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsPayloadAttestationBatch) Reset() {
...
func (b *beaconApiEthV1EventsPayloadAttestationBatch) Snapshot() []map[string]any {
	n := b.rows
