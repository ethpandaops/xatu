...
const beaconApiEthV1EventsProposerPreferencesTableName route.TableName = "beacon_api_eth_v1_events_proposer_preferences"

type beaconApiEthV1EventsProposerPreferencesBatch struct {
...
func newbeaconApiEthV1EventsProposerPreferencesBatch() *beaconApiEthV1EventsProposerPreferencesBatch {
	return &beaconApiEthV1EventsProposerPreferencesBatch{
...
func (b *beaconApiEthV1EventsProposerPreferencesBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsProposerPreferencesBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsProposerPreferencesBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsProposerPreferencesBatch) Reset() {
...
func (b *beaconApiEthV1EventsProposerPreferencesBatch) Snapshot() []map[string]any {
	n := b.rows
