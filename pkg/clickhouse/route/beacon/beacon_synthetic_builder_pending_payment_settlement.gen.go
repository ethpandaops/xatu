...
const beaconSyntheticBuilderPendingPaymentSettlementTableName route.TableName = "beacon_synthetic_builder_pending_payment_settlement"

type beaconSyntheticBuilderPendingPaymentSettlementBatch struct {
	...
	Weight                                    proto.ColUInt64
	Quorum                                    proto.ColUInt64
...
func newbeaconSyntheticBuilderPendingPaymentSettlementBatch() *beaconSyntheticBuilderPendingPaymentSettlementBatch {
	return &beaconSyntheticBuilderPendingPaymentSettlementBatch{
...
func (b *beaconSyntheticBuilderPendingPaymentSettlementBatch) Rows() int {
	return b.rows
}

func (b *beaconSyntheticBuilderPendingPaymentSettlementBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconSyntheticBuilderPendingPaymentSettlementBatch) Input() proto.Input {
	return proto.Input{
		...
		{Name: "weight", Data: &b.Weight},
		{Name: "quorum", Data: &b.Quorum},
...
func (b *beaconSyntheticBuilderPendingPaymentSettlementBatch) Reset() {
...
func (b *beaconSyntheticBuilderPendingPaymentSettlementBatch) Snapshot() []map[string]any {
	n := b.rows
	...
	for i := 0; i < n; i++ {
		...
		row["weight"] = b.Weight.Row(i)
		row["quorum"] = b.Quorum.Row(i)
