...
const beaconSyntheticPayloadAttestationProcessedTableName route.TableName = "beacon_synthetic_payload_attestation_processed"

type beaconSyntheticPayloadAttestationProcessedBatch struct {
	...
	PayloadPresent                            proto.ColBool
	BlobDataAvailable                         proto.ColBool
	PeerID                                    proto.ColStr
	ProcessingDurationMs                      proto.ColUInt64
	ReceivedAt                                proto.ColDateTime64
...
func newbeaconSyntheticPayloadAttestationProcessedBatch() *beaconSyntheticPayloadAttestationProcessedBatch {
	return &beaconSyntheticPayloadAttestationProcessedBatch{
		...
		ReceivedAt:                                func() proto.ColDateTime64 { var c proto.ColDateTime64; c.WithPrecision(proto.Precision(3)); return c }(),
...
func (b *beaconSyntheticPayloadAttestationProcessedBatch) Rows() int {
	return b.rows
}

func (b *beaconSyntheticPayloadAttestationProcessedBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconSyntheticPayloadAttestationProcessedBatch) Input() proto.Input {
	return proto.Input{
		...
		{Name: "blob_data_available", Data: &b.BlobDataAvailable},
		{Name: "peer_id", Data: &b.PeerID},
		{Name: "processing_duration_ms", Data: &b.ProcessingDurationMs},
		{Name: "received_at", Data: &b.ReceivedAt},
...
func (b *beaconSyntheticPayloadAttestationProcessedBatch) Reset() {
	...
	b.BlobDataAvailable.Reset()
	b.PeerID.Reset()
	b.ProcessingDurationMs.Reset()
	b.ReceivedAt.Reset()
...
func (b *beaconSyntheticPayloadAttestationProcessedBatch) Snapshot() []map[string]any {
	n := b.rows
	...
	for i := 0; i < n; i++ {
		...
		row["payload_present"] = b.PayloadPresent.Row(i)
		row["blob_data_available"] = b.BlobDataAvailable.Row(i)
		row["peer_id"] = b.PeerID.Row(i)
		row["processing_duration_ms"] = b.ProcessingDurationMs.Row(i)
		row["received_at"] = b.ReceivedAt.Row(i).UnixMilli()
