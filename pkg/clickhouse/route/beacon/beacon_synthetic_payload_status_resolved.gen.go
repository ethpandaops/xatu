...
const beaconSyntheticPayloadStatusResolvedTableName route.TableName = "beacon_synthetic_payload_status_resolved"

type beaconSyntheticPayloadStatusResolvedBatch struct {
...
func (b *beaconSyntheticPayloadStatusResolvedBatch) Rows() int {
	return b.rows
}

func (b *beaconSyntheticPayloadStatusResolvedBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconSyntheticPayloadStatusResolvedBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconSyntheticPayloadStatusResolvedBatch) Reset() {
...
func (b *beaconSyntheticPayloadStatusResolvedBatch) Snapshot() []map[string]any {
	n := b.rows
