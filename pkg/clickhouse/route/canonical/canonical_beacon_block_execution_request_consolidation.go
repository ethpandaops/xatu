...
// TODO: Add the xatu.Event_* name(s) that route events to the canonical_beacon_block_execution_request_consolidation table.
...
func (b *canonicalBeaconBlockExecutionRequestConsolidationBatch) FlattenTo(
	...
	//   b.rows++
	//   return nil
	return fmt.Errorf("canonicalBeaconBlockExecutionRequestConsolidation: FlattenTo not implemented")
}
