...
// TODO: Add the xatu.Event_* name(s) that route events to the canonical_beacon_block_execution_request_withdrawal table.
...
func (b *canonicalBeaconBlockExecutionRequestWithdrawalBatch) FlattenTo(
	...
	//   b.rows++
	//   return nil
	return fmt.Errorf("canonicalBeaconBlockExecutionRequestWithdrawal: FlattenTo not implemented")
}
