...
const canonicalBeaconBlockPayloadAttestationTableName route.TableName = "canonical_beacon_block_payload_attestation"

type canonicalBeaconBlockPayloadAttestationBatch struct {
	...
	AttestingValidatorCount                   proto.ColUInt32
...
func newcanonicalBeaconBlockPayloadAttestationBatch() *canonicalBeaconBlockPayloadAttestationBatch {
...
func (b *canonicalBeaconBlockPayloadAttestationBatch) Rows() int {
	return b.rows
}

func (b *canonicalBeaconBlockPayloadAttestationBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *canonicalBeaconBlockPayloadAttestationBatch) Input() proto.Input {
	return proto.Input{
		...
		{Name: "attesting_validator_count", Data: &b.AttestingValidatorCount},
...
func (b *canonicalBeaconBlockPayloadAttestationBatch) Reset() {
	...
	b.AttestingValidatorCount.Reset()
...
func (b *canonicalBeaconBlockPayloadAttestationBatch) Snapshot() []map[string]any {
	n := b.rows
	...
	for i := 0; i < n; i++ {
		...
		row["attesting_validator_count"] = b.AttestingValidatorCount.Row(i)
