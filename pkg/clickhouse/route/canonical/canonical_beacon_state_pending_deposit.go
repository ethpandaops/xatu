...
// TODO: Add the xatu.Event_* name(s) that route events to the canonical_beacon_state_pending_deposit table.
...
func (b *canonicalBeaconStatePendingDepositBatch) FlattenTo(
	...
	//   b.rows++
	//   return nil
	return fmt.Errorf("canonicalBeaconStatePendingDeposit: FlattenTo not implemented")
}
