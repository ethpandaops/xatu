...
const libp2pGossipsubExecutionPayloadEnvelopeTableName route.TableName = "libp2p_gossipsub_execution_payload_envelope"
...
func newlibp2pGossipsubExecutionPayloadEnvelopeBatch() *libp2pGossipsubExecutionPayloadEnvelopeBatch {
...
func (b *libp2pGossipsubExecutionPayloadEnvelopeBatch) Rows() int {
	return b.rows
}

func (b *libp2pGossipsubExecutionPayloadEnvelopeBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *libp2pGossipsubExecutionPayloadEnvelopeBatch) Snapshot() []map[string]any {
	n := b.rows
