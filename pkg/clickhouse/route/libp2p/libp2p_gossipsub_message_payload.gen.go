...
const libp2pGossipsubMessagePayloadTableName route.TableName = "libp2p_gossipsub_message_payload"

type libp2pGossipsubMessagePayloadBatch struct {
...
func newlibp2pGossipsubMessagePayloadBatch() *libp2pGossipsubMessagePayloadBatch {
	return &libp2pGossipsubMessagePayloadBatch{
...
func (b *libp2pGossipsubMessagePayloadBatch) Rows() int {
	return b.rows
}

func (b *libp2pGossipsubMessagePayloadBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *libp2pGossipsubMessagePayloadBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pGossipsubMessagePayloadBatch) Reset() {
...
func (b *libp2pGossipsubMessagePayloadBatch) Snapshot() []map[string]any {
	n := b.rows
