...
func (w *Writer) getOrCreateTableWriter(table string) *chTableWriter {
...
func (w *Writer) getPool() *chpool.Pool {
	w.poolMu.RLock()
...
func (w *Writer) setPool(pool *chpool.Pool) {
	w.poolMu.Lock()
...
func (w *Writer) withQueryTimeout(ctx context.Context) (context.Context, context.CancelFunc) {
