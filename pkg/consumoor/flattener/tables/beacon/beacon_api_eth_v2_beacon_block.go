...
func (BeaconApiEthV2BeaconBlockRoute) Table() flattener.TableName {
	return flattener.TableName("beacon_api_eth_v2_beacon_block")
}

func (r BeaconApiEthV2BeaconBlockRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_BEACON_API_ETH_V2_BEACON_BLOCK,
...
func init() {
	catalog.MustRegister(BeaconApiEthV2BeaconBlockRoute{})
}
