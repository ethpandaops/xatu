...
func (CanonicalBeaconBlockAttesterSlashingRoute) Table() flattener.TableName {
	return flattener.TableName("canonical_beacon_block_attester_slashing")
}

func (r CanonicalBeaconBlockAttesterSlashingRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_BEACON_API_ETH_V2_BEACON_BLOCK_ATTESTER_SLASHING).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(CanonicalBeaconBlockAttesterSlashingRoute{})
}
