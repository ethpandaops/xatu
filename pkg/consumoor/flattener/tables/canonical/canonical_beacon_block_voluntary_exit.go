...
func (CanonicalBeaconBlockVoluntaryExitRoute) Table() flattener.TableName {
	return flattener.TableName("canonical_beacon_block_voluntary_exit")
}

func (r CanonicalBeaconBlockVoluntaryExitRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_BEACON_API_ETH_V2_BEACON_BLOCK_VOLUNTARY_EXIT).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(CanonicalBeaconBlockVoluntaryExitRoute{})
}
