...
func (CanonicalBeaconBlockWithdrawalRoute) Table() flattener.TableName {
	return flattener.TableName("canonical_beacon_block_withdrawal")
}

func (r CanonicalBeaconBlockWithdrawalRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_BEACON_API_ETH_V2_BEACON_BLOCK_WITHDRAWAL).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(CanonicalBeaconBlockWithdrawalRoute{})
}
