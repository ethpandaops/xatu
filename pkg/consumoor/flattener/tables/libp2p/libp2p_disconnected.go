...
func (Libp2pDisconnectedRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_disconnected")
}

func (r Libp2pDisconnectedRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_DISCONNECTED).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pDisconnectedRoute{})
}
