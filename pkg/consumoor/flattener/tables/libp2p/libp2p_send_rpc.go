...
func (Libp2pSendRpcRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_send_rpc")
}

func (r Libp2pSendRpcRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_SEND_RPC).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pSendRpcRoute{})
}
