...
const beaconApiEthV1BeaconCommitteeTableName route.TableName = "beacon_api_eth_v1_beacon_committee"
...
func (b *beaconApiEthV1BeaconCommitteeBatch) appendMetadata(event *xatu.DecoratedEvent) {
