...
func init() {
	r, err := route.NewStaticRoute(
		...
		func() route.ColumnarBatch { return newbeaconApiEthV1BeaconCommitteeBatch() },
		route.WithStaticRoutePredicate(beaconApiEthV1BeaconCommitteePredicate),
	)
	if err != nil {
...
func (b *beaconApiEthV1BeaconCommitteeBatch) FlattenTo(event *xatu.DecoratedEvent) error {
