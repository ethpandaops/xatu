...
func init() {
	r, err := route.NewStaticRoute(
		...
		func() route.ColumnarBatch { return newbeaconApiEthV1EventsAttestationBatch() },
	)
	if err != nil {
...
func (b *beaconApiEthV1EventsAttestationBatch) FlattenTo(event *xatu.DecoratedEvent) error {
