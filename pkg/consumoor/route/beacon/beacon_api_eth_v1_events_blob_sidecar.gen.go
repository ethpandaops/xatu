...
const beaconApiEthV1EventsBlobSidecarTableName route.TableName = "beacon_api_eth_v1_events_blob_sidecar"
...
func (b *beaconApiEthV1EventsBlobSidecarBatch) appendMetadata(event *xatu.DecoratedEvent) {
