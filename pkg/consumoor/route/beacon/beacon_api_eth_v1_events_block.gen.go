...
const beaconApiEthV1EventsBlockTableName route.TableName = "beacon_api_eth_v1_events_block"
...
func (b *beaconApiEthV1EventsBlockBatch) appendMetadata(event *xatu.DecoratedEvent) {
