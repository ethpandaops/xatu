...
const beaconApiEthV1EventsBlockGossipTableName route.TableName = "beacon_api_eth_v1_events_block_gossip"
...
func (b *beaconApiEthV1EventsBlockGossipBatch) appendMetadata(event *xatu.DecoratedEvent) {
