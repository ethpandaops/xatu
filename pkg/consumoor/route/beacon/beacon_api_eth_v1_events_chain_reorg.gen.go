...
const beaconApiEthV1EventsChainReorgTableName route.TableName = "beacon_api_eth_v1_events_chain_reorg"
...
type beaconApiEthV1EventsChainReorgBatch struct {
	...
	OldHeadBlock                              route.SafeColFixedStr
	NewHeadBlock                              route.SafeColFixedStr
	OldHeadState                              route.SafeColFixedStr
	NewHeadState                              route.SafeColFixedStr
...
func newbeaconApiEthV1EventsChainReorgBatch() *beaconApiEthV1EventsChainReorgBatch {
	return &beaconApiEthV1EventsChainReorgBatch{
		...
		OldHeadBlock:                        func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
		NewHeadBlock:                        func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
		OldHeadState:                        func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
		NewHeadState:                        func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
...
func (b *beaconApiEthV1EventsChainReorgBatch) appendMetadata(event *xatu.DecoratedEvent) {
