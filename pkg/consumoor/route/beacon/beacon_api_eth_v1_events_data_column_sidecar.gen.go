...
const beaconApiEthV1EventsDataColumnSidecarTableName route.TableName = "beacon_api_eth_v1_events_data_column_sidecar"
...
func (b *beaconApiEthV1EventsDataColumnSidecarBatch) appendMetadata(event *xatu.DecoratedEvent) {
