...
const beaconApiEthV1EventsExecutionPayloadBidTableName route.TableName = "beacon_api_eth_v1_events_execution_payload_bid"

type beaconApiEthV1EventsExecutionPayloadBidBatch struct {
...
func (b *beaconApiEthV1EventsExecutionPayloadBidBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsExecutionPayloadBidBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsExecutionPayloadBidBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsExecutionPayloadBidBatch) Reset() {
...
func (b *beaconApiEthV1EventsExecutionPayloadBidBatch) Snapshot() []map[string]any {
	n := b.rows
