...
// TODO: Add the xatu.Event_* name(s) that route events to the beacon_api_eth_v1_events_execution_payload_bid table.
...
func (b *beaconApiEthV1EventsExecutionPayloadBidBatch) FlattenTo(
	...
	//   b.rows++
	//   return nil
	return fmt.Errorf("beaconApiEthV1EventsExecutionPayloadBid: FlattenTo not implemented")
}
