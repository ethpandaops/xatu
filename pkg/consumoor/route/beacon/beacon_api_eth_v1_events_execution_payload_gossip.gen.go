...
const beaconApiEthV1EventsExecutionPayloadGossipTableName route.TableName = "beacon_api_eth_v1_events_execution_payload_gossip"

type beaconApiEthV1EventsExecutionPayloadGossipBatch struct {
...
func newbeaconApiEthV1EventsExecutionPayloadGossipBatch() *beaconApiEthV1EventsExecutionPayloadGossipBatch {
	return &beaconApiEthV1EventsExecutionPayloadGossipBatch{
...
func (b *beaconApiEthV1EventsExecutionPayloadGossipBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsExecutionPayloadGossipBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *beaconApiEthV1EventsExecutionPayloadGossipBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsExecutionPayloadGossipBatch) Reset() {
...
func (b *beaconApiEthV1EventsExecutionPayloadGossipBatch) Snapshot() []map[string]any {
	n := b.rows
