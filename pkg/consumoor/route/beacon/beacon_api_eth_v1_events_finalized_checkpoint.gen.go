...
const beaconApiEthV1EventsFinalizedCheckpointTableName route.TableName = "beacon_api_eth_v1_events_finalized_checkpoint"
...
func newbeaconApiEthV1EventsFinalizedCheckpointBatch() *beaconApiEthV1EventsFinalizedCheckpointBatch {
	return &beaconApiEthV1EventsFinalizedCheckpointBatch{
		...
		State:                               func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
...
func (b *beaconApiEthV1EventsFinalizedCheckpointBatch) appendMetadata(event *xatu.DecoratedEvent) {
