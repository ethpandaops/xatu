...
const beaconApiEthV1EventsHeadTableName route.TableName = "beacon_api_eth_v1_events_head"
...
func newbeaconApiEthV1EventsHeadBatch() *beaconApiEthV1EventsHeadBatch {
	return &beaconApiEthV1EventsHeadBatch{
		...
		PreviousDutyDependentRoot:                 func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
		CurrentDutyDependentRoot:                  func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
