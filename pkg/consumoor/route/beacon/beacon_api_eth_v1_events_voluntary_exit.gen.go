...
const beaconApiEthV1EventsVoluntaryExitTableName route.TableName = "beacon_api_eth_v1_events_voluntary_exit"
...
func (b *beaconApiEthV1EventsVoluntaryExitBatch) appendMetadata(event *xatu.DecoratedEvent) {
