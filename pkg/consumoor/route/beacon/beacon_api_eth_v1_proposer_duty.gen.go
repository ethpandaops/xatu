...
const beaconApiEthV1ProposerDutyTableName route.TableName = "beacon_api_eth_v1_proposer_duty"
...
func (b *beaconApiEthV1ProposerDutyBatch) appendMetadata(event *xatu.DecoratedEvent) {
