...
const beaconApiEthV1ValidatorAttestationDataTableName route.TableName = "beacon_api_eth_v1_validator_attestation_data"
...
func (b *beaconApiEthV1ValidatorAttestationDataBatch) appendMetadata(event *xatu.DecoratedEvent) {
