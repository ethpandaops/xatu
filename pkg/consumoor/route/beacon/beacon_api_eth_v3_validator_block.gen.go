...
const beaconApiEthV3ValidatorBlockTableName route.TableName = "beacon_api_eth_v3_validator_block"
...
func (b *beaconApiEthV3ValidatorBlockBatch) appendMetadata(event *xatu.DecoratedEvent) {
