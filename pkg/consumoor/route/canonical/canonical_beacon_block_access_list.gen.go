...
const canonicalBeaconBlockAccessListTableName route.TableName = "canonical_beacon_block_access_list"

type canonicalBeaconBlockAccessListBatch struct {
...
func newcanonicalBeaconBlockAccessListBatch() *canonicalBeaconBlockAccessListBatch {
	return &canonicalBeaconBlockAccessListBatch{
...
func (b *canonicalBeaconBlockAccessListBatch) Rows() int {
	return b.rows
}

func (b *canonicalBeaconBlockAccessListBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *canonicalBeaconBlockAccessListBatch) Input() proto.Input {
	return proto.Input{
...
func (b *canonicalBeaconBlockAccessListBatch) Reset() {
...
func (b *canonicalBeaconBlockAccessListBatch) Snapshot() []map[string]any {
	n := b.rows
