...
func init() {
	r, err := route.NewStaticRoute(
		...
		func() route.ColumnarBatch { return newcanonicalBeaconBlockSyncAggregateBatch() },
	)
	if err != nil {
...
func (b *canonicalBeaconBlockSyncAggregateBatch) FlattenTo(event *xatu.DecoratedEvent) error {
