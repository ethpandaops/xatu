...
func init() {
	r, err := route.NewStaticRoute(
		...
		func() route.ColumnarBatch { return newcanonicalBeaconSyncCommitteeBatch() },
	)
	if err != nil {
...
func (b *canonicalBeaconSyncCommitteeBatch) FlattenTo(event *xatu.DecoratedEvent) error {
