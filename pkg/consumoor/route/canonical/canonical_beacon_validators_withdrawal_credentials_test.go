...
func TestSnapshot_canonical_beacon_validators_withdrawal_credentials(t *testing.T) {
	testfixture.AssertSnapshot(t, newcanonicalBeaconValidatorsWithdrawalCredentialsBatch(), &xatu.DecoratedEvent{
		Event: &xatu.Event{
