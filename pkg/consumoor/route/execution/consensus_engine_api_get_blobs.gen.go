...
const consensusEngineApiGetBlobsTableName route.TableName = "consensus_engine_api_get_blobs"
...
func (b *consensusEngineApiGetBlobsBatch) appendMetadata(event *xatu.DecoratedEvent) {
