...
const consensusEngineApiNewPayloadTableName route.TableName = "consensus_engine_api_new_payload"
...
func (b *consensusEngineApiNewPayloadBatch) appendMetadata(event *xatu.DecoratedEvent) {
