...
const executionEngineGetBlobsTableName route.TableName = "execution_engine_get_blobs"
...
func (b *executionEngineGetBlobsBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *executionEngineGetBlobsBatch) Snapshot() []map[string]any {
	...
	for i := 0; i < n; i++ {
		...
		row["versioned_hashes"] = route.ByteSlicesToStrings(b.VersionedHashes.Row(i))
		row["returned_count"] = b.ReturnedCount.Row(i)
		row["returned_blob_indexes"] = route.Uint8SliceToIntSlice(b.ReturnedBlobIndexes.Row(i))
