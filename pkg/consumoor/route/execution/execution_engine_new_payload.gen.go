...
const executionEngineNewPayloadTableName route.TableName = "execution_engine_new_payload"

type executionEngineNewPayloadBatch struct {
...
func newexecutionEngineNewPayloadBatch() *executionEngineNewPayloadBatch {
	return &executionEngineNewPayloadBatch{
		...
		LatestValidHash:                     route.NewNullableFixedStr(66),
...
func (b *executionEngineNewPayloadBatch) Rows() int {
	return b.rows
}

func (b *executionEngineNewPayloadBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *executionEngineNewPayloadBatch) Input() proto.Input {
	return proto.Input{
...
func (b *executionEngineNewPayloadBatch) Reset() {
...
func (b *executionEngineNewPayloadBatch) Snapshot() []map[string]any {
	n := b.rows
