...
const libp2pConnectedTableName route.TableName = "libp2p_connected"

type libp2pConnectedBatch struct {
...
func newlibp2pConnectedBatch() *libp2pConnectedBatch {
	return &libp2pConnectedBatch{
...
func (b *libp2pConnectedBatch) Rows() int {
	return b.rows
}

func (b *libp2pConnectedBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *libp2pConnectedBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pConnectedBatch) Reset() {
...
func (b *libp2pConnectedBatch) Snapshot() []map[string]any {
	n := b.rows
