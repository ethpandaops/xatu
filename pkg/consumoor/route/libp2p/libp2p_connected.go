...
func init() {
	r, err := route.NewStaticRoute(
		...
		func() route.ColumnarBatch { return newlibp2pConnectedBatch() },
	)
	if err != nil {
...
func (b *libp2pConnectedBatch) FlattenTo(
	...
	if event.GetLibp2PTraceConnected() == nil {
		return fmt.Errorf("nil libp2p_trace_connected payload: %w", route.ErrInvalidEvent)
	}
