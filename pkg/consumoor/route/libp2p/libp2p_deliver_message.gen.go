...
const libp2pDeliverMessageTableName route.TableName = "libp2p_deliver_message"

type libp2pDeliverMessageBatch struct {
...
func newlibp2pDeliverMessageBatch() *libp2pDeliverMessageBatch {
	return &libp2pDeliverMessageBatch{
...
func (b *libp2pDeliverMessageBatch) Rows() int {
	return b.rows
}

func (b *libp2pDeliverMessageBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *libp2pDeliverMessageBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pDeliverMessageBatch) Reset() {
...
func (b *libp2pDeliverMessageBatch) Snapshot() []map[string]any {
	n := b.rows
