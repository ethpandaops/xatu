...
func init() {
	r, err := route.NewStaticRoute(
		...
		func() route.ColumnarBatch { return newlibp2pDeliverMessageBatch() },
	)
	if err != nil {
...
func (b *libp2pDeliverMessageBatch) FlattenTo(
	...
	if event.GetLibp2PTraceDeliverMessage() == nil {
		return fmt.Errorf("nil libp2p_trace_deliver_message payload: %w", route.ErrInvalidEvent)
	}
