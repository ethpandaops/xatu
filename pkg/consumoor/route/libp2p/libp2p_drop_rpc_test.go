...
func TestSnapshot_libp2p_drop_rpc(t *testing.T) {
	const (
	...
	testfixture.AssertSnapshot(t, newlibp2pDropRpcBatch(), &xatu.DecoratedEvent{
		Event: &xatu.Event{
		...
		Data: &xatu.DecoratedEvent_Libp2PTraceDropRpc{
			Libp2PTraceDropRpc: &libp2ppb.DropRPC{
