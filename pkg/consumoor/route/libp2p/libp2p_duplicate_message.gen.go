...
const libp2pDuplicateMessageTableName route.TableName = "libp2p_duplicate_message"

type libp2pDuplicateMessageBatch struct {
...
func newlibp2pDuplicateMessageBatch() *libp2pDuplicateMessageBatch {
	return &libp2pDuplicateMessageBatch{
...
func (b *libp2pDuplicateMessageBatch) Rows() int {
	return b.rows
}

func (b *libp2pDuplicateMessageBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *libp2pDuplicateMessageBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pDuplicateMessageBatch) Reset() {
...
func (b *libp2pDuplicateMessageBatch) Snapshot() []map[string]any {
	n := b.rows
