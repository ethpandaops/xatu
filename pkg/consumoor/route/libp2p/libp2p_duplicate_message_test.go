...
func TestSnapshot_libp2p_duplicate_message(t *testing.T) {
	const (
	...
	testfixture.AssertSnapshot(t, newlibp2pDuplicateMessageBatch(), &xatu.DecoratedEvent{
		Event: &xatu.Event{
		...
		Data: &xatu.DecoratedEvent_Libp2PTraceDuplicateMessage{
			Libp2PTraceDuplicateMessage: &libp2ppb.DuplicateMessage{
