...
const libp2pGossipsubAggregateAndProofTableName route.TableName = "libp2p_gossipsub_aggregate_and_proof"
...
func (b *libp2pGossipsubAggregateAndProofBatch) appendMetadata(event *xatu.DecoratedEvent) {
