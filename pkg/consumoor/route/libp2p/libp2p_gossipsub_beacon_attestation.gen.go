...
const libp2pGossipsubBeaconAttestationTableName route.TableName = "libp2p_gossipsub_beacon_attestation"
...
func newlibp2pGossipsubBeaconAttestationBatch() *libp2pGossipsubBeaconAttestationBatch {
	return &libp2pGossipsubBeaconAttestationBatch{
...
func (b *libp2pGossipsubBeaconAttestationBatch) Rows() int {
	return b.rows
}
...
func (b *libp2pGossipsubBeaconAttestationBatch) Snapshot() []map[string]any {
	n := b.rows
