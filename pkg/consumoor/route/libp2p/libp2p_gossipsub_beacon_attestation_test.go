...
func TestSnapshot_libp2p_gossipsub_beacon_attestation(t *testing.T) {
	const (
	...
	testfixture.AssertSnapshot(t, newlibp2pGossipsubBeaconAttestationBatch(), &xatu.DecoratedEvent{
		Event: &xatu.Event{
