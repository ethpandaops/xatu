...
const libp2pGossipsubBeaconBlockTableName route.TableName = "libp2p_gossipsub_beacon_block"
...
func (b *libp2pGossipsubBeaconBlockBatch) appendMetadata(event *xatu.DecoratedEvent) {
