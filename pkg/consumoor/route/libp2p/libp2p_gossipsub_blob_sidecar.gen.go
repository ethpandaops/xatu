...
const libp2pGossipsubBlobSidecarTableName route.TableName = "libp2p_gossipsub_blob_sidecar"
...
func (b *libp2pGossipsubBlobSidecarBatch) appendMetadata(event *xatu.DecoratedEvent) {
