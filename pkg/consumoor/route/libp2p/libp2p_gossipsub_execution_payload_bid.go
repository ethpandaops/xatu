...
// TODO: Add the xatu.Event_* name(s) that route events to the libp2p_gossipsub_execution_payload_bid table.
...
func (b *libp2pGossipsubExecutionPayloadBidBatch) FlattenTo(
	...
	//   b.rows++
	//   return nil
	return fmt.Errorf("libp2pGossipsubExecutionPayloadBid: FlattenTo not implemented")
}
