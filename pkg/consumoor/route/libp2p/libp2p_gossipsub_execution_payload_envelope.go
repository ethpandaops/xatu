...
// TODO: Add the xatu.Event_* name(s) that route events to the libp2p_gossipsub_execution_payload_envelope table.
...
func (b *libp2pGossipsubExecutionPayloadEnvelopeBatch) FlattenTo(
	...
	//   b.rows++
	//   return nil
	return fmt.Errorf("libp2pGossipsubExecutionPayloadEnvelope: FlattenTo not implemented")
}
