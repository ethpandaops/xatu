...
const libp2pHandleStatusTableName route.TableName = "libp2p_handle_status"
...
func newlibp2pHandleStatusBatch() *libp2pHandleStatusBatch {
	return &libp2pHandleStatusBatch{
		...
		ResponseFinalizedRoot:                     route.NewNullableFixedStr(66),
		ResponseHeadRoot:                          route.NewNullableFixedStr(66),
