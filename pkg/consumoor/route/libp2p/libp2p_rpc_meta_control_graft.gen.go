...
const libp2pRpcMetaControlGraftTableName route.TableName = "libp2p_rpc_meta_control_graft"
...
func (b *libp2pRpcMetaControlGraftBatch) appendMetadata(event *xatu.DecoratedEvent) {
