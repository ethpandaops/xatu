...
const libp2pRpcMetaControlIdontwantTableName route.TableName = "libp2p_rpc_meta_control_idontwant"
...
func (b *libp2pRpcMetaControlIdontwantBatch) appendMetadata(event *xatu.DecoratedEvent) {
