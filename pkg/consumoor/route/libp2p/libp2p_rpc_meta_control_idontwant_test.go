...
func TestSnapshot_libp2p_rpc_meta_control_idontwant(t *testing.T) {
	const (
	...
	testfixture.AssertSnapshot(t, newlibp2pRpcMetaControlIdontwantBatch(), &xatu.DecoratedEvent{
		Event: &xatu.Event{
		...
		Data: &xatu.DecoratedEvent_Libp2PTraceRpcMetaControlIdontwant{
			Libp2PTraceRpcMetaControlIdontwant: &libp2ppb.ControlIDontWantMetaItem{
