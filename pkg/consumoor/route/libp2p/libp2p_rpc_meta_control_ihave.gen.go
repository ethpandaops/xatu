...
const libp2pRpcMetaControlIhaveTableName route.TableName = "libp2p_rpc_meta_control_ihave"
...
func (b *libp2pRpcMetaControlIhaveBatch) appendMetadata(event *xatu.DecoratedEvent) {
