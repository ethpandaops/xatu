...
const libp2pRpcMetaControlIwantTableName route.TableName = "libp2p_rpc_meta_control_iwant"
...
func (b *libp2pRpcMetaControlIwantBatch) appendMetadata(event *xatu.DecoratedEvent) {
