...
const libp2pRpcMetaControlPruneTableName route.TableName = "libp2p_rpc_meta_control_prune"
...
func (b *libp2pRpcMetaControlPruneBatch) appendMetadata(event *xatu.DecoratedEvent) {
