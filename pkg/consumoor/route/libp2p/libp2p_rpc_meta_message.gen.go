...
const libp2pRpcMetaMessageTableName route.TableName = "libp2p_rpc_meta_message"

type libp2pRpcMetaMessageBatch struct {
...
func newlibp2pRpcMetaMessageBatch() *libp2pRpcMetaMessageBatch {
	return &libp2pRpcMetaMessageBatch{
...
func (b *libp2pRpcMetaMessageBatch) Rows() int {
	return b.rows
}

func (b *libp2pRpcMetaMessageBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *libp2pRpcMetaMessageBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pRpcMetaMessageBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pRpcMetaMessageBatch) Snapshot() []map[string]any {
	n := b.rows
