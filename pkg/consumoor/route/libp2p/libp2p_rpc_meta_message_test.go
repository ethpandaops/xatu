...
func TestSnapshot_libp2p_rpc_meta_message(t *testing.T) {
	const (
	...
	testfixture.AssertSnapshot(t, newlibp2pRpcMetaMessageBatch(), &xatu.DecoratedEvent{
		Event: &xatu.Event{
		...
		Data: &xatu.DecoratedEvent_Libp2PTraceRpcMetaMessage{
			Libp2PTraceRpcMetaMessage: &libp2ppb.MessageMetaItem{
