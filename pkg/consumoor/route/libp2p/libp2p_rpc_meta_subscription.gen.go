...
const libp2pRpcMetaSubscriptionTableName route.TableName = "libp2p_rpc_meta_subscription"

type libp2pRpcMetaSubscriptionBatch struct {
...
func newlibp2pRpcMetaSubscriptionBatch() *libp2pRpcMetaSubscriptionBatch {
	return &libp2pRpcMetaSubscriptionBatch{
...
func (b *libp2pRpcMetaSubscriptionBatch) Rows() int {
	return b.rows
}

func (b *libp2pRpcMetaSubscriptionBatch) appendMetadata(event *xatu.DecoratedEvent) {
...
func (b *libp2pRpcMetaSubscriptionBatch) Input() proto.Input {
	return proto.Input{
		...
		{Name: "subscribe", Data: &b.Subscribe},
...
func (b *libp2pRpcMetaSubscriptionBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pRpcMetaSubscriptionBatch) Snapshot() []map[string]any {
	n := b.rows
	...
	for i := 0; i < n; i++ {
		...
		row["subscribe"] = b.Subscribe.Row(i)
