...
func TestSnapshot_libp2p_send_rpc(t *testing.T) {
	const (
	...
	testfixture.AssertSnapshot(t, newlibp2pSendRpcBatch(), &xatu.DecoratedEvent{
		Event: &xatu.Event{
		...
		Data: &xatu.DecoratedEvent_Libp2PTraceSendRpc{
			Libp2PTraceSendRpc: &libp2ppb.SendRPC{
