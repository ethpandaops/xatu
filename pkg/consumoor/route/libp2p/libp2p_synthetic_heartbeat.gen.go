...
const libp2pSyntheticHeartbeatTableName route.TableName = "libp2p_synthetic_heartbeat"
...
func (b *libp2pSyntheticHeartbeatBatch) appendMetadata(event *xatu.DecoratedEvent) {
