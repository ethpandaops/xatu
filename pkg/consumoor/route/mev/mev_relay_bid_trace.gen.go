...
const mevRelayBidTraceTableName route.TableName = "mev_relay_bid_trace"
...
type mevRelayBidTraceBatch struct {
	...
	ParentHash                                route.SafeColFixedStr
...
func newmevRelayBidTraceBatch() *mevRelayBidTraceBatch {
	return &mevRelayBidTraceBatch{
		...
		ParentHash:                          func() route.SafeColFixedStr { var c route.SafeColFixedStr; c.SetSize(66); return c }(),
...
func (b *mevRelayBidTraceBatch) appendMetadata(event *xatu.DecoratedEvent) {
