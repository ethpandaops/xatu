...
func init() {
	r, err := route.NewStaticRoute(
		...
		func() route.ColumnarBatch { return newmevRelayProposerPayloadDeliveredBatch() },
	)
	if err != nil {
...
func (b *mevRelayProposerPayloadDeliveredBatch) FlattenTo(event *xatu.DecoratedEvent) error {
