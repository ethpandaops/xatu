...
const beaconApiEthV1BeaconBlobTableName flattener.TableName = "beacon_api_eth_v1_beacon_blob"

type beaconApiEthV1BeaconBlobBatch struct {
...
func newbeaconApiEthV1BeaconBlobBatch() *beaconApiEthV1BeaconBlobBatch {
	return &beaconApiEthV1BeaconBlobBatch{
...
func (b *beaconApiEthV1BeaconBlobBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1BeaconBlobBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1BeaconBlobBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1BeaconBlobBatch) Reset() {
...
func (b *beaconApiEthV1BeaconBlobBatch) Snapshot() []map[string]any {
	n := b.rows
