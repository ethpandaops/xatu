...
const beaconApiEthV1EventsAttestationTableName flattener.TableName = "beacon_api_eth_v1_events_attestation"
...
func (b *beaconApiEthV1EventsAttestationBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
