...
const beaconApiEthV1EventsBlockTableName flattener.TableName = "beacon_api_eth_v1_events_block"

type beaconApiEthV1EventsBlockBatch struct {
...
func newbeaconApiEthV1EventsBlockBatch() *beaconApiEthV1EventsBlockBatch {
	return &beaconApiEthV1EventsBlockBatch{
...
func (b *beaconApiEthV1EventsBlockBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsBlockBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1EventsBlockBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsBlockBatch) Reset() {
...
func (b *beaconApiEthV1EventsBlockBatch) Snapshot() []map[string]any {
	n := b.rows
