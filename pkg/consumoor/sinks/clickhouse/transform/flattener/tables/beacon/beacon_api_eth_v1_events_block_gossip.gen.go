...
const beaconApiEthV1EventsBlockGossipTableName flattener.TableName = "beacon_api_eth_v1_events_block_gossip"

type beaconApiEthV1EventsBlockGossipBatch struct {
...
func newbeaconApiEthV1EventsBlockGossipBatch() *beaconApiEthV1EventsBlockGossipBatch {
	return &beaconApiEthV1EventsBlockGossipBatch{
...
func (b *beaconApiEthV1EventsBlockGossipBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsBlockGossipBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1EventsBlockGossipBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsBlockGossipBatch) Reset() {
...
func (b *beaconApiEthV1EventsBlockGossipBatch) Snapshot() []map[string]any {
	n := b.rows
