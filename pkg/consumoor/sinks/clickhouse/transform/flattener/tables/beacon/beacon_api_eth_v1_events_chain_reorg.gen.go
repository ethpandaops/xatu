...
const beaconApiEthV1EventsChainReorgTableName flattener.TableName = "beacon_api_eth_v1_events_chain_reorg"

type beaconApiEthV1EventsChainReorgBatch struct {
	...
	Depth                                     proto.ColUInt16
	OldHeadBlock                              flattener.SafeColFixedStr
	NewHeadBlock                              flattener.SafeColFixedStr
	OldHeadState                              flattener.SafeColFixedStr
	NewHeadState                              flattener.SafeColFixedStr
...
func newbeaconApiEthV1EventsChainReorgBatch() *beaconApiEthV1EventsChainReorgBatch {
	return &beaconApiEthV1EventsChainReorgBatch{
		EventDateTime:                       func() proto.ColDateTime64 { var c proto.ColDateTime64; c.WithPrecision(proto.Precision(3)); return c }(),
		OldHeadBlock:                        func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(66); return c }(),
		NewHeadBlock:                        func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(66); return c }(),
		OldHeadState:                        func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(66); return c }(),
		NewHeadState:                        func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(66); return c }(),
...
func (b *beaconApiEthV1EventsChainReorgBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsChainReorgBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1EventsChainReorgBatch) Input() proto.Input {
	return proto.Input{
		...
		{Name: "depth", Data: &b.Depth},
		{Name: "old_head_block", Data: &b.OldHeadBlock},
		{Name: "new_head_block", Data: &b.NewHeadBlock},
		{Name: "old_head_state", Data: &b.OldHeadState},
		{Name: "new_head_state", Data: &b.NewHeadState},
...
func (b *beaconApiEthV1EventsChainReorgBatch) Reset() {
	...
	b.Depth.Reset()
	b.OldHeadBlock.Reset()
	b.NewHeadBlock.Reset()
	b.OldHeadState.Reset()
	b.NewHeadState.Reset()
	b.Epoch.Reset()
...
func (b *beaconApiEthV1EventsChainReorgBatch) Snapshot() []map[string]any {
	n := b.rows
	...
	for i := 0; i < n; i++ {
		...
		row["depth"] = b.Depth.Row(i)
		row["old_head_block"] = string(b.OldHeadBlock.Row(i))
		row["new_head_block"] = string(b.NewHeadBlock.Row(i))
		row["old_head_state"] = string(b.OldHeadState.Row(i))
		row["new_head_state"] = string(b.NewHeadState.Row(i))
