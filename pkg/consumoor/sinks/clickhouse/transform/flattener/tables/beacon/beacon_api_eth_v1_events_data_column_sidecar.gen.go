...
const beaconApiEthV1EventsDataColumnSidecarTableName flattener.TableName = "beacon_api_eth_v1_events_data_column_sidecar"

type beaconApiEthV1EventsDataColumnSidecarBatch struct {
...
func (b *beaconApiEthV1EventsDataColumnSidecarBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsDataColumnSidecarBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1EventsDataColumnSidecarBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsDataColumnSidecarBatch) Reset() {
...
func (b *beaconApiEthV1EventsDataColumnSidecarBatch) Snapshot() []map[string]any {
	n := b.rows
