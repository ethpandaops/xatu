...
const beaconApiEthV1EventsFinalizedCheckpointTableName flattener.TableName = "beacon_api_eth_v1_events_finalized_checkpoint"

type beaconApiEthV1EventsFinalizedCheckpointBatch struct {
	UpdatedDateTime                           proto.ColDateTime
	EventDateTime                             proto.ColDateTime64
	Block                                     flattener.SafeColFixedStr
	State                                     flattener.SafeColFixedStr
...
func newbeaconApiEthV1EventsFinalizedCheckpointBatch() *beaconApiEthV1EventsFinalizedCheckpointBatch {
	return &beaconApiEthV1EventsFinalizedCheckpointBatch{
		...
		State:                               func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(66); return c }(),
...
func (b *beaconApiEthV1EventsFinalizedCheckpointBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsFinalizedCheckpointBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1EventsFinalizedCheckpointBatch) Reset() {
...
func (b *beaconApiEthV1EventsFinalizedCheckpointBatch) Snapshot() []map[string]any {
	n := b.rows
	...
	for i := 0; i < n; i++ {
		...
		row["state"] = string(b.State.Row(i))
