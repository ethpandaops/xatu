...
const beaconApiEthV1EventsVoluntaryExitTableName flattener.TableName = "beacon_api_eth_v1_events_voluntary_exit"

type beaconApiEthV1EventsVoluntaryExitBatch struct {
...
func newbeaconApiEthV1EventsVoluntaryExitBatch() *beaconApiEthV1EventsVoluntaryExitBatch {
	return &beaconApiEthV1EventsVoluntaryExitBatch{
...
func (b *beaconApiEthV1EventsVoluntaryExitBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1EventsVoluntaryExitBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1EventsVoluntaryExitBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1EventsVoluntaryExitBatch) Reset() {
...
func (b *beaconApiEthV1EventsVoluntaryExitBatch) Snapshot() []map[string]any {
	n := b.rows
