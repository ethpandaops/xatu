...
const beaconApiEthV1ProposerDutyTableName flattener.TableName = "beacon_api_eth_v1_proposer_duty"

type beaconApiEthV1ProposerDutyBatch struct {
...
func newbeaconApiEthV1ProposerDutyBatch() *beaconApiEthV1ProposerDutyBatch {
	return &beaconApiEthV1ProposerDutyBatch{
...
func (b *beaconApiEthV1ProposerDutyBatch) Rows() int {
	return b.rows
}

func (b *beaconApiEthV1ProposerDutyBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *beaconApiEthV1ProposerDutyBatch) Input() proto.Input {
	return proto.Input{
...
func (b *beaconApiEthV1ProposerDutyBatch) Reset() {
...
func (b *beaconApiEthV1ProposerDutyBatch) Snapshot() []map[string]any {
	n := b.rows
