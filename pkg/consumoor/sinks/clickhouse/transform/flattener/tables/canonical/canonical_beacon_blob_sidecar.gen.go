...
const canonicalBeaconBlobSidecarTableName flattener.TableName = "canonical_beacon_blob_sidecar"
...
func newcanonicalBeaconBlobSidecarBatch() *canonicalBeaconBlobSidecarBatch {
	return &canonicalBeaconBlobSidecarBatch{
		...
		BlockParentRoot:                     func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(66); return c }(),
		...
		KzgProof:                            func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(98); return c }(),
...
func (b *canonicalBeaconBlobSidecarBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
