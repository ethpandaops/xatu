...
const canonicalBeaconBlockTableName flattener.TableName = "canonical_beacon_block"
...
func newcanonicalBeaconBlockBatch() *canonicalBeaconBlockBatch {
	return &canonicalBeaconBlockBatch{
		...
		ExecutionPayloadBlockHash:                        flattener.NewNullableFixedStr(66),
		...
		ExecutionPayloadStateRoot:                        flattener.NewNullableFixedStr(66),
		ExecutionPayloadParentHash:                       flattener.NewNullableFixedStr(66),
...
func (b *canonicalBeaconBlockBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
