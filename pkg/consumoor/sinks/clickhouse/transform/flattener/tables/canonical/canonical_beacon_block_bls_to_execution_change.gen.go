...
const canonicalBeaconBlockBlsToExecutionChangeTableName flattener.TableName = "canonical_beacon_block_bls_to_execution_change"
...
type canonicalBeaconBlockBlsToExecutionChangeBatch struct {
	...
	ExchangingMessageToExecutionAddress       flattener.SafeColFixedStr
...
func newcanonicalBeaconBlockBlsToExecutionChangeBatch() *canonicalBeaconBlockBlsToExecutionChangeBatch {
	return &canonicalBeaconBlockBlsToExecutionChangeBatch{
		...
		ExchangingMessageToExecutionAddress:       func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(42); return c }(),
...
func (b *canonicalBeaconBlockBlsToExecutionChangeBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
