...
func (CanonicalBeaconBlockBlsToExecutionChangeRoute) Table() flattener.TableName {
	return flattener.TableName("canonical_beacon_block_bls_to_execution_change")
}

func (r CanonicalBeaconBlockBlsToExecutionChangeRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_BEACON_API_ETH_V2_BEACON_BLOCK_BLS_TO_EXECUTION_CHANGE).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(CanonicalBeaconBlockBlsToExecutionChangeRoute{})
}
