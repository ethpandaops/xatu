...
const canonicalBeaconBlockSyncAggregateTableName flattener.TableName = "canonical_beacon_block_sync_aggregate"
...
func (b *canonicalBeaconBlockSyncAggregateBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
