...
const canonicalBeaconBlockVoluntaryExitTableName flattener.TableName = "canonical_beacon_block_voluntary_exit"
...
func (b *canonicalBeaconBlockVoluntaryExitBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
