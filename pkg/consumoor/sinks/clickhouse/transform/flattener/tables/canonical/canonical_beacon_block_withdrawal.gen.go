...
const canonicalBeaconBlockWithdrawalTableName flattener.TableName = "canonical_beacon_block_withdrawal"
...
type canonicalBeaconBlockWithdrawalBatch struct {
	...
	WithdrawalAddress                         flattener.SafeColFixedStr
...
func newcanonicalBeaconBlockWithdrawalBatch() *canonicalBeaconBlockWithdrawalBatch {
	return &canonicalBeaconBlockWithdrawalBatch{
		...
		WithdrawalAddress:                         func() flattener.SafeColFixedStr { var c flattener.SafeColFixedStr; c.SetSize(42); return c }(),
...
func (b *canonicalBeaconBlockWithdrawalBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *canonicalBeaconBlockWithdrawalBatch) Snapshot() []map[string]any {
	...
	for i := 0; i < n; i++ {
		...
		row["withdrawal_amount"] = flattener.UInt128ToString(b.WithdrawalAmount.Row(i))
