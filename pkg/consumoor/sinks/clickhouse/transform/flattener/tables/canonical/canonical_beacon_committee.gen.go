...
const canonicalBeaconCommitteeTableName flattener.TableName = "canonical_beacon_committee"
...
func (b *canonicalBeaconCommitteeBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
