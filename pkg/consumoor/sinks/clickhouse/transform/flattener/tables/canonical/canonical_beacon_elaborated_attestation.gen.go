...
const canonicalBeaconElaboratedAttestationTableName flattener.TableName = "canonical_beacon_elaborated_attestation"
...
func (b *canonicalBeaconElaboratedAttestationBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
