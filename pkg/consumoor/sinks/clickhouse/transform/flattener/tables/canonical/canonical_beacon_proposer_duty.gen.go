...
const canonicalBeaconProposerDutyTableName flattener.TableName = "canonical_beacon_proposer_duty"
...
func (b *canonicalBeaconProposerDutyBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
