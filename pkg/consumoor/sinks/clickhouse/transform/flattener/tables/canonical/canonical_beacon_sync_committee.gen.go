...
const canonicalBeaconSyncCommitteeTableName flattener.TableName = "canonical_beacon_sync_committee"
...
func (b *canonicalBeaconSyncCommitteeBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
