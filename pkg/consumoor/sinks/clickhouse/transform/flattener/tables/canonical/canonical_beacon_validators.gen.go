...
const canonicalBeaconValidatorsTableName flattener.TableName = "canonical_beacon_validators"
...
func (b *canonicalBeaconValidatorsBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
