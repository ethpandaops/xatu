...
const canonicalBeaconValidatorsPubkeysTableName flattener.TableName = "canonical_beacon_validators_pubkeys"
...
func (b *canonicalBeaconValidatorsPubkeysBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
