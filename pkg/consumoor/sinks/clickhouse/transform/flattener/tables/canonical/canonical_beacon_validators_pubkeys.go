...
const canonicalBeaconValidatorsPubkeysVersion uint32 = 1
...
func init() {
	flattener.MustRegister(flattener.NewStaticRoute(
		...
		func() flattener.ColumnarBatch {
			return newcanonicalBeaconValidatorsPubkeysBatch()
		},
	))
}
...
func (b *canonicalBeaconValidatorsPubkeysBatch) FlattenTo(
	...
	for _, validator := range payload.GetValidators() {
		...
		b.Version.Append(canonicalBeaconValidatorsPubkeysVersion)
