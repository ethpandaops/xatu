...
const canonicalBeaconValidatorsWithdrawalCredentialsTableName flattener.TableName = "canonical_beacon_validators_withdrawal_credentials"
...
func (b *canonicalBeaconValidatorsWithdrawalCredentialsBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
