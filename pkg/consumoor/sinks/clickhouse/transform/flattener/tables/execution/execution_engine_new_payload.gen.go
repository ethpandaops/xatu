...
const executionEngineNewPayloadTableName flattener.TableName = "execution_engine_new_payload"
...
func (b *executionEngineNewPayloadBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
