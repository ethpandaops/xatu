...
const libp2pAddPeerTableName flattener.TableName = "libp2p_add_peer"

type libp2pAddPeerBatch struct {
...
func newlibp2pAddPeerBatch() *libp2pAddPeerBatch {
	return &libp2pAddPeerBatch{
...
func (b *libp2pAddPeerBatch) Rows() int {
	return b.rows
}

func (b *libp2pAddPeerBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pAddPeerBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pAddPeerBatch) Reset() {
...
func (b *libp2pAddPeerBatch) Snapshot() []map[string]any {
	n := b.rows
