...
const libp2pDeliverMessageTableName flattener.TableName = "libp2p_deliver_message"
...
func (b *libp2pDeliverMessageBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
