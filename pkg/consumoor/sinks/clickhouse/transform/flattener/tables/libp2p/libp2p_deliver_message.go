...
func (Libp2pDeliverMessageRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_deliver_message")
}

func (r Libp2pDeliverMessageRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_DELIVER_MESSAGE).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pDeliverMessageRoute{})
}
