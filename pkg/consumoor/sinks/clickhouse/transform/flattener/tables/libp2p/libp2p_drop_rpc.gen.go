...
const libp2pDropRpcTableName flattener.TableName = "libp2p_drop_rpc"

type libp2pDropRpcBatch struct {
...
func newlibp2pDropRpcBatch() *libp2pDropRpcBatch {
	return &libp2pDropRpcBatch{
...
func (b *libp2pDropRpcBatch) Rows() int {
	return b.rows
}

func (b *libp2pDropRpcBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pDropRpcBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pDropRpcBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pDropRpcBatch) Snapshot() []map[string]any {
	n := b.rows
