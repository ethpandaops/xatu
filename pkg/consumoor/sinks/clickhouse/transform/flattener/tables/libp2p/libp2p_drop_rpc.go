...
type Libp2pDropRpcRoute struct{}

func (Libp2pDropRpcRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_drop_rpc")
}

func (r Libp2pDropRpcRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_DROP_RPC).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pDropRpcRoute{})
}
