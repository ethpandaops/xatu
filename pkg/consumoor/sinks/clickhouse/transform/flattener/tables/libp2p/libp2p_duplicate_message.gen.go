...
const libp2pDuplicateMessageTableName flattener.TableName = "libp2p_duplicate_message"
...
func (b *libp2pDuplicateMessageBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
