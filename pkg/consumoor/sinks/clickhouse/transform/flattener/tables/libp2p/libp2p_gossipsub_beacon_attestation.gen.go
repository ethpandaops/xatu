...
const libp2pGossipsubBeaconAttestationTableName flattener.TableName = "libp2p_gossipsub_beacon_attestation"
...
func (b *libp2pGossipsubBeaconAttestationBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
