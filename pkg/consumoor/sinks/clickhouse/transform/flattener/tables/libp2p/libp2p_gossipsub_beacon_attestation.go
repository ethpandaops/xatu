...
func (Libp2pGossipsubBeaconAttestationRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_gossipsub_beacon_attestation")
}

func (r Libp2pGossipsubBeaconAttestationRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_GOSSIPSUB_BEACON_ATTESTATION).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pGossipsubBeaconAttestationRoute{})
}
