...
const libp2pGossipsubBeaconBlockTableName flattener.TableName = "libp2p_gossipsub_beacon_block"

type libp2pGossipsubBeaconBlockBatch struct {
...
func newlibp2pGossipsubBeaconBlockBatch() *libp2pGossipsubBeaconBlockBatch {
	return &libp2pGossipsubBeaconBlockBatch{
...
func (b *libp2pGossipsubBeaconBlockBatch) Rows() int {
	return b.rows
}

func (b *libp2pGossipsubBeaconBlockBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pGossipsubBeaconBlockBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pGossipsubBeaconBlockBatch) Reset() {
...
func (b *libp2pGossipsubBeaconBlockBatch) Snapshot() []map[string]any {
	n := b.rows
