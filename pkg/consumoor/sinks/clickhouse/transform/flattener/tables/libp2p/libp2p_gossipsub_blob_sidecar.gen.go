...
const libp2pGossipsubBlobSidecarTableName flattener.TableName = "libp2p_gossipsub_blob_sidecar"

type libp2pGossipsubBlobSidecarBatch struct {
...
func newlibp2pGossipsubBlobSidecarBatch() *libp2pGossipsubBlobSidecarBatch {
	return &libp2pGossipsubBlobSidecarBatch{
...
func (b *libp2pGossipsubBlobSidecarBatch) Rows() int {
	return b.rows
}

func (b *libp2pGossipsubBlobSidecarBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pGossipsubBlobSidecarBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pGossipsubBlobSidecarBatch) Reset() {
...
func (b *libp2pGossipsubBlobSidecarBatch) Snapshot() []map[string]any {
	n := b.rows
