...
const libp2pGossipsubDataColumnSidecarTableName flattener.TableName = "libp2p_gossipsub_data_column_sidecar"
...
func (b *libp2pGossipsubDataColumnSidecarBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
