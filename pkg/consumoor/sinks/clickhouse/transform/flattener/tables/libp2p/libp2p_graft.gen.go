...
const libp2pGraftTableName flattener.TableName = "libp2p_graft"

type libp2pGraftBatch struct {
...
func newlibp2pGraftBatch() *libp2pGraftBatch {
	return &libp2pGraftBatch{
...
func (b *libp2pGraftBatch) Rows() int {
	return b.rows
}

func (b *libp2pGraftBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pGraftBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pGraftBatch) Snapshot() []map[string]any {
	n := b.rows
