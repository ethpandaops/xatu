...
func (Libp2pGraftRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_graft")
}

func (r Libp2pGraftRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_GRAFT).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pGraftRoute{})
}
