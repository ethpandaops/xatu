...
func (Libp2pJoinRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_join")
}

func (r Libp2pJoinRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_JOIN).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pJoinRoute{})
}
