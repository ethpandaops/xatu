...
const libp2pLeaveTableName flattener.TableName = "libp2p_leave"

type libp2pLeaveBatch struct {
...
func newlibp2pLeaveBatch() *libp2pLeaveBatch {
	return &libp2pLeaveBatch{
...
func (b *libp2pLeaveBatch) Rows() int {
	return b.rows
}

func (b *libp2pLeaveBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pLeaveBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pLeaveBatch) Snapshot() []map[string]any {
	n := b.rows
