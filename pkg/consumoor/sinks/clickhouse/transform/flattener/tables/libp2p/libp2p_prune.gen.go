...
const libp2pPruneTableName flattener.TableName = "libp2p_prune"

type libp2pPruneBatch struct {
...
func newlibp2pPruneBatch() *libp2pPruneBatch {
	return &libp2pPruneBatch{
...
func (b *libp2pPruneBatch) Rows() int {
	return b.rows
}

func (b *libp2pPruneBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pPruneBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pPruneBatch) Snapshot() []map[string]any {
	n := b.rows
