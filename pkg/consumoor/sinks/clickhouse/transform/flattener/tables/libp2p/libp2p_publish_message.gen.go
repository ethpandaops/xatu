...
const libp2pPublishMessageTableName flattener.TableName = "libp2p_publish_message"

type libp2pPublishMessageBatch struct {
...
func newlibp2pPublishMessageBatch() *libp2pPublishMessageBatch {
	return &libp2pPublishMessageBatch{
...
func (b *libp2pPublishMessageBatch) Rows() int {
	return b.rows
}

func (b *libp2pPublishMessageBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pPublishMessageBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pPublishMessageBatch) Reset() {
...
func (b *libp2pPublishMessageBatch) Snapshot() []map[string]any {
	n := b.rows
	out := make([]map[string]any, n)

	for i := 0; i < n; i++ {
		row := make(map[string]any, 23)
