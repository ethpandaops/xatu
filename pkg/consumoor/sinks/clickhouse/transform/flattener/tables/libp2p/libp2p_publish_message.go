...
func (Libp2pPublishMessageRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_publish_message")
}

func (r Libp2pPublishMessageRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_PUBLISH_MESSAGE).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pPublishMessageRoute{})
}
