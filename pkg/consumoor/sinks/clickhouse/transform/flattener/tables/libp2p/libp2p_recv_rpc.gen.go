...
const libp2pRecvRpcTableName flattener.TableName = "libp2p_recv_rpc"

type libp2pRecvRpcBatch struct {
...
func newlibp2pRecvRpcBatch() *libp2pRecvRpcBatch {
	return &libp2pRecvRpcBatch{
...
func (b *libp2pRecvRpcBatch) Rows() int {
	return b.rows
}

func (b *libp2pRecvRpcBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pRecvRpcBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pRecvRpcBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pRecvRpcBatch) Snapshot() []map[string]any {
	n := b.rows
