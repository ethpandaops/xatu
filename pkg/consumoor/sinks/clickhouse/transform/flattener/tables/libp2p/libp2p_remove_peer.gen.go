...
const libp2pRemovePeerTableName flattener.TableName = "libp2p_remove_peer"

type libp2pRemovePeerBatch struct {
...
func newlibp2pRemovePeerBatch() *libp2pRemovePeerBatch {
	return &libp2pRemovePeerBatch{
...
func (b *libp2pRemovePeerBatch) Rows() int {
	return b.rows
}

func (b *libp2pRemovePeerBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pRemovePeerBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pRemovePeerBatch) Reset() {
...
func (b *libp2pRemovePeerBatch) Snapshot() []map[string]any {
	n := b.rows
	out := make([]map[string]any, n)

	for i := 0; i < n; i++ {
		row := make(map[string]any, 19)
