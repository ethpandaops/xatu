...
func (Libp2pRemovePeerRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_remove_peer")
}

func (r Libp2pRemovePeerRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_REMOVE_PEER).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pRemovePeerRoute{})
}
