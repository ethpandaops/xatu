...
const libp2pRpcMetaControlGraftTableName flattener.TableName = "libp2p_rpc_meta_control_graft"

type libp2pRpcMetaControlGraftBatch struct {
...
func newlibp2pRpcMetaControlGraftBatch() *libp2pRpcMetaControlGraftBatch {
	return &libp2pRpcMetaControlGraftBatch{
...
func (b *libp2pRpcMetaControlGraftBatch) Rows() int {
	return b.rows
}

func (b *libp2pRpcMetaControlGraftBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pRpcMetaControlGraftBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pRpcMetaControlGraftBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pRpcMetaControlGraftBatch) Snapshot() []map[string]any {
	n := b.rows
