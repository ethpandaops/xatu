...
const libp2pRpcMetaControlIdontwantTableName flattener.TableName = "libp2p_rpc_meta_control_idontwant"

type libp2pRpcMetaControlIdontwantBatch struct {
...
func newlibp2pRpcMetaControlIdontwantBatch() *libp2pRpcMetaControlIdontwantBatch {
	return &libp2pRpcMetaControlIdontwantBatch{
...
func (b *libp2pRpcMetaControlIdontwantBatch) Rows() int {
	return b.rows
}

func (b *libp2pRpcMetaControlIdontwantBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pRpcMetaControlIdontwantBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pRpcMetaControlIdontwantBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pRpcMetaControlIdontwantBatch) Snapshot() []map[string]any {
	n := b.rows
	out := make([]map[string]any, n)

	for i := 0; i < n; i++ {
		row := make(map[string]any, 24)
