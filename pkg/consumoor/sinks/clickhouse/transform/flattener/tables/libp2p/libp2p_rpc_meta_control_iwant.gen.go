...
const libp2pRpcMetaControlIwantTableName flattener.TableName = "libp2p_rpc_meta_control_iwant"

type libp2pRpcMetaControlIwantBatch struct {
...
func newlibp2pRpcMetaControlIwantBatch() *libp2pRpcMetaControlIwantBatch {
	return &libp2pRpcMetaControlIwantBatch{
...
func (b *libp2pRpcMetaControlIwantBatch) Rows() int {
	return b.rows
}

func (b *libp2pRpcMetaControlIwantBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pRpcMetaControlIwantBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pRpcMetaControlIwantBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pRpcMetaControlIwantBatch) Snapshot() []map[string]any {
	n := b.rows
