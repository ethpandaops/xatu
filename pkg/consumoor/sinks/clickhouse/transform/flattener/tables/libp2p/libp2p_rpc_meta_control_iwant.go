...
func (Libp2pRpcMetaControlIwantRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_rpc_meta_control_iwant")
}

func (r Libp2pRpcMetaControlIwantRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_RPC_META_CONTROL_IWANT).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pRpcMetaControlIwantRoute{})
}
