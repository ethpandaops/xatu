...
const libp2pRpcMetaMessageTableName flattener.TableName = "libp2p_rpc_meta_message"
...
func (b *libp2pRpcMetaMessageBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
