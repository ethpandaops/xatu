...
const libp2pRpcMetaSubscriptionTableName flattener.TableName = "libp2p_rpc_meta_subscription"
...
func (b *libp2pRpcMetaSubscriptionBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
