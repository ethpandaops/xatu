...
func (Libp2pRpcMetaSubscriptionRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_rpc_meta_subscription")
}

func (r Libp2pRpcMetaSubscriptionRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_RPC_META_SUBSCRIPTION).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pRpcMetaSubscriptionRoute{})
}
