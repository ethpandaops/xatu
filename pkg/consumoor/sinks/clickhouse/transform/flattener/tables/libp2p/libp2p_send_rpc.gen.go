...
const libp2pSendRpcTableName flattener.TableName = "libp2p_send_rpc"

type libp2pSendRpcBatch struct {
...
func newlibp2pSendRpcBatch() *libp2pSendRpcBatch {
	return &libp2pSendRpcBatch{
...
func (b *libp2pSendRpcBatch) Rows() int {
	return b.rows
}

func (b *libp2pSendRpcBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
...
func (b *libp2pSendRpcBatch) Input() proto.Input {
	return proto.Input{
...
func (b *libp2pSendRpcBatch) Reset() {
	b.UniqueKey.Reset()
...
func (b *libp2pSendRpcBatch) Snapshot() []map[string]any {
	n := b.rows
