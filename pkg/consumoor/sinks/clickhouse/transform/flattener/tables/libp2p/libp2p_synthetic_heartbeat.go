...
func (Libp2pSyntheticHeartbeatRoute) Table() flattener.TableName {
	return flattener.TableName("libp2p_synthetic_heartbeat")
}

func (r Libp2pSyntheticHeartbeatRoute) Build() flattener.Route {
	return flattener.
		From(xatu.Event_LIBP2P_TRACE_SYNTHETIC_HEARTBEAT).
		To(r.Table()).
...
func init() {
	catalog.MustRegister(Libp2pSyntheticHeartbeatRoute{})
}
