...
const mevRelayProposerPayloadDeliveredTableName flattener.TableName = "mev_relay_proposer_payload_delivered"
...
func (b *mevRelayProposerPayloadDeliveredBatch) appendMetadata(meta *metadata.CommonMetadata) {
	if meta == nil {
