...
// SQL query builder for beacon_api_eth_v1_beacon_committee
...
// BuildListBeaconApiEthV1BeaconCommitteeQuery constructs a parameterized SQL query from a ListBeaconApiEthV1BeaconCommitteeRequest
func BuildListBeaconApiEthV1BeaconCommitteeQuery(req *ListBeaconApiEthV1BeaconCommitteeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "event_date_time", "slot", "slot_start_date_time", "committee_index", "validators", "epoch", "epoch_start_date_time", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", meta_client_name" + ", committee_index"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "committee_index", "validators", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}

	return BuildParameterizedQuery("beacon_api_eth_v1_beacon_committee", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetBeaconApiEthV1BeaconCommitteeQuery constructs a parameterized SQL query from a GetBeaconApiEthV1BeaconCommitteeRequest
func BuildGetBeaconApiEthV1BeaconCommitteeQuery(req *GetBeaconApiEthV1BeaconCommitteeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("beacon_api_eth_v1_beacon_committee", columns, qb, orderByClause, 1, 0, options...)
}
