...
// SQL query builder for beacon_api_eth_v1_events_attestation
...
// BuildListBeaconApiEthV1EventsAttestationQuery constructs a parameterized SQL query from a ListBeaconApiEthV1EventsAttestationRequest
func BuildListBeaconApiEthV1EventsAttestationQuery(req *ListBeaconApiEthV1EventsAttestationRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", meta_client_name" + ", attesting_validator_index" + ", attesting_validator_committee_index" + ", aggregation_bits" + ", beacon_block_root"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "propagation_slot_start_diff", "committee_index", "attesting_validator_index", "attesting_validator_committee_index", "aggregation_bits", "NULLIF(`beacon_block_root`, repeat('\x00', 66)) AS `beacon_block_root`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "source_epoch", "toUnixTimestamp(`source_epoch_start_date_time`) AS `source_epoch_start_date_time`", "NULLIF(`source_root`, repeat('\x00', 66)) AS `source_root`", "target_epoch", "toUnixTimestamp(`target_epoch_start_date_time`) AS `target_epoch_start_date_time`", "NULLIF(`target_root`, repeat('\x00', 66)) AS `target_root`", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}

	return BuildParameterizedQuery("beacon_api_eth_v1_events_attestation", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetBeaconApiEthV1EventsAttestationQuery constructs a parameterized SQL query from a GetBeaconApiEthV1EventsAttestationRequest
func BuildGetBeaconApiEthV1EventsAttestationQuery(req *GetBeaconApiEthV1EventsAttestationRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("beacon_api_eth_v1_events_attestation", columns, qb, orderByClause, 1, 0, options...)
}
