...
// SQL query builder for beacon_api_eth_v1_events_blob_sidecar
...
// BuildListBeaconApiEthV1EventsBlobSidecarQuery constructs a parameterized SQL query from a ListBeaconApiEthV1EventsBlobSidecarRequest
func BuildListBeaconApiEthV1EventsBlobSidecarQuery(req *ListBeaconApiEthV1EventsBlobSidecarRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "event_date_time", "slot", "slot_start_date_time", "propagation_slot_start_diff", "epoch", "epoch_start_date_time", "block_root", "blob_index", "kzg_commitment", "versioned_hash", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "propagation_slot_start_diff", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "NULLIF(`block_root`, repeat('\x00', 66)) AS `block_root`", "blob_index", "NULLIF(`kzg_commitment`, repeat('\x00', 98)) AS `kzg_commitment`", "NULLIF(`versioned_hash`, repeat('\x00', 66)) AS `versioned_hash`", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}

	return BuildParameterizedQuery("beacon_api_eth_v1_events_blob_sidecar", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetBeaconApiEthV1EventsBlobSidecarQuery constructs a parameterized SQL query from a GetBeaconApiEthV1EventsBlobSidecarRequest
func BuildGetBeaconApiEthV1EventsBlobSidecarQuery(req *GetBeaconApiEthV1EventsBlobSidecarRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("beacon_api_eth_v1_events_blob_sidecar", columns, qb, orderByClause, 1, 0, options...)
}
