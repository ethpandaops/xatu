...
// SQL query builder for beacon_api_eth_v1_events_block
...
// BuildListBeaconApiEthV1EventsBlockQuery constructs a parameterized SQL query from a ListBeaconApiEthV1EventsBlockRequest
func BuildListBeaconApiEthV1EventsBlockQuery(req *ListBeaconApiEthV1EventsBlockRequest, options ...QueryOption) (SQLQuery, error) {
...
// BuildGetBeaconApiEthV1EventsBlockQuery constructs a parameterized SQL query from a GetBeaconApiEthV1EventsBlockRequest
func BuildGetBeaconApiEthV1EventsBlockQuery(req *GetBeaconApiEthV1EventsBlockRequest, options ...QueryOption) (SQLQuery, error) {
