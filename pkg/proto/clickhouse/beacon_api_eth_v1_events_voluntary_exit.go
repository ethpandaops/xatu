...
// SQL query builder for beacon_api_eth_v1_events_voluntary_exit
...
// BuildListBeaconApiEthV1EventsVoluntaryExitQuery constructs a parameterized SQL query from a ListBeaconApiEthV1EventsVoluntaryExitRequest
func BuildListBeaconApiEthV1EventsVoluntaryExitQuery(req *ListBeaconApiEthV1EventsVoluntaryExitRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY meta_network_name" + ", wallclock_epoch_start_date_time" + ", meta_client_name" + ", validator_index"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "wallclock_slot", "toUnixTimestamp(`wallclock_slot_start_date_time`) AS `wallclock_slot_start_date_time`", "wallclock_epoch", "toUnixTimestamp(`wallclock_epoch_start_date_time`) AS `wallclock_epoch_start_date_time`", "validator_index", "signature", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}

	return BuildParameterizedQuery("beacon_api_eth_v1_events_voluntary_exit", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetBeaconApiEthV1EventsVoluntaryExitQuery constructs a parameterized SQL query from a GetBeaconApiEthV1EventsVoluntaryExitRequest
func BuildGetBeaconApiEthV1EventsVoluntaryExitQuery(req *GetBeaconApiEthV1EventsVoluntaryExitRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("beacon_api_eth_v1_events_voluntary_exit", columns, qb, orderByClause, 1, 0, options...)
}
