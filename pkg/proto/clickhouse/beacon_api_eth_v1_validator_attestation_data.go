...
// SQL query builder for beacon_api_eth_v1_validator_attestation_data
...
// BuildListBeaconApiEthV1ValidatorAttestationDataQuery constructs a parameterized SQL query from a ListBeaconApiEthV1ValidatorAttestationDataRequest
func BuildListBeaconApiEthV1ValidatorAttestationDataQuery(req *ListBeaconApiEthV1ValidatorAttestationDataRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: request_date_time
	if req.RequestDateTime != nil {
		switch filter := req.RequestDateTime.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("request_date_time", "=", DateTimeValue{filter.Eq})
		case *UInt32Filter_Ne:
			qb.AddCondition("request_date_time", "!=", DateTimeValue{filter.Ne})
		case *UInt32Filter_Lt:
			qb.AddCondition("request_date_time", "<", DateTimeValue{filter.Lt})
		case *UInt32Filter_Lte:
			qb.AddCondition("request_date_time", "<=", DateTimeValue{filter.Lte})
		case *UInt32Filter_Gt:
			qb.AddCondition("request_date_time", ">", DateTimeValue{filter.Gt})
		case *UInt32Filter_Gte:
			qb.AddCondition("request_date_time", ">=", DateTimeValue{filter.Gte})
		case *UInt32Filter_Between:
			qb.AddBetweenCondition("request_date_time", DateTimeValue{filter.Between.Min}, DateTimeValue{filter.Between.Max.GetValue()})
		case *UInt32Filter_In:
			if len(filter.In.Values) > 0 {
				converted := make([]interface{}, len(filter.In.Values))
				for i, v := range filter.In.Values {
				...
				qb.AddInCondition("request_date_time", converted)
			}
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				converted := make([]interface{}, len(filter.NotIn.Values))
				...
				qb.AddNotInCondition("request_date_time", converted)
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: request_duration
	if req.RequestDuration != nil {
		switch filter := req.RequestDuration.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("request_duration", "=", filter.Eq)
		case *UInt32Filter_Ne:
			qb.AddCondition("request_duration", "!=", filter.Ne)
		case *UInt32Filter_Lt:
			qb.AddCondition("request_duration", "<", filter.Lt)
		case *UInt32Filter_Lte:
			qb.AddCondition("request_duration", "<=", filter.Lte)
		case *UInt32Filter_Gt:
			qb.AddCondition("request_duration", ">", filter.Gt)
		case *UInt32Filter_Gte:
			qb.AddCondition("request_duration", ">=", filter.Gte)
		case *UInt32Filter_Between:
			qb.AddBetweenCondition("request_duration", filter.Between.Min, filter.Between.Max.GetValue())
		case *UInt32Filter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("request_duration", UInt32SliceToInterface(filter.In.Values))
			}
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("request_duration", UInt32SliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: request_slot_start_diff
	if req.RequestSlotStartDiff != nil {
		switch filter := req.RequestSlotStartDiff.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("request_slot_start_diff", "=", filter.Eq)
		case *UInt32Filter_Ne:
			qb.AddCondition("request_slot_start_diff", "!=", filter.Ne)
		case *UInt32Filter_Lt:
			qb.AddCondition("request_slot_start_diff", "<", filter.Lt)
		case *UInt32Filter_Lte:
			qb.AddCondition("request_slot_start_diff", "<=", filter.Lte)
		case *UInt32Filter_Gt:
			qb.AddCondition("request_slot_start_diff", ">", filter.Gt)
		case *UInt32Filter_Gte:
			qb.AddCondition("request_slot_start_diff", ">=", filter.Gte)
		case *UInt32Filter_Between:
			qb.AddBetweenCondition("request_slot_start_diff", filter.Between.Min, filter.Between.Max.GetValue())
		case *UInt32Filter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("request_slot_start_diff", UInt32SliceToInterface(filter.In.Values))
			}
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("request_slot_start_diff", UInt32SliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "event_date_time", "slot", "slot_start_date_time", "committee_index", "beacon_block_root", "epoch", "epoch_start_date_time", "source_epoch", "source_epoch_start_date_time", "source_root", "target_epoch", "target_epoch_start_date_time", "target_root", "request_date_time", "request_duration", "request_slot_start_diff", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", meta_client_name" + ", committee_index" + ", beacon_block_root" + ", source_root" + ", target_root"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "committee_index", "NULLIF(`beacon_block_root`, repeat('\x00', 66)) AS `beacon_block_root`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "source_epoch", "toUnixTimestamp(`source_epoch_start_date_time`) AS `source_epoch_start_date_time`", "NULLIF(`source_root`, repeat('\x00', 66)) AS `source_root`", "target_epoch", "toUnixTimestamp(`target_epoch_start_date_time`) AS `target_epoch_start_date_time`", "NULLIF(`target_root`, repeat('\x00', 66)) AS `target_root`", "toUnixTimestamp(`request_date_time`) AS `request_date_time`", "request_duration", "request_slot_start_diff", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name", "meta_consensus_version", "meta_consensus_version_major", "meta_consensus_version_minor", "meta_consensus_version_patch", "meta_consensus_implementation"}

	return BuildParameterizedQuery("beacon_api_eth_v1_validator_attestation_data", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetBeaconApiEthV1ValidatorAttestationDataQuery constructs a parameterized SQL query from a GetBeaconApiEthV1ValidatorAttestationDataRequest
func BuildGetBeaconApiEthV1ValidatorAttestationDataQuery(req *GetBeaconApiEthV1ValidatorAttestationDataRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("beacon_api_eth_v1_validator_attestation_data", columns, qb, orderByClause, 1, 0, options...)
}
