...
// SQL query builder for beacon_api_eth_v2_beacon_block
...
// BuildListBeaconApiEthV2BeaconBlockQuery constructs a parameterized SQL query from a ListBeaconApiEthV2BeaconBlockRequest
func BuildListBeaconApiEthV2BeaconBlockQuery(req *ListBeaconApiEthV2BeaconBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", meta_client_name" + ", block_root" + ", parent_root" + ", state_root"
	}
	...
	return BuildParameterizedQuery("beacon_api_eth_v2_beacon_block", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetBeaconApiEthV2BeaconBlockQuery constructs a parameterized SQL query from a GetBeaconApiEthV2BeaconBlockRequest
func BuildGetBeaconApiEthV2BeaconBlockQuery(req *GetBeaconApiEthV2BeaconBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("beacon_api_eth_v2_beacon_block", columns, qb, orderByClause, 1, 0, options...)
}
