...
// SQL query builder for canonical_beacon_block_deposit
...
// BuildListCanonicalBeaconBlockDepositQuery constructs a parameterized SQL query from a ListCanonicalBeaconBlockDepositRequest
func BuildListCanonicalBeaconBlockDepositQuery(req *ListCanonicalBeaconBlockDepositRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: deposit_proof
	if req.DepositProof != nil {
		switch filter := req.DepositProof.Filter.(type) {
		case *ArrayStringFilter_Has:
			qb.AddArrayHasCondition("deposit_proof", filter.Has)
		case *ArrayStringFilter_HasAll:
			if len(filter.HasAll.Values) > 0 {
				qb.AddArrayHasAllCondition("deposit_proof", StringSliceToInterface(filter.HasAll.Values))
			}
		case *ArrayStringFilter_HasAny:
			if len(filter.HasAny.Values) > 0 {
				qb.AddArrayHasAnyCondition("deposit_proof", StringSliceToInterface(filter.HasAny.Values))
			}
		case *ArrayStringFilter_LengthEq:
			qb.AddArrayLengthCondition("deposit_proof", "=", filter.LengthEq)
		case *ArrayStringFilter_LengthGt:
			qb.AddArrayLengthCondition("deposit_proof", ">", filter.LengthGt)
		case *ArrayStringFilter_LengthGte:
			qb.AddArrayLengthCondition("deposit_proof", ">=", filter.LengthGte)
		case *ArrayStringFilter_LengthLt:
			qb.AddArrayLengthCondition("deposit_proof", "<", filter.LengthLt)
		case *ArrayStringFilter_LengthLte:
			qb.AddArrayLengthCondition("deposit_proof", "<=", filter.LengthLte)
		case *ArrayStringFilter_IsEmpty:
			qb.AddArrayIsEmptyCondition("deposit_proof")
		case *ArrayStringFilter_IsNotEmpty:
			qb.AddArrayIsNotEmptyCondition("deposit_proof")
		default:
			// Unsupported filter type
		}
	}

	// Add filter for column: deposit_data_pubkey
	if req.DepositDataPubkey != nil {
		switch filter := req.DepositDataPubkey.Filter.(type) {
		case *StringFilter_Eq:
			qb.AddCondition("deposit_data_pubkey", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("deposit_data_pubkey", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("deposit_data_pubkey", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("deposit_data_pubkey", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("deposit_data_pubkey", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("deposit_data_pubkey", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("deposit_data_pubkey", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("deposit_data_pubkey", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("deposit_data_pubkey", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: deposit_data_withdrawal_credentials
	if req.DepositDataWithdrawalCredentials != nil {
		switch filter := req.DepositDataWithdrawalCredentials.Filter.(type) {
		case *StringFilter_Eq:
			qb.AddCondition("deposit_data_withdrawal_credentials", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("deposit_data_withdrawal_credentials", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("deposit_data_withdrawal_credentials", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("deposit_data_withdrawal_credentials", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("deposit_data_withdrawal_credentials", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("deposit_data_withdrawal_credentials", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("deposit_data_withdrawal_credentials", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("deposit_data_withdrawal_credentials", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("deposit_data_withdrawal_credentials", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: deposit_data_amount
	if req.DepositDataAmount != nil {
		switch filter := req.DepositDataAmount.Filter.(type) {
		case *StringFilter_Eq:
			qb.AddCondition("deposit_data_amount", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("deposit_data_amount", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("deposit_data_amount", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("deposit_data_amount", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("deposit_data_amount", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("deposit_data_amount", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("deposit_data_amount", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("deposit_data_amount", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("deposit_data_amount", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: deposit_data_signature
	if req.DepositDataSignature != nil {
		switch filter := req.DepositDataSignature.Filter.(type) {
		case *StringFilter_Eq:
			qb.AddCondition("deposit_data_signature", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("deposit_data_signature", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("deposit_data_signature", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("deposit_data_signature", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("deposit_data_signature", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("deposit_data_signature", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("deposit_data_signature", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("deposit_data_signature", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("deposit_data_signature", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "block_version", "deposit_proof", "deposit_data_pubkey", "deposit_data_withdrawal_credentials", "deposit_data_amount", "deposit_data_signature", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", block_root" + ", deposit_data_pubkey" + ", deposit_proof"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "NULLIF(`block_root`, repeat('\x00', 66)) AS `block_root`", "block_version", "deposit_proof", "deposit_data_pubkey", "NULLIF(`deposit_data_withdrawal_credentials`, repeat('\x00', 66)) AS `deposit_data_withdrawal_credentials`", "toString(`deposit_data_amount`) AS `deposit_data_amount`", "deposit_data_signature", "meta_network_name"}

	return BuildParameterizedQuery("canonical_beacon_block_deposit", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetCanonicalBeaconBlockDepositQuery constructs a parameterized SQL query from a GetCanonicalBeaconBlockDepositRequest
func BuildGetCanonicalBeaconBlockDepositQuery(req *GetCanonicalBeaconBlockDepositRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("canonical_beacon_block_deposit", columns, qb, orderByClause, 1, 0, options...)
}
