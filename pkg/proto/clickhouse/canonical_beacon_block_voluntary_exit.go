...
// SQL query builder for canonical_beacon_block_voluntary_exit
...
// BuildListCanonicalBeaconBlockVoluntaryExitQuery constructs a parameterized SQL query from a ListCanonicalBeaconBlockVoluntaryExitRequest
func BuildListCanonicalBeaconBlockVoluntaryExitQuery(req *ListCanonicalBeaconBlockVoluntaryExitRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: voluntary_exit_message_epoch
	if req.VoluntaryExitMessageEpoch != nil {
		switch filter := req.VoluntaryExitMessageEpoch.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("voluntary_exit_message_epoch", "=", filter.Eq)
		case *UInt32Filter_Ne:
			qb.AddCondition("voluntary_exit_message_epoch", "!=", filter.Ne)
		case *UInt32Filter_Lt:
			qb.AddCondition("voluntary_exit_message_epoch", "<", filter.Lt)
		case *UInt32Filter_Lte:
			qb.AddCondition("voluntary_exit_message_epoch", "<=", filter.Lte)
		case *UInt32Filter_Gt:
			qb.AddCondition("voluntary_exit_message_epoch", ">", filter.Gt)
		case *UInt32Filter_Gte:
			qb.AddCondition("voluntary_exit_message_epoch", ">=", filter.Gte)
		case *UInt32Filter_Between:
			qb.AddBetweenCondition("voluntary_exit_message_epoch", filter.Between.Min, filter.Between.Max.GetValue())
		case *UInt32Filter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("voluntary_exit_message_epoch", UInt32SliceToInterface(filter.In.Values))
			}
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("voluntary_exit_message_epoch", UInt32SliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: voluntary_exit_message_validator_index
	if req.VoluntaryExitMessageValidatorIndex != nil {
		switch filter := req.VoluntaryExitMessageValidatorIndex.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("voluntary_exit_message_validator_index", "=", filter.Eq)
		case *UInt32Filter_Ne:
			qb.AddCondition("voluntary_exit_message_validator_index", "!=", filter.Ne)
		case *UInt32Filter_Lt:
			qb.AddCondition("voluntary_exit_message_validator_index", "<", filter.Lt)
		case *UInt32Filter_Lte:
			qb.AddCondition("voluntary_exit_message_validator_index", "<=", filter.Lte)
		case *UInt32Filter_Gt:
			qb.AddCondition("voluntary_exit_message_validator_index", ">", filter.Gt)
		case *UInt32Filter_Gte:
			qb.AddCondition("voluntary_exit_message_validator_index", ">=", filter.Gte)
		case *UInt32Filter_Between:
			qb.AddBetweenCondition("voluntary_exit_message_validator_index", filter.Between.Min, filter.Between.Max.GetValue())
		case *UInt32Filter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("voluntary_exit_message_validator_index", UInt32SliceToInterface(filter.In.Values))
			}
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("voluntary_exit_message_validator_index", UInt32SliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: voluntary_exit_signature
	if req.VoluntaryExitSignature != nil {
		switch filter := req.VoluntaryExitSignature.Filter.(type) {
		case *StringFilter_Eq:
			qb.AddCondition("voluntary_exit_signature", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("voluntary_exit_signature", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("voluntary_exit_signature", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("voluntary_exit_signature", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("voluntary_exit_signature", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("voluntary_exit_signature", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("voluntary_exit_signature", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("voluntary_exit_signature", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("voluntary_exit_signature", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "block_version", "voluntary_exit_message_epoch", "voluntary_exit_message_validator_index", "voluntary_exit_signature", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", block_root" + ", voluntary_exit_message_epoch" + ", voluntary_exit_message_validator_index"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "NULLIF(`block_root`, repeat('\x00', 66)) AS `block_root`", "block_version", "voluntary_exit_message_epoch", "voluntary_exit_message_validator_index", "voluntary_exit_signature", "meta_network_name"}

	return BuildParameterizedQuery("canonical_beacon_block_voluntary_exit", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetCanonicalBeaconBlockVoluntaryExitQuery constructs a parameterized SQL query from a GetCanonicalBeaconBlockVoluntaryExitRequest
func BuildGetCanonicalBeaconBlockVoluntaryExitQuery(req *GetCanonicalBeaconBlockVoluntaryExitRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("canonical_beacon_block_voluntary_exit", columns, qb, orderByClause, 1, 0, options...)
}
