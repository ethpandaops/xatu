...
// SQL query builder for canonical_beacon_committee
...
// BuildListCanonicalBeaconCommitteeQuery constructs a parameterized SQL query from a ListCanonicalBeaconCommitteeRequest
func BuildListCanonicalBeaconCommitteeQuery(req *ListCanonicalBeaconCommitteeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "slot", "slot_start_date_time", "committee_index", "validators", "epoch", "epoch_start_date_time", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", committee_index"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "committee_index", "validators", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "meta_network_name"}

	return BuildParameterizedQuery("canonical_beacon_committee", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetCanonicalBeaconCommitteeQuery constructs a parameterized SQL query from a GetCanonicalBeaconCommitteeRequest
func BuildGetCanonicalBeaconCommitteeQuery(req *GetCanonicalBeaconCommitteeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("canonical_beacon_committee", columns, qb, orderByClause, 1, 0, options...)
}
