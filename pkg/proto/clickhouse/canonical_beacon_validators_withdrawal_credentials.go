...
// SQL query builder for canonical_beacon_validators_withdrawal_credentials
...
// BuildListCanonicalBeaconValidatorsWithdrawalCredentialsQuery constructs a parameterized SQL query from a ListCanonicalBeaconValidatorsWithdrawalCredentialsRequest
func BuildListCanonicalBeaconValidatorsWithdrawalCredentialsQuery(req *ListCanonicalBeaconValidatorsWithdrawalCredentialsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "epoch", "epoch_start_date_time", "index", "withdrawal_credentials", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", index" + ", withdrawal_credentials"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "index", "withdrawal_credentials", "meta_network_name"}

	return BuildParameterizedQuery("canonical_beacon_validators_withdrawal_credentials", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetCanonicalBeaconValidatorsWithdrawalCredentialsQuery constructs a parameterized SQL query from a GetCanonicalBeaconValidatorsWithdrawalCredentialsRequest
func BuildGetCanonicalBeaconValidatorsWithdrawalCredentialsQuery(req *GetCanonicalBeaconValidatorsWithdrawalCredentialsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("canonical_beacon_validators_withdrawal_credentials", columns, qb, orderByClause, 1, 0, options...)
}
