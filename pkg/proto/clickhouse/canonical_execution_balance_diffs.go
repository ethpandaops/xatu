...
// SQL query builder for canonical_execution_balance_diffs
...
// BuildListCanonicalExecutionBalanceDiffsQuery constructs a parameterized SQL query from a ListCanonicalExecutionBalanceDiffsRequest
func BuildListCanonicalExecutionBalanceDiffsQuery(req *ListCanonicalExecutionBalanceDiffsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "transaction_index", "transaction_hash", "internal_index", "address", "from_value", "to_value", "meta_network_name"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "transaction_index", "NULLIF(`transaction_hash`, repeat('\x00', 66)) AS `transaction_hash`", "internal_index", "address", "toString(`from_value`) AS `from_value`", "toString(`to_value`) AS `to_value`", "meta_network_name"}

	return BuildParameterizedQuery("canonical_execution_balance_diffs", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetCanonicalExecutionBalanceDiffsQuery constructs a parameterized SQL query from a GetCanonicalExecutionBalanceDiffsRequest
func BuildGetCanonicalExecutionBalanceDiffsQuery(req *GetCanonicalExecutionBalanceDiffsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("canonical_execution_balance_diffs", columns, qb, orderByClause, 1, 0, options...)
}
