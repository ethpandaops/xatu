...
// SQL query builder for canonical_execution_nonce_reads
...
// BuildListCanonicalExecutionNonceReadsQuery constructs a parameterized SQL query from a ListCanonicalExecutionNonceReadsRequest
func BuildListCanonicalExecutionNonceReadsQuery(req *ListCanonicalExecutionNonceReadsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "transaction_index", "transaction_hash", "internal_index", "address", "nonce", "meta_network_name"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "transaction_index", "NULLIF(`transaction_hash`, repeat('\x00', 66)) AS `transaction_hash`", "internal_index", "address", "nonce", "meta_network_name"}

	return BuildParameterizedQuery("canonical_execution_nonce_reads", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetCanonicalExecutionNonceReadsQuery constructs a parameterized SQL query from a GetCanonicalExecutionNonceReadsRequest
func BuildGetCanonicalExecutionNonceReadsQuery(req *GetCanonicalExecutionNonceReadsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("canonical_execution_nonce_reads", columns, qb, orderByClause, 1, 0, options...)
}
