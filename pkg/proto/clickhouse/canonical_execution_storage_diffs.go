...
// SQL query builder for canonical_execution_storage_diffs
...
// BuildListCanonicalExecutionStorageDiffsQuery constructs a parameterized SQL query from a ListCanonicalExecutionStorageDiffsRequest
func BuildListCanonicalExecutionStorageDiffsQuery(req *ListCanonicalExecutionStorageDiffsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: from_value
	if req.FromValue != nil {
		switch filter := req.FromValue.Filter.(type) {
		case *StringFilter_Eq:
			qb.AddCondition("from_value", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("from_value", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("from_value", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("from_value", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("from_value", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("from_value", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("from_value", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("from_value", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("from_value", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	// Add filter for column: to_value
	if req.ToValue != nil {
		switch filter := req.ToValue.Filter.(type) {
		case *StringFilter_Eq:
			qb.AddCondition("to_value", "=", filter.Eq)
		case *StringFilter_Ne:
			qb.AddCondition("to_value", "!=", filter.Ne)
		case *StringFilter_Contains:
			qb.AddLikeCondition("to_value", "%" + filter.Contains + "%")
		case *StringFilter_StartsWith:
			qb.AddLikeCondition("to_value", filter.StartsWith + "%")
		case *StringFilter_EndsWith:
			qb.AddLikeCondition("to_value", "%" + filter.EndsWith)
		case *StringFilter_Like:
			qb.AddLikeCondition("to_value", filter.Like)
		case *StringFilter_NotLike:
			qb.AddNotLikeCondition("to_value", filter.NotLike)
		case *StringFilter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("to_value", StringSliceToInterface(filter.In.Values))
			}
		case *StringFilter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("to_value", StringSliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "block_number", "transaction_index", "transaction_hash", "internal_index", "address", "slot", "from_value", "to_value", "meta_network_name"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "block_number", "transaction_index", "NULLIF(`transaction_hash`, repeat('\x00', 66)) AS `transaction_hash`", "internal_index", "address", "slot", "from_value", "to_value", "meta_network_name"}

	return BuildParameterizedQuery("canonical_execution_storage_diffs", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetCanonicalExecutionStorageDiffsQuery constructs a parameterized SQL query from a GetCanonicalExecutionStorageDiffsRequest
func BuildGetCanonicalExecutionStorageDiffsQuery(req *GetCanonicalExecutionStorageDiffsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("canonical_execution_storage_diffs", columns, qb, orderByClause, 1, 0, options...)
}
