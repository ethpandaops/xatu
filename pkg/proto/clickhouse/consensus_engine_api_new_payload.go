...
// SQL query builder for consensus_engine_api_new_payload
...
// BuildListConsensusEngineApiNewPayloadQuery constructs a parameterized SQL query from a ListConsensusEngineApiNewPayloadRequest
func BuildListConsensusEngineApiNewPayloadQuery(req *ListConsensusEngineApiNewPayloadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "event_date_time", "requested_date_time", "duration_ms", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "block_root", "parent_block_root", "proposer_index", "block_number", "block_hash", "parent_hash", "gas_used", "gas_limit", "tx_count", "blob_count", "status", "latest_valid_hash", "validation_error", "method_version", "meta_execution_version", "meta_execution_implementation", "meta_execution_version_major", "meta_execution_version_minor", "meta_execution_version_patch", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", slot_start_date_time" + ", meta_client_name" + ", block_hash" + ", event_date_time"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "toUnixTimestamp64Micro(`requested_date_time`) AS `requested_date_time`", "duration_ms", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "NULLIF(`block_root`, repeat('\x00', 66)) AS `block_root`", "NULLIF(`parent_block_root`, repeat('\x00', 66)) AS `parent_block_root`", "proposer_index", "block_number", "NULLIF(`block_hash`, repeat('\x00', 66)) AS `block_hash`", "NULLIF(`parent_hash`, repeat('\x00', 66)) AS `parent_hash`", "gas_used", "gas_limit", "tx_count", "blob_count", "status", "NULLIF(`latest_valid_hash`, repeat('\x00', 66)) AS `latest_valid_hash`", "validation_error", "method_version", "meta_execution_version", "meta_execution_implementation", "meta_execution_version_major", "meta_execution_version_minor", "meta_execution_version_patch", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("consensus_engine_api_new_payload", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetConsensusEngineApiNewPayloadQuery constructs a parameterized SQL query from a GetConsensusEngineApiNewPayloadRequest
func BuildGetConsensusEngineApiNewPayloadQuery(req *GetConsensusEngineApiNewPayloadRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("consensus_engine_api_new_payload", columns, qb, orderByClause, 1, 0, options...)
}
