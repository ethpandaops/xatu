...
// SQL query builder for execution_engine_get_blobs
...
// BuildListExecutionEngineGetBlobsQuery constructs a parameterized SQL query from a ListExecutionEngineGetBlobsRequest
func BuildListExecutionEngineGetBlobsQuery(req *ListExecutionEngineGetBlobsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY meta_network_name" + ", event_date_time" + ", meta_client_name"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "toUnixTimestamp64Micro(`requested_date_time`) AS `requested_date_time`", "duration_ms", "source", "requested_count", "versioned_hashes", "returned_count", "arrayMap(x -> toUInt32(x), `returned_blob_indexes`) AS `returned_blob_indexes`", "status", "error_message", "method_version", "meta_execution_implementation", "meta_execution_version", "meta_execution_version_major", "meta_execution_version_minor", "meta_execution_version_patch", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("execution_engine_get_blobs", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetExecutionEngineGetBlobsQuery constructs a parameterized SQL query from a GetExecutionEngineGetBlobsRequest
func BuildGetExecutionEngineGetBlobsQuery(req *GetExecutionEngineGetBlobsRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("execution_engine_get_blobs", columns, qb, orderByClause, 1, 0, options...)
}
