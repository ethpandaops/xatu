...
// SQL query builder for libp2p_deliver_message
...
// BuildListLibp2PDeliverMessageQuery constructs a parameterized SQL query from a ListLibp2PDeliverMessageRequest
func BuildListLibp2PDeliverMessageQuery(req *ListLibp2PDeliverMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_deliver_message", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PDeliverMessageQuery constructs a parameterized SQL query from a GetLibp2PDeliverMessageRequest
func BuildGetLibp2PDeliverMessageQuery(req *GetLibp2PDeliverMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_deliver_message", columns, qb, orderByClause, 1, 0, options...)
}
