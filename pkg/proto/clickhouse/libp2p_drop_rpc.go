...
// SQL query builder for libp2p_drop_rpc
...
// BuildListLibp2PDropRpcQuery constructs a parameterized SQL query from a ListLibp2PDropRpcRequest
func BuildListLibp2PDropRpcQuery(req *ListLibp2PDropRpcRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_drop_rpc", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PDropRpcQuery constructs a parameterized SQL query from a GetLibp2PDropRpcRequest
func BuildGetLibp2PDropRpcQuery(req *GetLibp2PDropRpcRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_drop_rpc", columns, qb, orderByClause, 1, 0, options...)
}
