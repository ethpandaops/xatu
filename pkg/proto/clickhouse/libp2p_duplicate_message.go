...
// SQL query builder for libp2p_duplicate_message
...
// BuildListLibp2PDuplicateMessageQuery constructs a parameterized SQL query from a ListLibp2PDuplicateMessageRequest
func BuildListLibp2PDuplicateMessageQuery(req *ListLibp2PDuplicateMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_duplicate_message", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PDuplicateMessageQuery constructs a parameterized SQL query from a GetLibp2PDuplicateMessageRequest
func BuildGetLibp2PDuplicateMessageQuery(req *GetLibp2PDuplicateMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_duplicate_message", columns, qb, orderByClause, 1, 0, options...)
}
