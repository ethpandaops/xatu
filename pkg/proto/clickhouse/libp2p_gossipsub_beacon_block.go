...
// SQL query builder for libp2p_gossipsub_beacon_block
...
// BuildListLibp2PGossipsubBeaconBlockQuery constructs a parameterized SQL query from a ListLibp2PGossipsubBeaconBlockRequest
func BuildListLibp2PGossipsubBeaconBlockQuery(req *ListLibp2PGossipsubBeaconBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "wallclock_slot", "toUnixTimestamp(`wallclock_slot_start_date_time`) AS `wallclock_slot_start_date_time`", "wallclock_epoch", "toUnixTimestamp(`wallclock_epoch_start_date_time`) AS `wallclock_epoch_start_date_time`", "propagation_slot_start_diff", "NULLIF(`block`, repeat('\x00', 66)) AS `block`", "proposer_index", "peer_id_unique_key", "message_id", "message_size", "topic_layer", "topic_fork_digest_value", "topic_name", "topic_encoding", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("libp2p_gossipsub_beacon_block", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PGossipsubBeaconBlockQuery constructs a parameterized SQL query from a GetLibp2PGossipsubBeaconBlockRequest
func BuildGetLibp2PGossipsubBeaconBlockQuery(req *GetLibp2PGossipsubBeaconBlockRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_gossipsub_beacon_block", columns, qb, orderByClause, 1, 0, options...)
}
