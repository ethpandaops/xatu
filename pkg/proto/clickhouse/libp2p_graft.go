...
// SQL query builder for libp2p_graft
...
// BuildListLibp2PGraftQuery constructs a parameterized SQL query from a ListLibp2PGraftRequest
func BuildListLibp2PGraftQuery(req *ListLibp2PGraftRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_graft", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PGraftQuery constructs a parameterized SQL query from a GetLibp2PGraftRequest
func BuildGetLibp2PGraftQuery(req *GetLibp2PGraftRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_graft", columns, qb, orderByClause, 1, 0, options...)
}
