...
// SQL query builder for libp2p_join
...
// BuildListLibp2PJoinQuery constructs a parameterized SQL query from a ListLibp2PJoinRequest
func BuildListLibp2PJoinQuery(req *ListLibp2PJoinRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_join", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PJoinQuery constructs a parameterized SQL query from a GetLibp2PJoinRequest
func BuildGetLibp2PJoinQuery(req *GetLibp2PJoinRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_join", columns, qb, orderByClause, 1, 0, options...)
}
