...
// SQL query builder for libp2p_prune
...
// BuildListLibp2PPruneQuery constructs a parameterized SQL query from a ListLibp2PPruneRequest
func BuildListLibp2PPruneQuery(req *ListLibp2PPruneRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY meta_network_name" + ", event_date_time" + ", meta_client_name" + ", peer_id_unique_key" + ", topic_fork_digest_value" + ", topic_name"
	}
	...
	return BuildParameterizedQuery("libp2p_prune", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PPruneQuery constructs a parameterized SQL query from a GetLibp2PPruneRequest
func BuildGetLibp2PPruneQuery(req *GetLibp2PPruneRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_prune", columns, qb, orderByClause, 1, 0, options...)
}
