...
// SQL query builder for libp2p_publish_message
...
// BuildListLibp2PPublishMessageQuery constructs a parameterized SQL query from a ListLibp2PPublishMessageRequest
func BuildListLibp2PPublishMessageQuery(req *ListLibp2PPublishMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		...
		orderByClause = " ORDER BY meta_network_name" + ", event_date_time" + ", meta_client_name" + ", topic_fork_digest_value" + ", topic_name" + ", message_id"
	}
	...
	return BuildParameterizedQuery("libp2p_publish_message", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PPublishMessageQuery constructs a parameterized SQL query from a GetLibp2PPublishMessageRequest
func BuildGetLibp2PPublishMessageQuery(req *GetLibp2PPublishMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_publish_message", columns, qb, orderByClause, 1, 0, options...)
}
