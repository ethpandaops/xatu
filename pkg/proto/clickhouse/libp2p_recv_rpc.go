...
// SQL query builder for libp2p_recv_rpc
...
// BuildListLibp2PRecvRpcQuery constructs a parameterized SQL query from a ListLibp2PRecvRpcRequest
func BuildListLibp2PRecvRpcQuery(req *ListLibp2PRecvRpcRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_recv_rpc", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PRecvRpcQuery constructs a parameterized SQL query from a GetLibp2PRecvRpcRequest
func BuildGetLibp2PRecvRpcQuery(req *GetLibp2PRecvRpcRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_recv_rpc", columns, qb, orderByClause, 1, 0, options...)
}
