...
// SQL query builder for libp2p_rpc_data_column_custody_probe
...
// BuildListLibp2PRpcDataColumnCustodyProbeQuery constructs a parameterized SQL query from a ListLibp2PRpcDataColumnCustodyProbeRequest
func BuildListLibp2PRpcDataColumnCustodyProbeQuery(req *ListLibp2PRpcDataColumnCustodyProbeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Add filter for column: column_rows_count
	if req.ColumnRowsCount != nil {
		switch filter := req.ColumnRowsCount.Filter.(type) {
		case *UInt32Filter_Eq:
			qb.AddCondition("column_rows_count", "=", filter.Eq)
		case *UInt32Filter_Ne:
			qb.AddCondition("column_rows_count", "!=", filter.Ne)
		case *UInt32Filter_Lt:
			qb.AddCondition("column_rows_count", "<", filter.Lt)
		case *UInt32Filter_Lte:
			qb.AddCondition("column_rows_count", "<=", filter.Lte)
		case *UInt32Filter_Gt:
			qb.AddCondition("column_rows_count", ">", filter.Gt)
		case *UInt32Filter_Gte:
			qb.AddCondition("column_rows_count", ">=", filter.Gte)
		case *UInt32Filter_Between:
			qb.AddBetweenCondition("column_rows_count", filter.Between.Min, filter.Between.Max.GetValue())
		case *UInt32Filter_In:
			if len(filter.In.Values) > 0 {
				qb.AddInCondition("column_rows_count", UInt32SliceToInterface(filter.In.Values))
			}
		case *UInt32Filter_NotIn:
			if len(filter.NotIn.Values) > 0 {
				qb.AddNotInCondition("column_rows_count", UInt32SliceToInterface(filter.NotIn.Values))
			}
		default:
			// Unsupported filter type
		}
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "event_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "wallclock_request_slot", "wallclock_request_slot_start_date_time", "wallclock_request_epoch", "wallclock_request_epoch_start_date_time", "column_index", "column_rows_count", "beacon_block_root", "peer_id_unique_key", "result", "response_time_ms", "error", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", event_date_time" + ", meta_client_name" + ", peer_id_unique_key" + ", slot" + ", column_index"
	}

	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "wallclock_request_slot", "toUnixTimestamp(`wallclock_request_slot_start_date_time`) AS `wallclock_request_slot_start_date_time`", "wallclock_request_epoch", "toUnixTimestamp(`wallclock_request_epoch_start_date_time`) AS `wallclock_request_epoch_start_date_time`", "column_index", "toUInt32(`column_rows_count`) AS `column_rows_count`", "NULLIF(`beacon_block_root`, repeat('\x00', 66)) AS `beacon_block_root`", "peer_id_unique_key", "result", "response_time_ms", "error", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("libp2p_rpc_data_column_custody_probe", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PRpcDataColumnCustodyProbeQuery constructs a parameterized SQL query from a GetLibp2PRpcDataColumnCustodyProbeRequest
func BuildGetLibp2PRpcDataColumnCustodyProbeQuery(req *GetLibp2PRpcDataColumnCustodyProbeRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_rpc_data_column_custody_probe", columns, qb, orderByClause, 1, 0, options...)
}
