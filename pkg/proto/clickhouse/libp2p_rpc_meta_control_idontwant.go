...
// SQL query builder for libp2p_rpc_meta_control_idontwant
...
// BuildListLibp2PRpcMetaControlIdontwantQuery constructs a parameterized SQL query from a ListLibp2PRpcMetaControlIdontwantRequest
func BuildListLibp2PRpcMetaControlIdontwantQuery(req *ListLibp2PRpcMetaControlIdontwantRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"unique_key", "updated_date_time", "event_date_time", "control_index", "message_index", "rpc_meta_unique_key", "message_id", "peer_id_unique_key", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", event_date_time" + ", unique_key" + ", control_index" + ", peer_id_unique_key" + ", message_id" + ", message_index" + ", meta_client_name"
	}

	// Build column list
	columns := []string{"unique_key", "toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "control_index", "message_index", "rpc_meta_unique_key", "message_id", "peer_id_unique_key", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("libp2p_rpc_meta_control_idontwant", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PRpcMetaControlIdontwantQuery constructs a parameterized SQL query from a GetLibp2PRpcMetaControlIdontwantRequest
func BuildGetLibp2PRpcMetaControlIdontwantQuery(req *GetLibp2PRpcMetaControlIdontwantRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_rpc_meta_control_idontwant", columns, qb, orderByClause, 1, 0, options...)
}
