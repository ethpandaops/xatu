...
// SQL query builder for libp2p_rpc_meta_control_iwant
...
// BuildListLibp2PRpcMetaControlIwantQuery constructs a parameterized SQL query from a ListLibp2PRpcMetaControlIwantRequest
func BuildListLibp2PRpcMetaControlIwantQuery(req *ListLibp2PRpcMetaControlIwantRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_rpc_meta_control_iwant", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PRpcMetaControlIwantQuery constructs a parameterized SQL query from a GetLibp2PRpcMetaControlIwantRequest
func BuildGetLibp2PRpcMetaControlIwantQuery(req *GetLibp2PRpcMetaControlIwantRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_rpc_meta_control_iwant", columns, qb, orderByClause, 1, 0, options...)
}
