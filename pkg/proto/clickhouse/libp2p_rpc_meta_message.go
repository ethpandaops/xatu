...
// SQL query builder for libp2p_rpc_meta_message
...
// BuildListLibp2PRpcMetaMessageQuery constructs a parameterized SQL query from a ListLibp2PRpcMetaMessageRequest
func BuildListLibp2PRpcMetaMessageQuery(req *ListLibp2PRpcMetaMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	// Build column list
	columns := []string{"unique_key", "toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "control_index", "rpc_meta_unique_key", "message_id", "topic_layer", "topic_fork_digest_value", "topic_name", "topic_encoding", "peer_id_unique_key", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("libp2p_rpc_meta_message", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PRpcMetaMessageQuery constructs a parameterized SQL query from a GetLibp2PRpcMetaMessageRequest
func BuildGetLibp2PRpcMetaMessageQuery(req *GetLibp2PRpcMetaMessageRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_rpc_meta_message", columns, qb, orderByClause, 1, 0, options...)
}
