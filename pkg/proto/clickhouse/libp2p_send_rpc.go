...
// SQL query builder for libp2p_send_rpc
...
// BuildListLibp2PSendRpcQuery constructs a parameterized SQL query from a ListLibp2PSendRpcRequest
func BuildListLibp2PSendRpcQuery(req *ListLibp2PSendRpcRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"unique_key", "updated_date_time", "event_date_time", "peer_id_unique_key", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}
		...
		orderByClause = " ORDER BY meta_network_name" + ", event_date_time" + ", unique_key" + ", meta_client_name"
	}

	// Build column list
	columns := []string{"unique_key", "toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "peer_id_unique_key", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("libp2p_send_rpc", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetLibp2PSendRpcQuery constructs a parameterized SQL query from a GetLibp2PSendRpcRequest
func BuildGetLibp2PSendRpcQuery(req *GetLibp2PSendRpcRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("libp2p_send_rpc", columns, qb, orderByClause, 1, 0, options...)
}
