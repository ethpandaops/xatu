...
// SQL query builder for mev_relay_proposer_payload_delivered
...
// BuildListMevRelayProposerPayloadDeliveredQuery constructs a parameterized SQL query from a ListMevRelayProposerPayloadDeliveredRequest
func BuildListMevRelayProposerPayloadDeliveredQuery(req *ListMevRelayProposerPayloadDeliveredRequest, options ...QueryOption) (SQLQuery, error) {
	...
	if req.OrderBy != "" {
		validFields := []string{"updated_date_time", "event_date_time", "slot", "slot_start_date_time", "epoch", "epoch_start_date_time", "wallclock_slot", "wallclock_slot_start_date_time", "wallclock_epoch", "wallclock_epoch_start_date_time", "block_number", "relay_name", "block_hash", "proposer_pubkey", "builder_pubkey", "proposer_fee_recipient", "gas_limit", "gas_used", "value", "num_tx", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}
	...
	// Build column list
	columns := []string{"toUnixTimestamp(`updated_date_time`) AS `updated_date_time`", "toUnixTimestamp64Micro(`event_date_time`) AS `event_date_time`", "slot", "toUnixTimestamp(`slot_start_date_time`) AS `slot_start_date_time`", "epoch", "toUnixTimestamp(`epoch_start_date_time`) AS `epoch_start_date_time`", "wallclock_slot", "toUnixTimestamp(`wallclock_slot_start_date_time`) AS `wallclock_slot_start_date_time`", "wallclock_epoch", "toUnixTimestamp(`wallclock_epoch_start_date_time`) AS `wallclock_epoch_start_date_time`", "block_number", "relay_name", "NULLIF(`block_hash`, repeat('\x00', 66)) AS `block_hash`", "proposer_pubkey", "builder_pubkey", "NULLIF(`proposer_fee_recipient`, repeat('\x00', 42)) AS `proposer_fee_recipient`", "gas_limit", "gas_used", "toString(`value`) AS `value`", "num_tx", "meta_client_name", "meta_client_version", "meta_client_implementation", "meta_client_os", "meta_client_ip", "meta_client_geo_city", "meta_client_geo_country", "meta_client_geo_country_code", "meta_client_geo_continent_code", "meta_client_geo_longitude", "meta_client_geo_latitude", "meta_client_geo_autonomous_system_number", "meta_client_geo_autonomous_system_organization", "meta_network_name"}

	return BuildParameterizedQuery("mev_relay_proposer_payload_delivered", columns, qb, orderByClause, limit, offset, options...)
}

// BuildGetMevRelayProposerPayloadDeliveredQuery constructs a parameterized SQL query from a GetMevRelayProposerPayloadDeliveredRequest
func BuildGetMevRelayProposerPayloadDeliveredQuery(req *GetMevRelayProposerPayloadDeliveredRequest, options ...QueryOption) (SQLQuery, error) {
	...
	return BuildParameterizedQuery("mev_relay_proposer_payload_delivered", columns, qb, orderByClause, 1, 0, options...)
}
