...
var file_pkg_proto_eth_v1_attestation_proto_depIdxs = []int32{
	...
	0, // 3: xatu.eth.v1.AggregateAttestationAndProof.aggregate:type_name -> xatu.eth.v1.Attestation
	2, // 4: xatu.eth.v1.SignedAggregateAttestationAndProof.message:type_name -> xatu.eth.v1.AggregateAttestationAndProof
