...
func (m *ExecutionPayloadEvent) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ExecutionPayloadEvent) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ExecutionPayloadEvent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
var vtprotoPool_ExecutionPayloadEvent = sync.Pool{
	New: func() interface{} {
		return &ExecutionPayloadEvent{}
	},
}

func (m *ExecutionPayloadEvent) ResetVT() {
	if m != nil {
		m.Reset()
	}
}
func (m *ExecutionPayloadEvent) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_ExecutionPayloadEvent.Put(m)
	}
}
func ExecutionPayloadEventFromVTPool() *ExecutionPayloadEvent {
	return vtprotoPool_ExecutionPayloadEvent.Get().(*ExecutionPayloadEvent)
}
func (m *ExecutionPayloadEvent) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ExecutionPayloadEvent) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ExecutionPayloadEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExecutionPayloadEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
