...
type ForkChoiceNodeV2 struct {
	...
	ExecutionBlockHash string                  `protobuf:"bytes,8,opt,name=ExecutionBlockHash,json=execution_block_hash,proto3" json:"ExecutionBlockHash,omitempty"`
	ExtraData          string                  `protobuf:"bytes,9,opt,name=ExtraData,json=extra_data,proto3" json:"ExtraData,omitempty"`
	// EIP-7732 ePBS: per-node payload status from the Gloas+ fork-choice store
	// (0 = EMPTY, 1 = FULL, 2 = PENDING). Sourced from the upstream beacon
	// node's debug/fork_choice extra_data["payload_status"] when present.
	// Pre-Gloas nodes leave this unset. consensus-specs PR #5094 narrowed the
	// scope to per-node tracking (no Store-level payload_states mirror).
	PayloadStatus *wrapperspb.UInt32Value `protobuf:"bytes,10,opt,name=payload_status,proto3" json:"payload_status,omitempty"`
}
...
func (x *ForkChoiceNodeV2) GetPayloadStatus() *wrapperspb.UInt32Value {
	if x != nil {
...
var file_pkg_proto_eth_v1_fork_choice_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x22, 0xff, 0x03, 0x0a, 0x10, 0x46, 0x6f, 0x72,
	...
	0x64, 0x61, 0x74, 0x61, 0x12, 0x44, 0x0a, 0x0e, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x55,
	0x49, 0x6e, 0x74, 0x33, 0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0e, 0x70, 0x61, 0x79, 0x6c,
	0x6f, 0x61, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69,
...
var file_pkg_proto_eth_v1_fork_choice_proto_goTypes = []any{
...
var file_pkg_proto_eth_v1_fork_choice_proto_depIdxs = []int32{
	...
	7,  // 10: xatu.eth.v1.ForkChoiceNodeV2.payload_status:type_name -> google.protobuf.UInt32Value
...
func file_pkg_proto_eth_v1_fork_choice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_eth_v1_fork_choice_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_eth_v1_fork_choice_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_eth_v1_fork_choice_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_eth_v1_fork_choice_proto_msgTypes[3].Exporter = func(v any, i int) any {
