...
var file_pkg_proto_eth_v2_events_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x48, 0x00, 0x52, 0x07, 0x43, 0x41, 0x50, 0x45, 0x4c, 0x4c, 0x41, 0x12, 0x1c, 0x0a,
	...
	0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xfa, 0x02, 0x0a, 0x0c,
	...
	0x00, 0x52, 0x07, 0x43, 0x41, 0x50, 0x45, 0x4c, 0x4c, 0x41, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x4f, 0x0a, 0x0c, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x43, 0x41, 0x50, 0x45, 0x4c, 0x4c, 0x41, 0x10, 0x04, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74,
	...
	0x74, 0x6f, 0x2f, 0x65, 0x74, 0x68, 0x2f, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_pkg_proto_eth_v2_events_proto_goTypes = []interface{}{
	...
	(*v1.BeaconBlockV2)(nil),       // 7: xatu.eth.v1.BeaconBlockV2
	(*BeaconBlockAltairV2)(nil),    // 8: xatu.eth.v2.BeaconBlockAltairV2
	(*BeaconBlockBellatrixV2)(nil), // 9: xatu.eth.v2.BeaconBlockBellatrixV2
	(*BeaconBlockCapellaV2)(nil),   // 10: xatu.eth.v2.BeaconBlockCapellaV2
}
var file_pkg_proto_eth_v2_events_proto_depIdxs = []int32{
	...
	7,  // 5: xatu.eth.v2.EventBlockV2.phase0_block:type_name -> xatu.eth.v1.BeaconBlockV2
	8,  // 6: xatu.eth.v2.EventBlockV2.altair_block:type_name -> xatu.eth.v2.BeaconBlockAltairV2
	9,  // 7: xatu.eth.v2.EventBlockV2.bellatrix_block:type_name -> xatu.eth.v2.BeaconBlockBellatrixV2
	10, // 8: xatu.eth.v2.EventBlockV2.capella_block:type_name -> xatu.eth.v2.BeaconBlockCapellaV2
	0,  // 9: xatu.eth.v2.EventBlockV2.version:type_name -> xatu.eth.v2.BlockVersion
