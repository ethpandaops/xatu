...
var file_pkg_proto_eth_v2_events_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x02, 0x0a, 0x0a, 0x45, 0x76, 0x65,
...
var file_pkg_proto_eth_v2_events_proto_goTypes = []interface{}{
	(*EventBlock)(nil),           // 0: xatu.eth.v2.EventBlock
	(*v1.BeaconBlock)(nil),       // 1: xatu.eth.v1.BeaconBlock
	(*BeaconBlockAltair)(nil),    // 2: xatu.eth.v2.BeaconBlockAltair
	(*BeaconBlockBellatrix)(nil), // 3: xatu.eth.v2.BeaconBlockBellatrix
	(*BeaconBlockCapella)(nil),   // 4: xatu.eth.v2.BeaconBlockCapella
}
var file_pkg_proto_eth_v2_events_proto_depIdxs = []int32{
	1, // 0: xatu.eth.v2.EventBlock.phase0_block:type_name -> xatu.eth.v1.BeaconBlock
	2, // 1: xatu.eth.v2.EventBlock.altair_block:type_name -> xatu.eth.v2.BeaconBlockAltair
	3, // 2: xatu.eth.v2.EventBlock.bellatrix_block:type_name -> xatu.eth.v2.BeaconBlockBellatrix
	4, // 3: xatu.eth.v2.EventBlock.capella_block:type_name -> xatu.eth.v2.BeaconBlockCapella
