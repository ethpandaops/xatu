...
func (x *SignedBLSToExecutionChangeV2) Reset() {
	*x = SignedBLSToExecutionChangeV2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SignedBLSToExecutionChangeV2) Descriptor() ([]byte, []int) {
	return file_pkg_proto_eth_v2_withdrawals_proto_rawDescGZIP(), []int{3}
}
...
func (x *SubmitBLSToExecutionChangesRequest) Reset() {
	*x = SubmitBLSToExecutionChangesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SubmitBLSToExecutionChangesRequest) Descriptor() ([]byte, []int) {
	return file_pkg_proto_eth_v2_withdrawals_proto_rawDescGZIP(), []int{4}
}
...
var file_pkg_proto_eth_v2_withdrawals_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x73, 0x22, 0xbe, 0x01, 0x0a, 0x16, 0x42, 0x4c, 0x53, 0x54, 0x6f, 0x45, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x56, 0x32, 0x12,
	...
	0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x28, 0x0a, 0x0f, 0x66, 0x72, 0x6f, 0x6d, 0x5f,
	0x62, 0x6c, 0x73, 0x5f, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0f, 0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x62, 0x6c, 0x73, 0x5f, 0x70, 0x75, 0x62, 0x6b, 0x65,
	0x79, 0x12, 0x32, 0x0a, 0x14, 0x74, 0x6f, 0x5f, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x77, 0x0a, 0x1a, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42,
	0x4c, 0x53, 0x54, 0x6f, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x12, 0x3b, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01,
	...
	,
	...
	0x74, 0x12, 0x41, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	...
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x07, 0x63, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x73, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_pkg_proto_eth_v2_withdrawals_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_pkg_proto_eth_v2_withdrawals_proto_goTypes = []any{
	(*BLSToExecutionChange)(nil),               // 0: xatu.eth.v2.BLSToExecutionChange
	(*BLSToExecutionChangeV2)(nil),             // 1: xatu.eth.v2.BLSToExecutionChangeV2
	(*SignedBLSToExecutionChange)(nil),         // 2: xatu.eth.v2.SignedBLSToExecutionChange
	(*SignedBLSToExecutionChangeV2)(nil),       // 3: xatu.eth.v2.SignedBLSToExecutionChangeV2
	(*SubmitBLSToExecutionChangesRequest)(nil), // 4: xatu.eth.v2.SubmitBLSToExecutionChangesRequest
	(*wrapperspb.UInt64Value)(nil),             // 5: google.protobuf.UInt64Value
}
var file_pkg_proto_eth_v2_withdrawals_proto_depIdxs = []int32{
	5, // 0: xatu.eth.v2.BLSToExecutionChangeV2.validator_index:type_name -> google.protobuf.UInt64Value
	0, // 1: xatu.eth.v2.SignedBLSToExecutionChange.message:type_name -> xatu.eth.v2.BLSToExecutionChange
	1, // 2: xatu.eth.v2.SignedBLSToExecutionChangeV2.message:type_name -> xatu.eth.v2.BLSToExecutionChangeV2
	2, // 3: xatu.eth.v2.SubmitBLSToExecutionChangesRequest.changes:type_name -> xatu.eth.v2.SignedBLSToExecutionChange
...
func file_pkg_proto_eth_v2_withdrawals_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*BLSToExecutionChangeV2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*SignedBLSToExecutionChangeV2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[4].Exporter = func(v any, i int) any {
