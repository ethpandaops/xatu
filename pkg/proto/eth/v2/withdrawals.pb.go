...
func file_pkg_proto_eth_v2_withdrawals_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_proto_eth_v2_withdrawals_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
