...
// Enum defining the possible health statuses of a service
...
type HealthCheckRequest struct {
	...
	// Service name to check. Empty string means the overall system health.
...
type HealthCheckResponse struct {
	...
	// The health status of the requested service
...
var file_pkg_proto_health_health_proto_rawDesc = []byte{
	...
	0x06, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x22, 0x2e, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xa9, 0x01, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c,
	...
	0x29, 0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43,
	...
	0x4e, 0x10, 0x03, 0x32, 0x8e, 0x01, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x40,
	...
	0x12, 0x42, 0x0a, 0x05, 0x57, 0x61, 0x74, 0x63, 0x68, 0x12, 0x1a, 0x2e, 0x68, 0x65, 0x61, 0x6c,
	...
	0x61, 0x74, 0x75, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x65,
...
func file_pkg_proto_health_health_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_health_health_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_health_health_proto_msgTypes[1].Exporter = func(v any, i int) any {
