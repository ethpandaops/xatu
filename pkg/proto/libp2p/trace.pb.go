...
var file_pkg_proto_libp2p_trace_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0xe7, 0x01, 0x0a, 0x07,
	...
	0x64, 0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2a, 0xbf,
...
var file_pkg_proto_libp2p_trace_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_pkg_proto_libp2p_trace_proto_goTypes = []any{
	...
	(*RPCMeta)(nil),                // 8: xatu.libp2p.RPCMeta
	(*MessageMeta)(nil),            // 9: xatu.libp2p.MessageMeta
	(*SubMeta)(nil),                // 10: xatu.libp2p.SubMeta
	(*ControlMeta)(nil),            // 11: xatu.libp2p.ControlMeta
	(*ControlIHaveMeta)(nil),       // 12: xatu.libp2p.ControlIHaveMeta
	(*ControlIWantMeta)(nil),       // 13: xatu.libp2p.ControlIWantMeta
	(*ControlGraftMeta)(nil),       // 14: xatu.libp2p.ControlGraftMeta
	(*ControlPruneMeta)(nil),       // 15: xatu.libp2p.ControlPruneMeta
	(*ControlIDontWantMeta)(nil),   // 16: xatu.libp2p.ControlIDontWantMeta
	(*TraceEventMetadata)(nil),     // 17: xatu.libp2p.TraceEventMetadata
	(*Connected)(nil),              // 18: xatu.libp2p.Connected
	(*Disconnected)(nil),           // 19: xatu.libp2p.Disconnected
	(*HandleStatus)(nil),           // 20: xatu.libp2p.HandleStatus
	(*HandleMetadata)(nil),         // 21: xatu.libp2p.HandleMetadata
	...
	(*Status)(nil),                 // 26: xatu.libp2p.Status
	(*Metadata)(nil),               // 27: xatu.libp2p.Metadata
}
var file_pkg_proto_libp2p_trace_proto_depIdxs = []int32{
	22, // 0: xatu.libp2p.AddPeer.peer_id:type_name -> google.protobuf.StringValue
	22, // 1: xatu.libp2p.AddPeer.protocol:type_name -> google.protobuf.StringValue
	22, // 2: xatu.libp2p.RemovePeer.peer_id:type_name -> google.protobuf.StringValue
	22, // 3: xatu.libp2p.RecvRPC.peer_id:type_name -> google.protobuf.StringValue
	8,  // 4: xatu.libp2p.RecvRPC.meta:type_name -> xatu.libp2p.RPCMeta
	22, // 5: xatu.libp2p.SendRPC.peer_id:type_name -> google.protobuf.StringValue
	8,  // 6: xatu.libp2p.SendRPC.meta:type_name -> xatu.libp2p.RPCMeta
	22, // 7: xatu.libp2p.DropRPC.peer_id:type_name -> google.protobuf.StringValue
	8,  // 8: xatu.libp2p.DropRPC.meta:type_name -> xatu.libp2p.RPCMeta
	22, // 9: xatu.libp2p.Join.topic:type_name -> google.protobuf.StringValue
	22, // 10: xatu.libp2p.Leave.topic:type_name -> google.protobuf.StringValue
	9,  // 11: xatu.libp2p.RPCMeta.messages:type_name -> xatu.libp2p.MessageMeta
	10, // 12: xatu.libp2p.RPCMeta.subscriptions:type_name -> xatu.libp2p.SubMeta
	11, // 13: xatu.libp2p.RPCMeta.control:type_name -> xatu.libp2p.ControlMeta
	22, // 14: xatu.libp2p.RPCMeta.peer_id:type_name -> google.protobuf.StringValue
	22, // 15: xatu.libp2p.MessageMeta.message_id:type_name -> google.protobuf.StringValue
	22, // 16: xatu.libp2p.MessageMeta.topic:type_name -> google.protobuf.StringValue
	23, // 17: xatu.libp2p.SubMeta.subscribe:type_name -> google.protobuf.BoolValue
	22, // 18: xatu.libp2p.SubMeta.topic_id:type_name -> google.protobuf.StringValue
	12, // 19: xatu.libp2p.ControlMeta.ihave:type_name -> xatu.libp2p.ControlIHaveMeta
	13, // 20: xatu.libp2p.ControlMeta.iwant:type_name -> xatu.libp2p.ControlIWantMeta
	14, // 21: xatu.libp2p.ControlMeta.graft:type_name -> xatu.libp2p.ControlGraftMeta
	15, // 22: xatu.libp2p.ControlMeta.prune:type_name -> xatu.libp2p.ControlPruneMeta
	16, // 23: xatu.libp2p.ControlMeta.idontwant:type_name -> xatu.libp2p.ControlIDontWantMeta
	22, // 24: xatu.libp2p.ControlIHaveMeta.topic_id:type_name -> google.protobuf.StringValue
	22, // 25: xatu.libp2p.ControlIHaveMeta.message_ids:type_name -> google.protobuf.StringValue
	22, // 26: xatu.libp2p.ControlIWantMeta.message_ids:type_name -> google.protobuf.StringValue
	22, // 27: xatu.libp2p.ControlGraftMeta.topic_id:type_name -> google.protobuf.StringValue
	22, // 28: xatu.libp2p.ControlPruneMeta.topic_id:type_name -> google.protobuf.StringValue
	22, // 29: xatu.libp2p.ControlPruneMeta.peer_ids:type_name -> google.protobuf.StringValue
	22, // 30: xatu.libp2p.ControlIDontWantMeta.message_ids:type_name -> google.protobuf.StringValue
	22, // 31: xatu.libp2p.TraceEventMetadata.peer_id:type_name -> google.protobuf.StringValue
	22, // 32: xatu.libp2p.Connected.remote_peer:type_name -> google.protobuf.StringValue
	22, // 33: xatu.libp2p.Connected.remote_maddrs:type_name -> google.protobuf.StringValue
	22, // 34: xatu.libp2p.Connected.agent_version:type_name -> google.protobuf.StringValue
	22, // 35: xatu.libp2p.Connected.direction:type_name -> google.protobuf.StringValue
	24, // 36: xatu.libp2p.Connected.opened:type_name -> google.protobuf.Timestamp
	23, // 37: xatu.libp2p.Connected.transient:type_name -> google.protobuf.BoolValue
	23, // 38: xatu.libp2p.Connected.limited:type_name -> google.protobuf.BoolValue
	22, // 39: xatu.libp2p.Disconnected.remote_peer:type_name -> google.protobuf.StringValue
	22, // 40: xatu.libp2p.Disconnected.remote_maddrs:type_name -> google.protobuf.StringValue
	22, // 41: xatu.libp2p.Disconnected.agent_version:type_name -> google.protobuf.StringValue
	22, // 42: xatu.libp2p.Disconnected.direction:type_name -> google.protobuf.StringValue
	24, // 43: xatu.libp2p.Disconnected.opened:type_name -> google.protobuf.Timestamp
	23, // 44: xatu.libp2p.Disconnected.transient:type_name -> google.protobuf.BoolValue
	23, // 45: xatu.libp2p.Disconnected.limited:type_name -> google.protobuf.BoolValue
	22, // 46: xatu.libp2p.HandleStatus.peer_id:type_name -> google.protobuf.StringValue
	22, // 47: xatu.libp2p.HandleStatus.protocol_id:type_name -> google.protobuf.StringValue
	22, // 48: xatu.libp2p.HandleStatus.error:type_name -> google.protobuf.StringValue
	25, // 49: xatu.libp2p.HandleStatus.latency:type_name -> google.protobuf.FloatValue
	26, // 50: xatu.libp2p.HandleStatus.request:type_name -> xatu.libp2p.Status
	26, // 51: xatu.libp2p.HandleStatus.response:type_name -> xatu.libp2p.Status
	22, // 52: xatu.libp2p.HandleMetadata.peer_id:type_name -> google.protobuf.StringValue
	22, // 53: xatu.libp2p.HandleMetadata.protocol_id:type_name -> google.protobuf.StringValue
	22, // 54: xatu.libp2p.HandleMetadata.error:type_name -> google.protobuf.StringValue
	25, // 55: xatu.libp2p.HandleMetadata.latency:type_name -> google.protobuf.FloatValue
	27, // 56: xatu.libp2p.HandleMetadata.metadata:type_name -> xatu.libp2p.Metadata
