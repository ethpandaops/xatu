...
var file_pkg_proto_mevrelay_relay_proto_rawDesc = []byte{
	...
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69,
...
var file_pkg_proto_mevrelay_relay_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_proto_mevrelay_relay_proto_goTypes = []interface{}{
	(*Relay)(nil),                  // 0: xatu.mevrelay.Relay
	(*wrapperspb.StringValue)(nil), // 1: google.protobuf.StringValue
}
var file_pkg_proto_mevrelay_relay_proto_depIdxs = []int32{
	1, // 0: xatu.mevrelay.Relay.name:type_name -> google.protobuf.StringValue
	1, // 1: xatu.mevrelay.Relay.url:type_name -> google.protobuf.StringValue
...
func file_pkg_proto_mevrelay_relay_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_mevrelay_relay_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Relay); i {
			case 0:
				return &v.state
			case 1:
