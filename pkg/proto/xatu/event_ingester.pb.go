...
type DecoratedEvent_Libp2PTracePublishMessage struct {
	Libp2PTracePublishMessage *libp2p.PublishMessage `protobuf:"bytes,40,opt,name=libp2p_trace_publish_message,json=LIBP2P_TRACE_PUBLISH_MESSAGE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceRejectMessage struct {
	Libp2PTraceRejectMessage *libp2p.RejectMessage `protobuf:"bytes,41,opt,name=libp2p_trace_reject_message,json=LIBP2P_TRACE_REJECT_MESSAGE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceDuplicateMessage struct {
	Libp2PTraceDuplicateMessage *libp2p.DuplicateMessage `protobuf:"bytes,42,opt,name=libp2p_trace_duplicate_message,json=LIBP2P_TRACE_DUPLICATE_MESSAGE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceDeliverMessage struct {
	Libp2PTraceDeliverMessage *libp2p.DeliverMessage `protobuf:"bytes,43,opt,name=libp2p_trace_deliver_message,json=LIBP2P_TRACE_DELIVER_MESSAGE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceAddPeer struct {
	Libp2PTraceAddPeer *libp2p.AddPeer `protobuf:"bytes,44,opt,name=libp2p_trace_add_peer,json=LIBP2P_TRACE_ADD_PEER,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceRemovePeer struct {
	Libp2PTraceRemovePeer *libp2p.RemovePeer `protobuf:"bytes,45,opt,name=libp2p_trace_remove_peer,json=LIBP2P_TRACE_REMOVE_PEER,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceRecvRpc struct {
	Libp2PTraceRecvRpc *libp2p.RecvRPC `protobuf:"bytes,46,opt,name=libp2p_trace_recv_rpc,json=LIBP2P_TRACE_RECV_RPC,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceSendRpc struct {
	Libp2PTraceSendRpc *libp2p.SendRPC `protobuf:"bytes,47,opt,name=libp2p_trace_send_rpc,json=LIBP2P_TRACE_SEND_RPC,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceDropRpc struct {
	Libp2PTraceDropRpc *libp2p.DropRPC `protobuf:"bytes,48,opt,name=libp2p_trace_drop_rpc,json=LIBP2P_TRACE_DROP_RPC,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceJoin struct {
	Libp2PTraceJoin *libp2p.Join `protobuf:"bytes,49,opt,name=libp2p_trace_join,json=LIBP2P_TRACE_JOIN,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceLeave struct {
	Libp2PTraceLeave *libp2p.Leave `protobuf:"bytes,50,opt,name=libp2p_trace_leave,json=LIBP2P_TRACE_LEAVE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceGraft struct {
	Libp2PTraceGraft *libp2p.Graft `protobuf:"bytes,51,opt,name=libp2p_trace_graft,json=LIBP2P_TRACE_GRAFT,proto3,oneof"`
}

type DecoratedEvent_Libp2PTracePrune struct {
	Libp2PTracePrune *libp2p.Prune `protobuf:"bytes,52,opt,name=libp2p_trace_prune,json=LIBP2P_TRACE_PRUNE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceValidateMessage struct {
	Libp2PTraceValidateMessage *libp2p.ValidateMessage `protobuf:"bytes,53,opt,name=libp2p_trace_validate_message,json=LIBP2P_TRACE_VALIDATE_MESSAGE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceThrottlePeer struct {
	Libp2PTraceThrottlePeer *libp2p.ThrottlePeer `protobuf:"bytes,54,opt,name=libp2p_trace_throttle_peer,json=LIBP2P_TRACE_THROTTLE_PEER,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceUndeliverableMessage struct {
	Libp2PTraceUndeliverableMessage *libp2p.UndeliverableMessage `protobuf:"bytes,55,opt,name=libp2p_trace_undeliverable_message,json=LIBP2P_TRACE_UNDELIVERABLE_MESSAGE,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceConnected struct {
	Libp2PTraceConnected *libp2p.Connected `protobuf:"bytes,56,opt,name=libp2p_trace_connected,json=LIBP2P_TRACE_CONNECTED,proto3,oneof"`
}

type DecoratedEvent_Libp2PTraceDisconnected struct {
	Libp2PTraceDisconnected *libp2p.Disconnected `protobuf:"bytes,57,opt,name=libp2p_trace_disconnected,json=LIBP2P_TRACE_DISCONNECTED,proto3,oneof"`
}
...
var file_pkg_proto_xatu_event_ingester_proto_rawDesc = []byte{
	...
	0x45, 0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x41, 0x22, 0xff, 0x2c, 0x0a, 0x0e,
	...
	0x44, 0x5f, 0x41, 0x54, 0x54, 0x45, 0x53, 0x54, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x12, 0x61, 0x0a,
	...
	0x29, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x78, 0x61, 0x74, 0x75, 0x2e, 0x6c, 0x69, 0x62,
	...
	0x67, 0x65, 0x18, 0x2a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x78, 0x61, 0x74, 0x75, 0x2e,
	...
	0x72, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x2b, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x49, 0x56, 0x45, 0x52, 0x5f, 0x4d, 0x45, 0x53, 0x53, 0x41, 0x47, 0x45, 0x12, 0x4c, 0x0a, 0x15,
	0x6c, 0x69, 0x62, 0x70, 0x32, 0x70, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x5f, 0x61, 0x64, 0x64,
	0x5f, 0x70, 0x65, 0x65, 0x72, 0x18, 0x2c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x78, 0x61,
	...
	0x65, 0x5f, 0x70, 0x65, 0x65, 0x72, 0x18, 0x2d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x78,
	...
	0x65, 0x5f, 0x72, 0x65, 0x63, 0x76, 0x5f, 0x72, 0x70, 0x63, 0x18, 0x2e, 0x20, 0x01, 0x28, 0x0b,
	...
	0x73, 0x65, 0x6e, 0x64, 0x5f, 0x72, 0x70, 0x63, 0x18, 0x2f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14,
	...
	0x52, 0x41, 0x43, 0x45, 0x5f, 0x53, 0x45, 0x4e, 0x44, 0x5f, 0x52, 0x50, 0x43, 0x12, 0x4c, 0x0a,
	0x15, 0x6c, 0x69, 0x62, 0x70, 0x32, 0x70, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x5f, 0x64, 0x72,
	0x6f, 0x70, 0x5f, 0x72, 0x70, 0x63, 0x18, 0x30, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x78,
	...
	0x43, 0x45, 0x5f, 0x44, 0x52, 0x4f, 0x50, 0x5f, 0x52, 0x50, 0x43, 0x12, 0x41, 0x0a, 0x11, 0x6c,
	0x69, 0x62, 0x70, 0x32, 0x70, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x5f, 0x6a, 0x6f, 0x69, 0x6e,
	0x18, 0x31, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x78, 0x61, 0x74, 0x75, 0x2e, 0x6c, 0x69,
	0x62, 0x70, 0x32, 0x70, 0x2e, 0x4a, 0x6f, 0x69, 0x6e, 0x48, 0x00, 0x52, 0x11, 0x4c, 0x49, 0x42,
	0x50, 0x32, 0x50, 0x5f, 0x54, 0x52, 0x41, 0x43, 0x45, 0x5f, 0x4a, 0x4f, 0x49, 0x4e, 0x12, 0x44,
	0x0a, 0x12, 0x6c, 0x69, 0x62, 0x70, 0x32, 0x70, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x5f, 0x6c,
	0x65, 0x61, 0x76, 0x65, 0x18, 0x32, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x78, 0x61, 0x74,
	...
	0x72, 0x61, 0x63, 0x65, 0x5f, 0x67, 0x72, 0x61, 0x66, 0x74, 0x18, 0x33, 0x20, 0x01, 0x28, 0x0b,
	...
	0x18, 0x34, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x78, 0x61, 0x74, 0x75, 0x2e, 0x6c, 0x69,
	...
	,
	...
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x65, 0x64, 0x18, 0x39, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	...
	0x45, 0x43, 0x54, 0x45, 0x44, 0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x58, 0x0a,
