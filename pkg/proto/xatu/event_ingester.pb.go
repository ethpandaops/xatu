...
const (
	...
	Event_EXECUTION_BLOCK_STATE_METRICS                          Event_Name = 82
)
...
var (
	Event_Name_name = map[int32]string{
		...
		82: "EXECUTION_BLOCK_STATE_METRICS",
	}
	Event_Name_value = map[string]int32{
		...
		"EXECUTION_BLOCK_STATE_METRICS":                          82,
	}
)
...
// DepthStats holds node count and byte size for a single trie depth level.
// Only depths with non-zero count or bytes are included.
type DepthStats struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Depth is the trie depth level (0-64).
	Depth *wrapperspb.UInt32Value `protobuf:"bytes,1,opt,name=depth,proto3" json:"depth,omitempty"`
	// Count is the number of nodes at this depth.
	Count string `protobuf:"bytes,2,opt,name=count,proto3" json:"count,omitempty"`
	// Bytes is the total size in bytes of nodes at this depth.
	Bytes string `protobuf:"bytes,3,opt,name=bytes,proto3" json:"bytes,omitempty"`
}

func (x *DepthStats) Reset() {
	*x = DepthStats{}
	if protoimpl.UnsafeEnabled {
...
func (x *DepthStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DepthStats) ProtoMessage() {}

func (x *DepthStats) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_proto_xatu_event_ingester_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DepthStats.ProtoReflect.Descriptor instead.
func (*DepthStats) Descriptor() ([]byte, []int) {
	return file_pkg_proto_xatu_event_ingester_proto_rawDescGZIP(), []int{16}
}

func (x *DepthStats) GetDepth() *wrapperspb.UInt32Value {
	if x != nil {
		return x.Depth
	}
	return nil
...
func (x *DepthStats) GetCount() string {
	if x != nil {
		return x.Count
	}
	return ""
...
func (x *DepthStats) GetBytes() string {
	if x != nil {
		return x.Bytes
	}
	return ""
...
// ExecutionBlockStateMetrics contains state size changes and trie depth
// statistics for a single block. All delta values are signed integers
...
type ExecutionBlockStateMetrics struct {
	...
	// Block context
	// BlockNumber is the block number for this state change.
	BlockNumber string `protobuf:"bytes,1,opt,name=block_number,proto3" json:"block_number,omitempty"`
	// StateRoot is the state root after the block was processed.
	StateRoot string `protobuf:"bytes,2,opt,name=state_root,proto3" json:"state_root,omitempty"`
	// OriginRoot is the state root before the block was processed.
	OriginRoot string `protobuf:"bytes,3,opt,name=origin_root,proto3" json:"origin_root,omitempty"`
	// Account changes
	// AccountDelta is the net change in account count.
	AccountDelta string `protobuf:"bytes,4,opt,name=account_delta,proto3" json:"account_delta,omitempty"`
	// AccountBytesDelta is the net change in account data bytes.
	AccountBytesDelta string `protobuf:"bytes,5,opt,name=account_bytes_delta,proto3" json:"account_bytes_delta,omitempty"`
	// Account trie node changes
	// AccountTrienodeDelta is the net change in account trie node count.
	AccountTrienodeDelta string `protobuf:"bytes,6,opt,name=account_trienode_delta,proto3" json:"account_trienode_delta,omitempty"`
	// AccountTrienodeBytesDelta is the net change in account trie node bytes.
	AccountTrienodeBytesDelta string `protobuf:"bytes,7,opt,name=account_trienode_bytes_delta,proto3" json:"account_trienode_bytes_delta,omitempty"`
	// Contract code changes
	// ContractCodeDelta is the net change in contract code count.
	ContractCodeDelta string `protobuf:"bytes,8,opt,name=contract_code_delta,proto3" json:"contract_code_delta,omitempty"`
	// ContractCodeBytesDelta is the net change in contract code bytes.
	ContractCodeBytesDelta string `protobuf:"bytes,9,opt,name=contract_code_bytes_delta,proto3" json:"contract_code_bytes_delta,omitempty"`
	// Storage changes
	// StorageDelta is the net change in storage entry count.
	StorageDelta string `protobuf:"bytes,10,opt,name=storage_delta,proto3" json:"storage_delta,omitempty"`
	// StorageBytesDelta is the net change in storage data bytes.
	StorageBytesDelta string `protobuf:"bytes,11,opt,name=storage_bytes_delta,proto3" json:"storage_bytes_delta,omitempty"`
	// Storage trie node changes
	// StorageTrienodeDelta is the net change in storage trie node count.
	StorageTrienodeDelta string `protobuf:"bytes,12,opt,name=storage_trienode_delta,proto3" json:"storage_trienode_delta,omitempty"`
	// StorageTrienodeBytesDelta is the net change in storage trie node bytes.
	StorageTrienodeBytesDelta string `protobuf:"bytes,13,opt,name=storage_trienode_bytes_delta,proto3" json:"storage_trienode_bytes_delta,omitempty"`
	// Depth statistics for created trie nodes (only non-zero depths included)
	// AccountTrieDepthCreated contains stats for account trie nodes created.
	AccountTrieDepthCreated []*DepthStats `protobuf:"bytes,14,rep,name=account_trie_depth_created,proto3" json:"account_trie_depth_created,omitempty"`
	// StorageTrieDepthCreated contains stats for storage trie nodes created.
	StorageTrieDepthCreated []*DepthStats `protobuf:"bytes,15,rep,name=storage_trie_depth_created,proto3" json:"storage_trie_depth_created,omitempty"`
	// Depth statistics for deleted trie nodes (only non-zero depths included)
	// AccountTrieDepthDeleted contains stats for account trie nodes deleted.
	AccountTrieDepthDeleted []*DepthStats `protobuf:"bytes,16,rep,name=account_trie_depth_deleted,proto3" json:"account_trie_depth_deleted,omitempty"`
	// StorageTrieDepthDeleted contains stats for storage trie nodes deleted.
	StorageTrieDepthDeleted []*DepthStats `protobuf:"bytes,17,rep,name=storage_trie_depth_deleted,proto3" json:"storage_trie_depth_deleted,omitempty"`
}

func (x *ExecutionBlockStateMetrics) Reset() {
	*x = ExecutionBlockStateMetrics{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExecutionBlockStateMetrics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecutionBlockStateMetrics) ProtoMessage() {}

func (x *ExecutionBlockStateMetrics) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_proto_xatu_event_ingester_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecutionBlockStateMetrics.ProtoReflect.Descriptor instead.
func (*ExecutionBlockStateMetrics) Descriptor() ([]byte, []int) {
	return file_pkg_proto_xatu_event_ingester_proto_rawDescGZIP(), []int{17}
}

func (x *ExecutionBlockStateMetrics) GetBlockNumber() string {
	if x != nil {
		return x.BlockNumber
	}
	return ""
...
func (x *ExecutionBlockStateMetrics) GetStateRoot() string {
	if x != nil {
		return x.StateRoot
	}
	return ""
...
func (x *ExecutionBlockStateMetrics) GetOriginRoot() string {
	if x != nil {
		return x.OriginRoot
	}
	return ""
...
func (x *ExecutionBlockStateMetrics) GetAccountDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetAccountBytesDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetAccountTrienodeDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetAccountTrienodeBytesDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetContractCodeDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetContractCodeBytesDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetStorageDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetStorageBytesDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetStorageTrienodeDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetStorageTrienodeBytesDelta() string {
	if x != nil {
...
func (x *ExecutionBlockStateMetrics) GetAccountTrieDepthCreated() []*DepthStats {
	if x != nil {
		return x.AccountTrieDepthCreated
	}
	return nil
}

func (x *ExecutionBlockStateMetrics) GetStorageTrieDepthCreated() []*DepthStats {
	if x != nil {
		return x.StorageTrieDepthCreated
	}
	return nil
}

func (x *ExecutionBlockStateMetrics) GetAccountTrieDepthDeleted() []*DepthStats {
	if x != nil {
		return x.AccountTrieDepthDeleted
	}
	return nil
}

func (x *ExecutionBlockStateMetrics) GetStorageTrieDepthDeleted() []*DepthStats {
	if x != nil {
		return x.StorageTrieDepthDeleted
	}
	return nil
}
...
type DecoratedEvent struct {
	...
	//	*DecoratedEvent_ExecutionBlockStateMetrics
...
func (x *DecoratedEvent) GetExecutionBlockStateMetrics() *ExecutionBlockStateMetrics {
	if x, ok := x.GetData().(*DecoratedEvent_ExecutionBlockStateMetrics); ok {
		return x.ExecutionBlockStateMetrics
	}
	return nil
}
...
type DecoratedEvent_ExecutionBlockStateMetrics struct {
	ExecutionBlockStateMetrics *ExecutionBlockStateMetrics `protobuf:"bytes,204,opt,name=execution_block_state_metrics,json=EXECUTION_BLOCK_STATE_METRICS,proto3,oneof"`
}
...
func (*DecoratedEvent_ExecutionBlockStateMetrics) isDecoratedEvent_Data() {}
...
var file_pkg_proto_xatu_event_ingester_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x68, 0x6f, 0x64, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x99, 0xeb, 0x01,
	...
	0x0b, 0x70, 0x72, 0x65, 0x73, 0x65, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x1a, 0xb5, 0x04, 0x0a,
	...
	,
	...
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x48, 0x00, 0x52, 0x16, 0x4c,
	0x49, 0x42, 0x50, 0x32, 0x50, 0x5f, 0x54, 0x52, 0x41, 0x43, 0x45, 0x5f, 0x43, 0x4f, 0x4e, 0x4e,
	0x45, 0x43, 0x54, 0x45, 0x44, 0x12, 0x76, 0x0a, 0x19, 0x4c, 0x49, 0x42, 0x50, 0x32, 0x50, 0x5f,
	0x54, 0x52, 0x41, 0x43, 0x45, 0x5f, 0x44, 0x49, 0x53, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54,
	0x45, 0x44, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x78, 0x61, 0x74, 0x75, 0x2e,
	...
	0x5f, 0x44, 0x49, 0x53, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54, 0x45, 0x44, 0x12, 0x6a, 0x0a,
	0x15, 0x4e, 0x4f, 0x44, 0x45, 0x5f, 0x52, 0x45, 0x43, 0x4f, 0x52, 0x44, 0x5f, 0x43, 0x4f, 0x4e,
	0x53, 0x45, 0x4e, 0x53, 0x55, 0x53, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x78,
	...
	,
	...
	0x41, 0x54, 0x1a, 0x53, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x4a, 0x0a, 0x12, 0x72,
	...
	0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0xda, 0x1a, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
	...
	0xe0, 0x19, 0x0a, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x20, 0x42, 0x45, 0x41, 0x43,
	0x4f, 0x4e, 0x5f, 0x41, 0x50, 0x49, 0x5f, 0x45, 0x54, 0x48, 0x5f, 0x56, 0x31, 0x5f, 0x45, 0x56,
	...
	,
	...
	0x10, 0x2f, 0x12, 0x1e, 0x0a, 0x1a, 0x4c, 0x49, 0x42, 0x50, 0x32, 0x50, 0x5f, 0x54, 0x52, 0x41,
	0x43, 0x45, 0x5f, 0x48, 0x41, 0x4e, 0x44, 0x4c, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53,
	0x10, 0x30, 0x12, 0x27, 0x0a, 0x23, 0x4c, 0x49, 0x42, 0x50, 0x32, 0x50, 0x5f, 0x54, 0x52, 0x41,
	0x43, 0x45, 0x5f, 0x47, 0x4f, 0x53, 0x53, 0x49, 0x50, 0x53, 0x55, 0x42, 0x5f, 0x42, 0x45, 0x41,
	0x43, 0x4f, 0x4e, 0x5f, 0x42, 0x4c, 0x4f, 0x43, 0x4b, 0x10, 0x31, 0x12, 0x2d, 0x0a, 0x29, 0x4c,
	...
	0x45, 0x53, 0x54, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x32, 0x12, 0x27, 0x0a, 0x23, 0x4c, 0x49,
	...
	0x52, 0x10, 0x33, 0x12, 0x27, 0x0a, 0x23, 0x42, 0x45, 0x41, 0x43, 0x4f, 0x4e, 0x5f, 0x41, 0x50,
	0x49, 0x5f, 0x45, 0x54, 0x48, 0x5f, 0x56, 0x31, 0x5f, 0x42, 0x45, 0x41, 0x43, 0x4f, 0x4e, 0x5f,
	0x56, 0x41, 0x4c, 0x49, 0x44, 0x41, 0x54, 0x4f, 0x52, 0x53, 0x10, 0x34, 0x12, 0x30, 0x0a, 0x2c,
	...
	,
	...
	0x40, 0x12, 0x27, 0x0a, 0x23, 0x4c, 0x49, 0x42, 0x50, 0x32, 0x50, 0x5f, 0x54, 0x52, 0x41, 0x43,
	0x45, 0x5f, 0x52, 0x50, 0x43, 0x5f, 0x4d, 0x45, 0x54, 0x41, 0x5f, 0x43, 0x4f, 0x4e, 0x54, 0x52,
	0x4f, 0x4c, 0x5f, 0x49, 0x48, 0x41, 0x56, 0x45, 0x10, 0x41, 0x12, 0x27, 0x0a, 0x23, 0x4c, 0x49,
	...
	,
	...
	,
	...
	,
	...
	0x86, 0x01, 0x0a, 0x2a, 0x6c, 0x69, 0x62, 0x70, 0x32, 0x70, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65,
	0x5f, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e,
	0x5f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x64, 0x79, 0x5f, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x18, 0xc8,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x78, 0x61, 0x74, 0x75, 0x2e, 0x6c, 0x69, 0x62,
	0x70, 0x32, 0x70, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x64, 0x79, 0x50, 0x72, 0x6f, 0x62, 0x65, 0x48, 0x00, 0x52, 0x2a, 0x4c, 0x49,
	...
	,
...
var file_pkg_proto_xatu_event_ingester_proto_goTypes = []any{
	...
	(*DepthStats)(nil),                   // 17: xatu.DepthStats
	(*ExecutionBlockStateMetrics)(nil),   // 18: xatu.ExecutionBlockStateMetrics
	...
	(*ClientMeta)(nil),                   // 21: xatu.ClientMeta
	(*ServerMeta)(nil),                   // 22: xatu.ServerMeta
	(*Meta)(nil),                         // 23: xatu.Meta
	(*Event)(nil),                        // 24: xatu.Event
	(*DecoratedEvent)(nil),               // 25: xatu.DecoratedEvent
	(*ClientMeta_Ethereum)(nil),          // 26: xatu.ClientMeta.Ethereum
	nil,                                  // 27: xatu.ClientMeta.LabelsEntry
	(*ClientMeta_AdditionalEthV1AttestationSourceData)(nil),                        // 28: xatu.ClientMeta.AdditionalEthV1AttestationSourceData
	(*ClientMeta_AdditionalEthV1AttestationSourceV2Data)(nil),                      // 29: xatu.ClientMeta.AdditionalEthV1AttestationSourceV2Data
	(*ClientMeta_AdditionalEthV1AttestationTargetData)(nil),                        // 30: xatu.ClientMeta.AdditionalEthV1AttestationTargetData
	(*ClientMeta_AdditionalEthV1AttestationTargetV2Data)(nil),                      // 31: xatu.ClientMeta.AdditionalEthV1AttestationTargetV2Data
	(*ClientMeta_AdditionalEthV1EventsAttestationData)(nil),                        // 32: xatu.ClientMeta.AdditionalEthV1EventsAttestationData
	(*ClientMeta_AdditionalEthV1EventsAttestationV2Data)(nil),                      // 33: xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data
	(*ClientMeta_AdditionalEthV1EventsHeadData)(nil),                               // 34: xatu.ClientMeta.AdditionalEthV1EventsHeadData
	(*ClientMeta_AdditionalEthV1EventsHeadV2Data)(nil),                             // 35: xatu.ClientMeta.AdditionalEthV1EventsHeadV2Data
	(*ClientMeta_AdditionalEthV1EventsBlockData)(nil),                              // 36: xatu.ClientMeta.AdditionalEthV1EventsBlockData
	(*ClientMeta_AdditionalEthV1EventsBlockV2Data)(nil),                            // 37: xatu.ClientMeta.AdditionalEthV1EventsBlockV2Data
	(*ClientMeta_AdditionalEthV1EventsBlockGossipData)(nil),                        // 38: xatu.ClientMeta.AdditionalEthV1EventsBlockGossipData
	(*ClientMeta_AdditionalEthV1EventsVoluntaryExitData)(nil),                      // 39: xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitData
	(*ClientMeta_AdditionalEthV1EventsVoluntaryExitV2Data)(nil),                    // 40: xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitV2Data
	(*ClientMeta_AdditionalEthV1EventsFinalizedCheckpointData)(nil),                // 41: xatu.ClientMeta.AdditionalEthV1EventsFinalizedCheckpointData
	(*ClientMeta_AdditionalEthV1EventsFinalizedCheckpointV2Data)(nil),              // 42: xatu.ClientMeta.AdditionalEthV1EventsFinalizedCheckpointV2Data
	(*ClientMeta_AdditionalEthV1EventsChainReorgData)(nil),                         // 43: xatu.ClientMeta.AdditionalEthV1EventsChainReorgData
	(*ClientMeta_AdditionalEthV1EventsChainReorgV2Data)(nil),                       // 44: xatu.ClientMeta.AdditionalEthV1EventsChainReorgV2Data
	(*ClientMeta_AdditionalEthV1EventsContributionAndProofContributionData)(nil),   // 45: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionData
	(*ClientMeta_AdditionalEthV1EventsContributionAndProofContributionV2Data)(nil), // 46: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionV2Data
	(*ClientMeta_AdditionalEthV1EventsContributionAndProofData)(nil),               // 47: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofData
	(*ClientMeta_AdditionalEthV1EventsContributionAndProofV2Data)(nil),             // 48: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofV2Data
	(*ClientMeta_ForkChoiceSnapshot)(nil),                                          // 49: xatu.ClientMeta.ForkChoiceSnapshot
	(*ClientMeta_ForkChoiceSnapshotV2)(nil),                                        // 50: xatu.ClientMeta.ForkChoiceSnapshotV2
	(*ClientMeta_AdditionalEthV1DebugForkChoiceData)(nil),                          // 51: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceData
	(*ClientMeta_AdditionalEthV1DebugForkChoiceV2Data)(nil),                        // 52: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceV2Data
	(*ClientMeta_AdditionalEthV1DebugForkChoiceReOrgData)(nil),                     // 53: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgData
	(*ClientMeta_AdditionalEthV1DebugForkChoiceReOrgV2Data)(nil),                   // 54: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgV2Data
	(*ClientMeta_AdditionalEthV1BeaconCommitteeData)(nil),                          // 55: xatu.ClientMeta.AdditionalEthV1BeaconCommitteeData
	(*ClientMeta_AdditionalMempoolTransactionData)(nil),                            // 56: xatu.ClientMeta.AdditionalMempoolTransactionData
	(*ClientMeta_AdditionalMempoolTransactionV2Data)(nil),                          // 57: xatu.ClientMeta.AdditionalMempoolTransactionV2Data
	(*ClientMeta_AdditionalEthV2BeaconBlockData)(nil),                              // 58: xatu.ClientMeta.AdditionalEthV2BeaconBlockData
	(*ClientMeta_AdditionalEthV2BeaconBlockV2Data)(nil),                            // 59: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data
	(*ClientMeta_AdditionalEthV2BeaconBlockAttesterSlashingData)(nil),              // 60: xatu.ClientMeta.AdditionalEthV2BeaconBlockAttesterSlashingData
	(*ClientMeta_AdditionalEthV2BeaconBlockProposerSlashingData)(nil),              // 61: xatu.ClientMeta.AdditionalEthV2BeaconBlockProposerSlashingData
	(*ClientMeta_AdditionalEthV2BeaconBlockVoluntaryExitData)(nil),                 // 62: xatu.ClientMeta.AdditionalEthV2BeaconBlockVoluntaryExitData
	(*ClientMeta_AdditionalEthV2BeaconBlockDepositData)(nil),                       // 63: xatu.ClientMeta.AdditionalEthV2BeaconBlockDepositData
	(*ClientMeta_AdditionalEthV2BeaconBlockBLSToExecutionChangeData)(nil),          // 64: xatu.ClientMeta.AdditionalEthV2BeaconBlockBLSToExecutionChangeData
	(*ClientMeta_AdditionalEthV2BeaconBlockExecutionTransactionData)(nil),          // 65: xatu.ClientMeta.AdditionalEthV2BeaconBlockExecutionTransactionData
	(*ClientMeta_AdditionalEthV2BeaconBlockWithdrawalData)(nil),                    // 66: xatu.ClientMeta.AdditionalEthV2BeaconBlockWithdrawalData
	(*ClientMeta_AdditionalBlockprintBlockClassificationData)(nil),                 // 67: xatu.ClientMeta.AdditionalBlockprintBlockClassificationData
	(*ClientMeta_AttestationDataSnapshot)(nil),                                     // 68: xatu.ClientMeta.AttestationDataSnapshot
	(*ClientMeta_AdditionalEthV1ValidatorAttestationDataData)(nil),                 // 69: xatu.ClientMeta.AdditionalEthV1ValidatorAttestationDataData
	(*ClientMeta_AdditionalEthV1EventsBlobSidecarData)(nil),                        // 70: xatu.ClientMeta.AdditionalEthV1EventsBlobSidecarData
	(*ClientMeta_AdditionalEthV1EventsDataColumnSidecarData)(nil),                  // 71: xatu.ClientMeta.AdditionalEthV1EventsDataColumnSidecarData
	(*ClientMeta_AdditionalEthV1BeaconBlobSidecarData)(nil),                        // 72: xatu.ClientMeta.AdditionalEthV1BeaconBlobSidecarData
	(*ClientMeta_AdditionalBeaconP2PAttestationData)(nil),                          // 73: xatu.ClientMeta.AdditionalBeaconP2PAttestationData
	(*ClientMeta_AdditionalEthV1ProposerDutyData)(nil),                             // 74: xatu.ClientMeta.AdditionalEthV1ProposerDutyData
	(*ClientMeta_AdditionalEthV2BeaconBlockElaboratedAttestationData)(nil),         // 75: xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData
	(*ClientMeta_AdditionalLibP2PTraceAddPeerData)(nil),                            // 76: xatu.ClientMeta.AdditionalLibP2PTraceAddPeerData
	(*ClientMeta_AdditionalLibP2PTraceRemovePeerData)(nil),                         // 77: xatu.ClientMeta.AdditionalLibP2PTraceRemovePeerData
	(*ClientMeta_AdditionalLibP2PTraceRecvRPCData)(nil),                            // 78: xatu.ClientMeta.AdditionalLibP2PTraceRecvRPCData
	(*ClientMeta_AdditionalLibP2PTraceSendRPCData)(nil),                            // 79: xatu.ClientMeta.AdditionalLibP2PTraceSendRPCData
	(*ClientMeta_AdditionalLibP2PTraceDropRPCData)(nil),                            // 80: xatu.ClientMeta.AdditionalLibP2PTraceDropRPCData
	(*ClientMeta_AdditionalLibP2PTraceRPCMetaControlIHaveData)(nil),                // 81: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIHaveData
	(*ClientMeta_AdditionalLibP2PTraceRPCMetaControlIWantData)(nil),                // 82: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIWantData
	(*ClientMeta_AdditionalLibP2PTraceRPCMetaControlIDontWantData)(nil),            // 83: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIDontWantData
	(*ClientMeta_AdditionalLibP2PTraceRPCMetaControlGraftData)(nil),                // 84: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlGraftData
	(*ClientMeta_AdditionalLibP2PTraceRPCMetaControlPruneData)(nil),                // 85: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlPruneData
	(*ClientMeta_AdditionalLibP2PTraceJoinData)(nil),                               // 86: xatu.ClientMeta.AdditionalLibP2PTraceJoinData
	(*ClientMeta_AdditionalLibP2PTraceLeaveData)(nil),                              // 87: xatu.ClientMeta.AdditionalLibP2PTraceLeaveData
	(*ClientMeta_AdditionalLibP2PTraceGraftData)(nil),                              // 88: xatu.ClientMeta.AdditionalLibP2PTraceGraftData
	(*ClientMeta_AdditionalLibP2PTracePruneData)(nil),                              // 89: xatu.ClientMeta.AdditionalLibP2PTracePruneData
	(*ClientMeta_AdditionalLibP2PTraceDuplicateMessageData)(nil),                   // 90: xatu.ClientMeta.AdditionalLibP2PTraceDuplicateMessageData
	(*ClientMeta_AdditionalLibP2PTraceDeliverMessageData)(nil),                     // 91: xatu.ClientMeta.AdditionalLibP2PTraceDeliverMessageData
	(*ClientMeta_AdditionalLibP2PTracePublishMessageData)(nil),                     // 92: xatu.ClientMeta.AdditionalLibP2PTracePublishMessageData
	(*ClientMeta_AdditionalLibP2PTraceRejectMessageData)(nil),                      // 93: xatu.ClientMeta.AdditionalLibP2PTraceRejectMessageData
	(*ClientMeta_AdditionalLibP2PTraceConnectedData)(nil),                          // 94: xatu.ClientMeta.AdditionalLibP2PTraceConnectedData
	(*ClientMeta_AdditionalLibP2PTraceDisconnectedData)(nil),                       // 95: xatu.ClientMeta.AdditionalLibP2PTraceDisconnectedData
	(*ClientMeta_AdditionalLibP2PTraceSyntheticHeartbeatData)(nil),                 // 96: xatu.ClientMeta.AdditionalLibP2PTraceSyntheticHeartbeatData
	(*ClientMeta_AdditionalLibP2PTraceHandleMetadataData)(nil),                     // 97: xatu.ClientMeta.AdditionalLibP2PTraceHandleMetadataData
	(*ClientMeta_AdditionalLibP2PTraceHandleStatusData)(nil),                       // 98: xatu.ClientMeta.AdditionalLibP2PTraceHandleStatusData
	(*ClientMeta_AdditionalLibP2PTraceRpcDataColumnCustodyProbeData)(nil),          // 99: xatu.ClientMeta.AdditionalLibP2PTraceRpcDataColumnCustodyProbeData
	(*ClientMeta_AdditionalLibP2PTraceRPCMetaSubscriptionData)(nil),                // 100: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaSubscriptionData
	(*ClientMeta_AdditionalLibP2PTraceRPCMetaMessageData)(nil),                     // 101: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaMessageData
	(*ClientMeta_AdditionalLibP2PTraceGossipSubBeaconBlockData)(nil),               // 102: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData
	(*ClientMeta_AdditionalLibP2PTraceGossipSubBeaconAttestationSourceData)(nil),   // 103: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationSourceData
	(*ClientMeta_AdditionalLibP2PTraceGossipSubBeaconAttestationTargetData)(nil),   // 104: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationTargetData
	(*ClientMeta_AdditionalLibP2PTraceGossipSubBeaconAttestationData)(nil),         // 105: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData
	(*ClientMeta_AdditionalLibP2PTraceGossipSubAggregateAndProofData)(nil),         // 106: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData
	(*ClientMeta_AdditionalLibP2PTraceGossipSubBlobSidecarData)(nil),               // 107: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData
	(*ClientMeta_AdditionalLibP2PTraceGossipSubDataColumnSidecarData)(nil),         // 108: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData
	(*ClientMeta_AdditionalEthV1ValidatorsData)(nil),                               // 109: xatu.ClientMeta.AdditionalEthV1ValidatorsData
	(*ClientMeta_AdditionalMevRelayBidTraceBuilderBlockSubmissionData)(nil),        // 110: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData
	(*ClientMeta_AdditionalMevRelayPayloadDeliveredData)(nil),                      // 111: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData
	(*ClientMeta_AdditionalEthV3ValidatorBlockData)(nil),                           // 112: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData
	(*ClientMeta_AdditionalMevRelayValidatorRegistrationData)(nil),                 // 113: xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData
	(*ClientMeta_AdditionalNodeRecordConsensusData)(nil),                           // 114: xatu.ClientMeta.AdditionalNodeRecordConsensusData
	(*ClientMeta_AdditionalConsensusEngineAPINewPayloadData)(nil),                  // 115: xatu.ClientMeta.AdditionalConsensusEngineAPINewPayloadData
	(*ClientMeta_AdditionalConsensusEngineAPIGetBlobsData)(nil),                    // 116: xatu.ClientMeta.AdditionalConsensusEngineAPIGetBlobsData
	...
	(*libp2p.Peer)(nil),                                                            // 204: xatu.libp2p.Peer
	(*wrapperspb.BoolValue)(nil),                                                   // 205: google.protobuf.BoolValue
	(*libp2p.TraceEventMetadata)(nil),                                              // 206: xatu.libp2p.TraceEventMetadata
	(*wrapperspb.StringValue)(nil),                                                 // 207: google.protobuf.StringValue
	(*mevrelay.Relay)(nil),                                                         // 208: xatu.mevrelay.Relay
}
var file_pkg_proto_xatu_event_ingester_proto_depIdxs = []int32{
	25,  // 0: xatu.CreateEventsRequest.events:type_name -> xatu.DecoratedEvent
	...
	137, // 20: xatu.DepthStats.depth:type_name -> google.protobuf.UInt32Value
	17,  // 21: xatu.ExecutionBlockStateMetrics.account_trie_depth_created:type_name -> xatu.DepthStats
	17,  // 22: xatu.ExecutionBlockStateMetrics.storage_trie_depth_created:type_name -> xatu.DepthStats
	17,  // 23: xatu.ExecutionBlockStateMetrics.account_trie_depth_deleted:type_name -> xatu.DepthStats
	17,  // 24: xatu.ExecutionBlockStateMetrics.storage_trie_depth_deleted:type_name -> xatu.DepthStats
	131, // 25: xatu.ConsensusEngineAPINewPayload.requested_at:type_name -> google.protobuf.Timestamp
	130, // 26: xatu.ConsensusEngineAPINewPayload.duration_ms:type_name -> google.protobuf.UInt64Value
	130, // 27: xatu.ConsensusEngineAPINewPayload.slot:type_name -> google.protobuf.UInt64Value
	130, // 28: xatu.ConsensusEngineAPINewPayload.proposer_index:type_name -> google.protobuf.UInt64Value
	130, // 29: xatu.ConsensusEngineAPINewPayload.block_number:type_name -> google.protobuf.UInt64Value
	130, // 30: xatu.ConsensusEngineAPINewPayload.gas_used:type_name -> google.protobuf.UInt64Value
	130, // 31: xatu.ConsensusEngineAPINewPayload.gas_limit:type_name -> google.protobuf.UInt64Value
	137, // 32: xatu.ConsensusEngineAPINewPayload.tx_count:type_name -> google.protobuf.UInt32Value
	137, // 33: xatu.ConsensusEngineAPINewPayload.blob_count:type_name -> google.protobuf.UInt32Value
	131, // 34: xatu.ConsensusEngineAPIGetBlobs.requested_at:type_name -> google.protobuf.Timestamp
	130, // 35: xatu.ConsensusEngineAPIGetBlobs.duration_ms:type_name -> google.protobuf.UInt64Value
	130, // 36: xatu.ConsensusEngineAPIGetBlobs.slot:type_name -> google.protobuf.UInt64Value
	137, // 37: xatu.ConsensusEngineAPIGetBlobs.requested_count:type_name -> google.protobuf.UInt32Value
	137, // 38: xatu.ConsensusEngineAPIGetBlobs.returned_count:type_name -> google.protobuf.UInt32Value
	26,  // 39: xatu.ClientMeta.ethereum:type_name -> xatu.ClientMeta.Ethereum
	27,  // 40: xatu.ClientMeta.labels:type_name -> xatu.ClientMeta.LabelsEntry
	32,  // 41: xatu.ClientMeta.eth_v1_events_attestation:type_name -> xatu.ClientMeta.AdditionalEthV1EventsAttestationData
	34,  // 42: xatu.ClientMeta.eth_v1_events_head:type_name -> xatu.ClientMeta.AdditionalEthV1EventsHeadData
	36,  // 43: xatu.ClientMeta.eth_v1_events_block:type_name -> xatu.ClientMeta.AdditionalEthV1EventsBlockData
	39,  // 44: xatu.ClientMeta.eth_v1_events_voluntary_exit:type_name -> xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitData
	41,  // 45: xatu.ClientMeta.eth_v1_events_finalized_checkpoint:type_name -> xatu.ClientMeta.AdditionalEthV1EventsFinalizedCheckpointData
	43,  // 46: xatu.ClientMeta.eth_v1_events_chain_reorg:type_name -> xatu.ClientMeta.AdditionalEthV1EventsChainReorgData
	47,  // 47: xatu.ClientMeta.eth_v1_events_contribution_and_proof:type_name -> xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofData
	56,  // 48: xatu.ClientMeta.mempool_transaction:type_name -> xatu.ClientMeta.AdditionalMempoolTransactionData
	58,  // 49: xatu.ClientMeta.eth_v2_beacon_block:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockData
	51,  // 50: xatu.ClientMeta.eth_v1_debug_fork_choice:type_name -> xatu.ClientMeta.AdditionalEthV1DebugForkChoiceData
	53,  // 51: xatu.ClientMeta.eth_v1_debug_fork_choice_reorg:type_name -> xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgData
	55,  // 52: xatu.ClientMeta.eth_v1_beacon_committee:type_name -> xatu.ClientMeta.AdditionalEthV1BeaconCommitteeData
	69,  // 53: xatu.ClientMeta.eth_v1_validator_attestation_data:type_name -> xatu.ClientMeta.AdditionalEthV1ValidatorAttestationDataData
	33,  // 54: xatu.ClientMeta.eth_v1_events_attestation_v2:type_name -> xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data
	35,  // 55: xatu.ClientMeta.eth_v1_events_head_v2:type_name -> xatu.ClientMeta.AdditionalEthV1EventsHeadV2Data
	37,  // 56: xatu.ClientMeta.eth_v1_events_block_v2:type_name -> xatu.ClientMeta.AdditionalEthV1EventsBlockV2Data
	40,  // 57: xatu.ClientMeta.eth_v1_events_voluntary_exit_v2:type_name -> xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitV2Data
	42,  // 58: xatu.ClientMeta.eth_v1_events_finalized_checkpoint_v2:type_name -> xatu.ClientMeta.AdditionalEthV1EventsFinalizedCheckpointV2Data
	44,  // 59: xatu.ClientMeta.eth_v1_events_chain_reorg_v2:type_name -> xatu.ClientMeta.AdditionalEthV1EventsChainReorgV2Data
	48,  // 60: xatu.ClientMeta.eth_v1_events_contribution_and_proof_v2:type_name -> xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofV2Data
	57,  // 61: xatu.ClientMeta.mempool_transaction_v2:type_name -> xatu.ClientMeta.AdditionalMempoolTransactionV2Data
	59,  // 62: xatu.ClientMeta.eth_v2_beacon_block_v2:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data
	52,  // 63: xatu.ClientMeta.eth_v1_debug_fork_choice_v2:type_name -> xatu.ClientMeta.AdditionalEthV1DebugForkChoiceV2Data
	54,  // 64: xatu.ClientMeta.eth_v1_debug_fork_choice_reorg_v2:type_name -> xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgV2Data
	60,  // 65: xatu.ClientMeta.eth_v2_beacon_block_attester_slashing:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockAttesterSlashingData
	61,  // 66: xatu.ClientMeta.eth_v2_beacon_block_proposer_slashing:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockProposerSlashingData
	62,  // 67: xatu.ClientMeta.eth_v2_beacon_block_voluntary_exit:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockVoluntaryExitData
	63,  // 68: xatu.ClientMeta.eth_v2_beacon_block_deposit:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockDepositData
	64,  // 69: xatu.ClientMeta.eth_v2_beacon_block_bls_to_execution_change:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockBLSToExecutionChangeData
	65,  // 70: xatu.ClientMeta.eth_v2_beacon_block_execution_transaction:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockExecutionTransactionData
	66,  // 71: xatu.ClientMeta.eth_v2_beacon_block_withdrawal:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockWithdrawalData
	70,  // 72: xatu.ClientMeta.eth_v1_events_blob_sidecar:type_name -> xatu.ClientMeta.AdditionalEthV1EventsBlobSidecarData
	67,  // 73: xatu.ClientMeta.blockprint_block_classification:type_name -> xatu.ClientMeta.AdditionalBlockprintBlockClassificationData
	72,  // 74: xatu.ClientMeta.eth_v1_beacon_blob_sidecar:type_name -> xatu.ClientMeta.AdditionalEthV1BeaconBlobSidecarData
	73,  // 75: xatu.ClientMeta.beacon_p2p_attestation:type_name -> xatu.ClientMeta.AdditionalBeaconP2PAttestationData
	74,  // 76: xatu.ClientMeta.eth_v1_proposer_duty:type_name -> xatu.ClientMeta.AdditionalEthV1ProposerDutyData
	75,  // 77: xatu.ClientMeta.eth_v2_beacon_block_elaborated_attestation:type_name -> xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData
	76,  // 78: xatu.ClientMeta.libp2p_trace_add_peer:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceAddPeerData
	77,  // 79: xatu.ClientMeta.libp2p_trace_remove_peer:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRemovePeerData
	78,  // 80: xatu.ClientMeta.libp2p_trace_recv_rpc:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRecvRPCData
	79,  // 81: xatu.ClientMeta.libp2p_trace_send_rpc:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceSendRPCData
	86,  // 82: xatu.ClientMeta.libp2p_trace_join:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceJoinData
	94,  // 83: xatu.ClientMeta.libp2p_trace_connected:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceConnectedData
	95,  // 84: xatu.ClientMeta.libp2p_trace_disconnected:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceDisconnectedData
	97,  // 85: xatu.ClientMeta.libp2p_trace_handle_metadata:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceHandleMetadataData
	98,  // 86: xatu.ClientMeta.libp2p_trace_handle_status:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceHandleStatusData
	102, // 87: xatu.ClientMeta.libp2p_trace_gossipsub_beacon_block:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData
	105, // 88: xatu.ClientMeta.libp2p_trace_gossipsub_beacon_attestation:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData
	107, // 89: xatu.ClientMeta.libp2p_trace_gossipsub_blob_sidecar:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData
	109, // 90: xatu.ClientMeta.eth_v1_validators:type_name -> xatu.ClientMeta.AdditionalEthV1ValidatorsData
	110, // 91: xatu.ClientMeta.mev_relay_bid_trace_builder_block_submission:type_name -> xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData
	111, // 92: xatu.ClientMeta.mev_relay_payload_delivered:type_name -> xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData
	112, // 93: xatu.ClientMeta.eth_v3_validator_block:type_name -> xatu.ClientMeta.AdditionalEthV3ValidatorBlockData
	113, // 94: xatu.ClientMeta.mev_relay_validator_registration:type_name -> xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData
	38,  // 95: xatu.ClientMeta.eth_v1_events_block_gossip:type_name -> xatu.ClientMeta.AdditionalEthV1EventsBlockGossipData
	80,  // 96: xatu.ClientMeta.libp2p_trace_drop_rpc:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceDropRPCData
	87,  // 97: xatu.ClientMeta.libp2p_trace_leave:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceLeaveData
	88,  // 98: xatu.ClientMeta.libp2p_trace_graft:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGraftData
	89,  // 99: xatu.ClientMeta.libp2p_trace_prune:type_name -> xatu.ClientMeta.AdditionalLibP2PTracePruneData
	90,  // 100: xatu.ClientMeta.libp2p_trace_duplicate_message:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceDuplicateMessageData
	91,  // 101: xatu.ClientMeta.libp2p_trace_deliver_message:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceDeliverMessageData
	92,  // 102: xatu.ClientMeta.libp2p_trace_publish_message:type_name -> xatu.ClientMeta.AdditionalLibP2PTracePublishMessageData
	93,  // 103: xatu.ClientMeta.libp2p_trace_reject_message:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRejectMessageData
	81,  // 104: xatu.ClientMeta.libp2p_trace_rpc_meta_control_ihave:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIHaveData
	82,  // 105: xatu.ClientMeta.libp2p_trace_rpc_meta_control_iwant:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIWantData
	83,  // 106: xatu.ClientMeta.libp2p_trace_rpc_meta_control_idontwant:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIDontWantData
	84,  // 107: xatu.ClientMeta.libp2p_trace_rpc_meta_control_graft:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlGraftData
	85,  // 108: xatu.ClientMeta.libp2p_trace_rpc_meta_control_prune:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlPruneData
	100, // 109: xatu.ClientMeta.libp2p_trace_rpc_meta_subscription:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaSubscriptionData
	101, // 110: xatu.ClientMeta.libp2p_trace_rpc_meta_message:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaMessageData
	114, // 111: xatu.ClientMeta.node_record_consensus:type_name -> xatu.ClientMeta.AdditionalNodeRecordConsensusData
	106, // 112: xatu.ClientMeta.libp2p_trace_gossipsub_aggregate_and_proof:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData
	71,  // 113: xatu.ClientMeta.eth_v1_events_data_column_sidecar:type_name -> xatu.ClientMeta.AdditionalEthV1EventsDataColumnSidecarData
	108, // 114: xatu.ClientMeta.libp2p_trace_gossipsub_data_column_sidecar:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData
	96,  // 115: xatu.ClientMeta.libp2p_trace_synthetic_heartbeat:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceSyntheticHeartbeatData
	99,  // 116: xatu.ClientMeta.libp2p_trace_rpc_data_column_custody_probe:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceRpcDataColumnCustodyProbeData
	115, // 117: xatu.ClientMeta.consensus_engine_api_new_payload:type_name -> xatu.ClientMeta.AdditionalConsensusEngineAPINewPayloadData
	116, // 118: xatu.ClientMeta.consensus_engine_api_get_blobs:type_name -> xatu.ClientMeta.AdditionalConsensusEngineAPIGetBlobsData
	138, // 119: xatu.ClientMeta.module_name:type_name -> xatu.ModuleName
	120, // 120: xatu.ServerMeta.event:type_name -> xatu.ServerMeta.Event
	122, // 121: xatu.ServerMeta.client:type_name -> xatu.ServerMeta.Client
	124, // 122: xatu.ServerMeta.BEACON_P2P_ATTESTATION:type_name -> xatu.ServerMeta.AdditionalBeaconP2PAttestationData
	125, // 123: xatu.ServerMeta.LIBP2P_TRACE_CONNECTED:type_name -> xatu.ServerMeta.AdditionalLibp2PTraceConnectedData
	126, // 124: xatu.ServerMeta.LIBP2P_TRACE_DISCONNECTED:type_name -> xatu.ServerMeta.AdditionalLibp2PTraceDisconnectedData
	128, // 125: xatu.ServerMeta.NODE_RECORD_CONSENSUS:type_name -> xatu.ServerMeta.AdditionalNodeRecordConsensusData
	129, // 126: xatu.ServerMeta.NODE_RECORD_EXECUTION:type_name -> xatu.ServerMeta.AdditionalNodeRecordExecutionData
	127, // 127: xatu.ServerMeta.LIBP2P_TRACE_SYNTHETIC_HEARTBEAT:type_name -> xatu.ServerMeta.AdditionalLibP2PTraceSyntheticHeartbeatData
	21,  // 128: xatu.Meta.client:type_name -> xatu.ClientMeta
	22,  // 129: xatu.Meta.server:type_name -> xatu.ServerMeta
	0,   // 130: xatu.Event.name:type_name -> xatu.Event.Name
	131, // 131: xatu.Event.date_time:type_name -> google.protobuf.Timestamp
	24,  // 132: xatu.DecoratedEvent.event:type_name -> xatu.Event
	23,  // 133: xatu.DecoratedEvent.meta:type_name -> xatu.Meta
	139, // 134: xatu.DecoratedEvent.eth_v1_events_attestation:type_name -> xatu.eth.v1.Attestation
	140, // 135: xatu.DecoratedEvent.eth_v1_events_block:type_name -> xatu.eth.v1.EventBlock
	133, // 136: xatu.DecoratedEvent.eth_v1_events_chain_reorg:type_name -> xatu.eth.v1.EventChainReorg
	141, // 137: xatu.DecoratedEvent.eth_v1_events_finalized_checkpoint:type_name -> xatu.eth.v1.EventFinalizedCheckpoint
	142, // 138: xatu.DecoratedEvent.eth_v1_events_head:type_name -> xatu.eth.v1.EventHead
	143, // 139: xatu.DecoratedEvent.eth_v1_events_voluntary_exit:type_name -> xatu.eth.v1.EventVoluntaryExit
	144, // 140: xatu.DecoratedEvent.eth_v1_events_contribution_and_proof:type_name -> xatu.eth.v1.EventContributionAndProof
	145, // 141: xatu.DecoratedEvent.eth_v2_beacon_block:type_name -> xatu.eth.v2.EventBlock
	132, // 142: xatu.DecoratedEvent.eth_v1_fork_choice:type_name -> xatu.eth.v1.ForkChoice
	12,  // 143: xatu.DecoratedEvent.eth_v1_fork_choice_reorg:type_name -> xatu.DebugForkChoiceReorg
	146, // 144: xatu.DecoratedEvent.eth_v1_beacon_committee:type_name -> xatu.eth.v1.Committee
	147, // 145: xatu.DecoratedEvent.eth_v1_validator_attestation_data:type_name -> xatu.eth.v1.AttestationDataV2
	148, // 146: xatu.DecoratedEvent.eth_v1_events_attestation_v2:type_name -> xatu.eth.v1.AttestationV2
	149, // 147: xatu.DecoratedEvent.eth_v1_events_block_v2:type_name -> xatu.eth.v1.EventBlockV2
	135, // 148: xatu.DecoratedEvent.eth_v1_events_chain_reorg_v2:type_name -> xatu.eth.v1.EventChainReorgV2
	150, // 149: xatu.DecoratedEvent.eth_v1_events_finalized_checkpoint_v2:type_name -> xatu.eth.v1.EventFinalizedCheckpointV2
	151, // 150: xatu.DecoratedEvent.eth_v1_events_head_v2:type_name -> xatu.eth.v1.EventHeadV2
	152, // 151: xatu.DecoratedEvent.eth_v1_events_voluntary_exit_v2:type_name -> xatu.eth.v1.EventVoluntaryExitV2
	153, // 152: xatu.DecoratedEvent.eth_v1_events_contribution_and_proof_v2:type_name -> xatu.eth.v1.EventContributionAndProofV2
	154, // 153: xatu.DecoratedEvent.eth_v2_beacon_block_v2:type_name -> xatu.eth.v2.EventBlockV2
	134, // 154: xatu.DecoratedEvent.eth_v1_fork_choice_v2:type_name -> xatu.eth.v1.ForkChoiceV2
	13,  // 155: xatu.DecoratedEvent.eth_v1_fork_choice_reorg_v2:type_name -> xatu.DebugForkChoiceReorgV2
	155, // 156: xatu.DecoratedEvent.eth_v2_beacon_block_attester_slashing:type_name -> xatu.eth.v1.AttesterSlashingV2
	156, // 157: xatu.DecoratedEvent.eth_v2_beacon_block_proposer_slashing:type_name -> xatu.eth.v1.ProposerSlashingV2
	157, // 158: xatu.DecoratedEvent.eth_v2_beacon_block_voluntary_exit:type_name -> xatu.eth.v1.SignedVoluntaryExitV2
	158, // 159: xatu.DecoratedEvent.eth_v2_beacon_block_deposit:type_name -> xatu.eth.v1.DepositV2
	159, // 160: xatu.DecoratedEvent.eth_v2_beacon_block_bls_to_execution_change:type_name -> xatu.eth.v2.SignedBLSToExecutionChangeV2
	160, // 161: xatu.DecoratedEvent.eth_v2_beacon_block_execution_transaction:type_name -> xatu.eth.v1.Transaction
	161, // 162: xatu.DecoratedEvent.eth_v2_beacon_block_withdrawal:type_name -> xatu.eth.v1.WithdrawalV2
	162, // 163: xatu.DecoratedEvent.eth_v1_events_blob_sidecar:type_name -> xatu.eth.v1.EventBlobSidecar
	163, // 164: xatu.DecoratedEvent.blockprint_block_classification:type_name -> xatu.blockprint.BlockClassification
	164, // 165: xatu.DecoratedEvent.eth_v1_beacon_block_blob_sidecar:type_name -> xatu.eth.v1.BlobSidecar
	148, // 166: xatu.DecoratedEvent.beacon_p2p_attestation:type_name -> xatu.eth.v1.AttestationV2
	165, // 167: xatu.DecoratedEvent.eth_v1_proposer_duty:type_name -> xatu.eth.v1.ProposerDuty
	166, // 168: xatu.DecoratedEvent.eth_v2_beacon_block_elaborated_attestation:type_name -> xatu.eth.v1.ElaboratedAttestation
	167, // 169: xatu.DecoratedEvent.libp2p_trace_add_peer:type_name -> xatu.libp2p.AddPeer
	168, // 170: xatu.DecoratedEvent.libp2p_trace_remove_peer:type_name -> xatu.libp2p.RemovePeer
	169, // 171: xatu.DecoratedEvent.libp2p_trace_recv_rpc:type_name -> xatu.libp2p.RecvRPC
	170, // 172: xatu.DecoratedEvent.libp2p_trace_send_rpc:type_name -> xatu.libp2p.SendRPC
	171, // 173: xatu.DecoratedEvent.libp2p_trace_join:type_name -> xatu.libp2p.Join
	172, // 174: xatu.DecoratedEvent.libp2p_trace_connected:type_name -> xatu.libp2p.Connected
	173, // 175: xatu.DecoratedEvent.libp2p_trace_disconnected:type_name -> xatu.libp2p.Disconnected
	174, // 176: xatu.DecoratedEvent.libp2p_trace_handle_metadata:type_name -> xatu.libp2p.HandleMetadata
	175, // 177: xatu.DecoratedEvent.libp2p_trace_handle_status:type_name -> xatu.libp2p.HandleStatus
	176, // 178: xatu.DecoratedEvent.libp2p_trace_gossipsub_beacon_block:type_name -> xatu.libp2p.gossipsub.eth.BeaconBlock
	139, // 179: xatu.DecoratedEvent.libp2p_trace_gossipsub_beacon_attestation:type_name -> xatu.eth.v1.Attestation
	177, // 180: xatu.DecoratedEvent.libp2p_trace_gossipsub_blob_sidecar:type_name -> xatu.libp2p.gossipsub.eth.BlobSidecar
	14,  // 181: xatu.DecoratedEvent.eth_v1_validators:type_name -> xatu.Validators
	178, // 182: xatu.DecoratedEvent.mev_relay_bid_trace_builder_block_submission:type_name -> xatu.mevrelay.BidTrace
	179, // 183: xatu.DecoratedEvent.mev_relay_payload_delivered:type_name -> xatu.mevrelay.ProposerPayloadDelivered
	154, // 184: xatu.DecoratedEvent.eth_v3_validator_block:type_name -> xatu.eth.v2.EventBlockV2
	180, // 185: xatu.DecoratedEvent.mev_relay_validator_registration:type_name -> xatu.mevrelay.ValidatorRegistration
	181, // 186: xatu.DecoratedEvent.eth_v1_events_block_gossip:type_name -> xatu.eth.v1.EventBlockGossip
	182, // 187: xatu.DecoratedEvent.libp2p_trace_drop_rpc:type_name -> xatu.libp2p.DropRPC
	183, // 188: xatu.DecoratedEvent.libp2p_trace_leave:type_name -> xatu.libp2p.Leave
	184, // 189: xatu.DecoratedEvent.libp2p_trace_graft:type_name -> xatu.libp2p.Graft
	185, // 190: xatu.DecoratedEvent.libp2p_trace_prune:type_name -> xatu.libp2p.Prune
	186, // 191: xatu.DecoratedEvent.libp2p_trace_duplicate_message:type_name -> xatu.libp2p.DuplicateMessage
	187, // 192: xatu.DecoratedEvent.libp2p_trace_deliver_message:type_name -> xatu.libp2p.DeliverMessage
	188, // 193: xatu.DecoratedEvent.libp2p_trace_publish_message:type_name -> xatu.libp2p.PublishMessage
	189, // 194: xatu.DecoratedEvent.libp2p_trace_reject_message:type_name -> xatu.libp2p.RejectMessage
	190, // 195: xatu.DecoratedEvent.libp2p_trace_rpc_meta_control_ihave:type_name -> xatu.libp2p.ControlIHaveMetaItem
	191, // 196: xatu.DecoratedEvent.libp2p_trace_rpc_meta_control_iwant:type_name -> xatu.libp2p.ControlIWantMetaItem
	192, // 197: xatu.DecoratedEvent.libp2p_trace_rpc_meta_control_idontwant:type_name -> xatu.libp2p.ControlIDontWantMetaItem
	193, // 198: xatu.DecoratedEvent.libp2p_trace_rpc_meta_control_graft:type_name -> xatu.libp2p.ControlGraftMetaItem
	194, // 199: xatu.DecoratedEvent.libp2p_trace_rpc_meta_control_prune:type_name -> xatu.libp2p.ControlPruneMetaItem
	195, // 200: xatu.DecoratedEvent.libp2p_trace_rpc_meta_subscription:type_name -> xatu.libp2p.SubMetaItem
	196, // 201: xatu.DecoratedEvent.libp2p_trace_rpc_meta_message:type_name -> xatu.libp2p.MessageMetaItem
	197, // 202: xatu.DecoratedEvent.node_record_consensus:type_name -> xatu.noderecord.Consensus
	198, // 203: xatu.DecoratedEvent.node_record_execution:type_name -> xatu.noderecord.Execution
	199, // 204: xatu.DecoratedEvent.libp2p_trace_gossipsub_aggregate_and_proof:type_name -> xatu.eth.v1.SignedAggregateAttestationAndProofV2
	200, // 205: xatu.DecoratedEvent.eth_v1_events_data_column_sidecar:type_name -> xatu.eth.v1.EventDataColumnSidecar
	201, // 206: xatu.DecoratedEvent.libp2p_trace_gossipsub_data_column_sidecar:type_name -> xatu.libp2p.gossipsub.eth.DataColumnSidecar
	202, // 207: xatu.DecoratedEvent.libp2p_trace_synthetic_heartbeat:type_name -> xatu.libp2p.SyntheticHeartbeat
	203, // 208: xatu.DecoratedEvent.libp2p_trace_rpc_data_column_custody_probe:type_name -> xatu.libp2p.DataColumnCustodyProbe
	16,  // 209: xatu.DecoratedEvent.execution_state_size:type_name -> xatu.ExecutionStateSize
	19,  // 210: xatu.DecoratedEvent.consensus_engine_api_new_payload:type_name -> xatu.ConsensusEngineAPINewPayload
	20,  // 211: xatu.DecoratedEvent.consensus_engine_api_get_blobs:type_name -> xatu.ConsensusEngineAPIGetBlobs
	18,  // 212: xatu.DecoratedEvent.execution_block_state_metrics:type_name -> xatu.ExecutionBlockStateMetrics
	117, // 213: xatu.ClientMeta.Ethereum.network:type_name -> xatu.ClientMeta.Ethereum.Network
	118, // 214: xatu.ClientMeta.Ethereum.execution:type_name -> xatu.ClientMeta.Ethereum.Execution
	119, // 215: xatu.ClientMeta.Ethereum.consensus:type_name -> xatu.ClientMeta.Ethereum.Consensus
	3,   // 216: xatu.ClientMeta.AdditionalEthV1AttestationSourceData.epoch:type_name -> xatu.Epoch
	4,   // 217: xatu.ClientMeta.AdditionalEthV1AttestationSourceV2Data.epoch:type_name -> xatu.EpochV2
	3,   // 218: xatu.ClientMeta.AdditionalEthV1AttestationTargetData.epoch:type_name -> xatu.Epoch
	4,   // 219: xatu.ClientMeta.AdditionalEthV1AttestationTargetV2Data.epoch:type_name -> xatu.EpochV2
	28,  // 220: xatu.ClientMeta.AdditionalEthV1EventsAttestationData.source:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationSourceData
	30,  // 221: xatu.ClientMeta.AdditionalEthV1EventsAttestationData.target:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationTargetData
	5,   // 222: xatu.ClientMeta.AdditionalEthV1EventsAttestationData.slot:type_name -> xatu.Slot
	3,   // 223: xatu.ClientMeta.AdditionalEthV1EventsAttestationData.epoch:type_name -> xatu.Epoch
	8,   // 224: xatu.ClientMeta.AdditionalEthV1EventsAttestationData.propagation:type_name -> xatu.Propagation
	10,  // 225: xatu.ClientMeta.AdditionalEthV1EventsAttestationData.attesting_validator:type_name -> xatu.AttestingValidator
	29,  // 226: xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data.source:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationSourceV2Data
	31,  // 227: xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data.target:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationTargetV2Data
	6,   // 228: xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data.slot:type_name -> xatu.SlotV2
	4,   // 229: xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data.epoch:type_name -> xatu.EpochV2
	9,   // 230: xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data.propagation:type_name -> xatu.PropagationV2
	11,  // 231: xatu.ClientMeta.AdditionalEthV1EventsAttestationV2Data.attesting_validator:type_name -> xatu.AttestingValidatorV2
	3,   // 232: xatu.ClientMeta.AdditionalEthV1EventsHeadData.epoch:type_name -> xatu.Epoch
	5,   // 233: xatu.ClientMeta.AdditionalEthV1EventsHeadData.slot:type_name -> xatu.Slot
	8,   // 234: xatu.ClientMeta.AdditionalEthV1EventsHeadData.propagation:type_name -> xatu.Propagation
	4,   // 235: xatu.ClientMeta.AdditionalEthV1EventsHeadV2Data.epoch:type_name -> xatu.EpochV2
	6,   // 236: xatu.ClientMeta.AdditionalEthV1EventsHeadV2Data.slot:type_name -> xatu.SlotV2
	9,   // 237: xatu.ClientMeta.AdditionalEthV1EventsHeadV2Data.propagation:type_name -> xatu.PropagationV2
	3,   // 238: xatu.ClientMeta.AdditionalEthV1EventsBlockData.epoch:type_name -> xatu.Epoch
	5,   // 239: xatu.ClientMeta.AdditionalEthV1EventsBlockData.slot:type_name -> xatu.Slot
	8,   // 240: xatu.ClientMeta.AdditionalEthV1EventsBlockData.propagation:type_name -> xatu.Propagation
	4,   // 241: xatu.ClientMeta.AdditionalEthV1EventsBlockV2Data.epoch:type_name -> xatu.EpochV2
	6,   // 242: xatu.ClientMeta.AdditionalEthV1EventsBlockV2Data.slot:type_name -> xatu.SlotV2
	9,   // 243: xatu.ClientMeta.AdditionalEthV1EventsBlockV2Data.propagation:type_name -> xatu.PropagationV2
	4,   // 244: xatu.ClientMeta.AdditionalEthV1EventsBlockGossipData.epoch:type_name -> xatu.EpochV2
	6,   // 245: xatu.ClientMeta.AdditionalEthV1EventsBlockGossipData.slot:type_name -> xatu.SlotV2
	9,   // 246: xatu.ClientMeta.AdditionalEthV1EventsBlockGossipData.propagation:type_name -> xatu.PropagationV2
	3,   // 247: xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitData.epoch:type_name -> xatu.Epoch
	4,   // 248: xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitV2Data.epoch:type_name -> xatu.EpochV2
	4,   // 249: xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitV2Data.wallclock_epoch:type_name -> xatu.EpochV2
	6,   // 250: xatu.ClientMeta.AdditionalEthV1EventsVoluntaryExitV2Data.wallclock_slot:type_name -> xatu.SlotV2
	3,   // 251: xatu.ClientMeta.AdditionalEthV1EventsFinalizedCheckpointData.epoch:type_name -> xatu.Epoch
	4,   // 252: xatu.ClientMeta.AdditionalEthV1EventsFinalizedCheckpointV2Data.epoch:type_name -> xatu.EpochV2
	3,   // 253: xatu.ClientMeta.AdditionalEthV1EventsChainReorgData.epoch:type_name -> xatu.Epoch
	5,   // 254: xatu.ClientMeta.AdditionalEthV1EventsChainReorgData.slot:type_name -> xatu.Slot
	8,   // 255: xatu.ClientMeta.AdditionalEthV1EventsChainReorgData.propagation:type_name -> xatu.Propagation
	4,   // 256: xatu.ClientMeta.AdditionalEthV1EventsChainReorgV2Data.epoch:type_name -> xatu.EpochV2
	6,   // 257: xatu.ClientMeta.AdditionalEthV1EventsChainReorgV2Data.slot:type_name -> xatu.SlotV2
	9,   // 258: xatu.ClientMeta.AdditionalEthV1EventsChainReorgV2Data.propagation:type_name -> xatu.PropagationV2
	3,   // 259: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionData.epoch:type_name -> xatu.Epoch
	5,   // 260: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionData.slot:type_name -> xatu.Slot
	8,   // 261: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionData.propagation:type_name -> xatu.Propagation
	4,   // 262: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionV2Data.epoch:type_name -> xatu.EpochV2
	6,   // 263: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionV2Data.slot:type_name -> xatu.SlotV2
	9,   // 264: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionV2Data.propagation:type_name -> xatu.PropagationV2
	45,  // 265: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofData.contribution:type_name -> xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionData
	46,  // 266: xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofV2Data.contribution:type_name -> xatu.ClientMeta.AdditionalEthV1EventsContributionAndProofContributionV2Data
	3,   // 267: xatu.ClientMeta.ForkChoiceSnapshot.request_epoch:type_name -> xatu.Epoch
	5,   // 268: xatu.ClientMeta.ForkChoiceSnapshot.request_slot:type_name -> xatu.Slot
	131, // 269: xatu.ClientMeta.ForkChoiceSnapshot.timestamp:type_name -> google.protobuf.Timestamp
	4,   // 270: xatu.ClientMeta.ForkChoiceSnapshotV2.request_epoch:type_name -> xatu.EpochV2
	6,   // 271: xatu.ClientMeta.ForkChoiceSnapshotV2.request_slot:type_name -> xatu.SlotV2
	130, // 272: xatu.ClientMeta.ForkChoiceSnapshotV2.requested_at_slot_start_diff_ms:type_name -> google.protobuf.UInt64Value
	130, // 273: xatu.ClientMeta.ForkChoiceSnapshotV2.request_duration_ms:type_name -> google.protobuf.UInt64Value
	131, // 274: xatu.ClientMeta.ForkChoiceSnapshotV2.timestamp:type_name -> google.protobuf.Timestamp
	49,  // 275: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceData.Snapshot:type_name -> xatu.ClientMeta.ForkChoiceSnapshot
	50,  // 276: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceV2Data.Snapshot:type_name -> xatu.ClientMeta.ForkChoiceSnapshotV2
	49,  // 277: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgData.before:type_name -> xatu.ClientMeta.ForkChoiceSnapshot
	49,  // 278: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgData.after:type_name -> xatu.ClientMeta.ForkChoiceSnapshot
	50,  // 279: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgV2Data.before:type_name -> xatu.ClientMeta.ForkChoiceSnapshotV2
	50,  // 280: xatu.ClientMeta.AdditionalEthV1DebugForkChoiceReOrgV2Data.after:type_name -> xatu.ClientMeta.ForkChoiceSnapshotV2
	4,   // 281: xatu.ClientMeta.AdditionalEthV1BeaconCommitteeData.epoch:type_name -> xatu.EpochV2
	6,   // 282: xatu.ClientMeta.AdditionalEthV1BeaconCommitteeData.slot:type_name -> xatu.SlotV2
	130, // 283: xatu.ClientMeta.AdditionalMempoolTransactionV2Data.nonce:type_name -> google.protobuf.UInt64Value
	130, // 284: xatu.ClientMeta.AdditionalMempoolTransactionV2Data.gas:type_name -> google.protobuf.UInt64Value
	137, // 285: xatu.ClientMeta.AdditionalMempoolTransactionV2Data.type:type_name -> google.protobuf.UInt32Value
	130, // 286: xatu.ClientMeta.AdditionalMempoolTransactionV2Data.blob_gas:type_name -> google.protobuf.UInt64Value
	3,   // 287: xatu.ClientMeta.AdditionalEthV2BeaconBlockData.epoch:type_name -> xatu.Epoch
	5,   // 288: xatu.ClientMeta.AdditionalEthV2BeaconBlockData.slot:type_name -> xatu.Slot
	4,   // 289: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data.epoch:type_name -> xatu.EpochV2
	6,   // 290: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data.slot:type_name -> xatu.SlotV2
	130, // 291: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data.transactions_count:type_name -> google.protobuf.UInt64Value
	130, // 292: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data.transactions_total_bytes:type_name -> google.protobuf.UInt64Value
	130, // 293: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data.transactions_total_bytes_compressed:type_name -> google.protobuf.UInt64Value
	130, // 294: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data.total_bytes:type_name -> google.protobuf.UInt64Value
	130, // 295: xatu.ClientMeta.AdditionalEthV2BeaconBlockV2Data.total_bytes_compressed:type_name -> google.protobuf.UInt64Value
	15,  // 296: xatu.ClientMeta.AdditionalEthV2BeaconBlockAttesterSlashingData.block:type_name -> xatu.BlockIdentifier
	15,  // 297: xatu.ClientMeta.AdditionalEthV2BeaconBlockProposerSlashingData.block:type_name -> xatu.BlockIdentifier
	15,  // 298: xatu.ClientMeta.AdditionalEthV2BeaconBlockVoluntaryExitData.block:type_name -> xatu.BlockIdentifier
	15,  // 299: xatu.ClientMeta.AdditionalEthV2BeaconBlockDepositData.block:type_name -> xatu.BlockIdentifier
	15,  // 300: xatu.ClientMeta.AdditionalEthV2BeaconBlockBLSToExecutionChangeData.block:type_name -> xatu.BlockIdentifier
	15,  // 301: xatu.ClientMeta.AdditionalEthV2BeaconBlockExecutionTransactionData.block:type_name -> xatu.BlockIdentifier
	130, // 302: xatu.ClientMeta.AdditionalEthV2BeaconBlockExecutionTransactionData.position_in_block:type_name -> google.protobuf.UInt64Value
	15,  // 303: xatu.ClientMeta.AdditionalEthV2BeaconBlockWithdrawalData.block:type_name -> xatu.BlockIdentifier
	4,   // 304: xatu.ClientMeta.AdditionalBlockprintBlockClassificationData.epoch:type_name -> xatu.EpochV2
	6,   // 305: xatu.ClientMeta.AdditionalBlockprintBlockClassificationData.slot:type_name -> xatu.SlotV2
	130, // 306: xatu.ClientMeta.AttestationDataSnapshot.requested_at_slot_start_diff_ms:type_name -> google.protobuf.UInt64Value
	130, // 307: xatu.ClientMeta.AttestationDataSnapshot.request_duration_ms:type_name -> google.protobuf.UInt64Value
	131, // 308: xatu.ClientMeta.AttestationDataSnapshot.timestamp:type_name -> google.protobuf.Timestamp
	29,  // 309: xatu.ClientMeta.AdditionalEthV1ValidatorAttestationDataData.source:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationSourceV2Data
	31,  // 310: xatu.ClientMeta.AdditionalEthV1ValidatorAttestationDataData.target:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationTargetV2Data
	4,   // 311: xatu.ClientMeta.AdditionalEthV1ValidatorAttestationDataData.epoch:type_name -> xatu.EpochV2
	6,   // 312: xatu.ClientMeta.AdditionalEthV1ValidatorAttestationDataData.slot:type_name -> xatu.SlotV2
	68,  // 313: xatu.ClientMeta.AdditionalEthV1ValidatorAttestationDataData.Snapshot:type_name -> xatu.ClientMeta.AttestationDataSnapshot
	4,   // 314: xatu.ClientMeta.AdditionalEthV1EventsBlobSidecarData.epoch:type_name -> xatu.EpochV2
	6,   // 315: xatu.ClientMeta.AdditionalEthV1EventsBlobSidecarData.slot:type_name -> xatu.SlotV2
	9,   // 316: xatu.ClientMeta.AdditionalEthV1EventsBlobSidecarData.propagation:type_name -> xatu.PropagationV2
	4,   // 317: xatu.ClientMeta.AdditionalEthV1EventsDataColumnSidecarData.epoch:type_name -> xatu.EpochV2
	6,   // 318: xatu.ClientMeta.AdditionalEthV1EventsDataColumnSidecarData.slot:type_name -> xatu.SlotV2
	9,   // 319: xatu.ClientMeta.AdditionalEthV1EventsDataColumnSidecarData.propagation:type_name -> xatu.PropagationV2
	4,   // 320: xatu.ClientMeta.AdditionalEthV1BeaconBlobSidecarData.epoch:type_name -> xatu.EpochV2
	6,   // 321: xatu.ClientMeta.AdditionalEthV1BeaconBlobSidecarData.slot:type_name -> xatu.SlotV2
	130, // 322: xatu.ClientMeta.AdditionalEthV1BeaconBlobSidecarData.data_size:type_name -> google.protobuf.UInt64Value
	130, // 323: xatu.ClientMeta.AdditionalEthV1BeaconBlobSidecarData.data_empty_size:type_name -> google.protobuf.UInt64Value
	29,  // 324: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.source:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationSourceV2Data
	31,  // 325: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.target:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationTargetV2Data
	6,   // 326: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.slot:type_name -> xatu.SlotV2
	4,   // 327: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.epoch:type_name -> xatu.EpochV2
	9,   // 328: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.propagation:type_name -> xatu.PropagationV2
	11,  // 329: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.attesting_validator:type_name -> xatu.AttestingValidatorV2
	204, // 330: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.peer:type_name -> xatu.libp2p.Peer
	137, // 331: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.subnet:type_name -> google.protobuf.UInt32Value
	205, // 332: xatu.ClientMeta.AdditionalBeaconP2PAttestationData.validated:type_name -> google.protobuf.BoolValue
	4,   // 333: xatu.ClientMeta.AdditionalEthV1ProposerDutyData.epoch:type_name -> xatu.EpochV2
	6,   // 334: xatu.ClientMeta.AdditionalEthV1ProposerDutyData.slot:type_name -> xatu.SlotV2
	15,  // 335: xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData.block:type_name -> xatu.BlockIdentifier
	130, // 336: xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData.position_in_block:type_name -> google.protobuf.UInt64Value
	4,   // 337: xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData.epoch:type_name -> xatu.EpochV2
	6,   // 338: xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData.slot:type_name -> xatu.SlotV2
	29,  // 339: xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData.source:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationSourceV2Data
	31,  // 340: xatu.ClientMeta.AdditionalEthV2BeaconBlockElaboratedAttestationData.target:type_name -> xatu.ClientMeta.AdditionalEthV1AttestationTargetV2Data
	206, // 341: xatu.ClientMeta.AdditionalLibP2PTraceAddPeerData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 342: xatu.ClientMeta.AdditionalLibP2PTraceRemovePeerData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 343: xatu.ClientMeta.AdditionalLibP2PTraceRecvRPCData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 344: xatu.ClientMeta.AdditionalLibP2PTraceSendRPCData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 345: xatu.ClientMeta.AdditionalLibP2PTraceDropRPCData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 346: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIHaveData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 347: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIWantData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 348: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlIDontWantData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 349: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlGraftData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 350: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaControlPruneData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 351: xatu.ClientMeta.AdditionalLibP2PTraceJoinData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 352: xatu.ClientMeta.AdditionalLibP2PTraceLeaveData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 353: xatu.ClientMeta.AdditionalLibP2PTraceGraftData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 354: xatu.ClientMeta.AdditionalLibP2PTracePruneData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 355: xatu.ClientMeta.AdditionalLibP2PTraceDuplicateMessageData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 356: xatu.ClientMeta.AdditionalLibP2PTraceDeliverMessageData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 357: xatu.ClientMeta.AdditionalLibP2PTracePublishMessageData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 358: xatu.ClientMeta.AdditionalLibP2PTraceRejectMessageData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 359: xatu.ClientMeta.AdditionalLibP2PTraceConnectedData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 360: xatu.ClientMeta.AdditionalLibP2PTraceDisconnectedData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 361: xatu.ClientMeta.AdditionalLibP2PTraceSyntheticHeartbeatData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 362: xatu.ClientMeta.AdditionalLibP2PTraceHandleMetadataData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 363: xatu.ClientMeta.AdditionalLibP2PTraceHandleStatusData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 364: xatu.ClientMeta.AdditionalLibP2PTraceRpcDataColumnCustodyProbeData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	4,   // 365: xatu.ClientMeta.AdditionalLibP2PTraceRpcDataColumnCustodyProbeData.epoch:type_name -> xatu.EpochV2
	6,   // 366: xatu.ClientMeta.AdditionalLibP2PTraceRpcDataColumnCustodyProbeData.slot:type_name -> xatu.SlotV2
	4,   // 367: xatu.ClientMeta.AdditionalLibP2PTraceRpcDataColumnCustodyProbeData.wallclock_epoch:type_name -> xatu.EpochV2
	6,   // 368: xatu.ClientMeta.AdditionalLibP2PTraceRpcDataColumnCustodyProbeData.wallclock_slot:type_name -> xatu.SlotV2
	206, // 369: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaSubscriptionData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	206, // 370: xatu.ClientMeta.AdditionalLibP2PTraceRPCMetaMessageData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	4,   // 371: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.epoch:type_name -> xatu.EpochV2
	6,   // 372: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.slot:type_name -> xatu.SlotV2
	4,   // 373: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.wallclock_epoch:type_name -> xatu.EpochV2
	6,   // 374: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.wallclock_slot:type_name -> xatu.SlotV2
	9,   // 375: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.propagation:type_name -> xatu.PropagationV2
	206, // 376: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	207, // 377: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.topic:type_name -> google.protobuf.StringValue
	137, // 378: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.message_size:type_name -> google.protobuf.UInt32Value
	207, // 379: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconBlockData.message_id:type_name -> google.protobuf.StringValue
	4,   // 380: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationSourceData.epoch:type_name -> xatu.EpochV2
	4,   // 381: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationTargetData.epoch:type_name -> xatu.EpochV2
	103, // 382: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.source:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationSourceData
	104, // 383: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.target:type_name -> xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationTargetData
	6,   // 384: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.slot:type_name -> xatu.SlotV2
	4,   // 385: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.epoch:type_name -> xatu.EpochV2
	9,   // 386: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.propagation:type_name -> xatu.PropagationV2
	11,  // 387: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.attesting_validator:type_name -> xatu.AttestingValidatorV2
	4,   // 388: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.wallclock_epoch:type_name -> xatu.EpochV2
	6,   // 389: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.wallclock_slot:type_name -> xatu.SlotV2
	206, // 390: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	207, // 391: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.topic:type_name -> google.protobuf.StringValue
	137, // 392: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.message_size:type_name -> google.protobuf.UInt32Value
	207, // 393: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBeaconAttestationData.message_id:type_name -> google.protobuf.StringValue
	4,   // 394: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.epoch:type_name -> xatu.EpochV2
	6,   // 395: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.slot:type_name -> xatu.SlotV2
	4,   // 396: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.wallclock_epoch:type_name -> xatu.EpochV2
	6,   // 397: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.wallclock_slot:type_name -> xatu.SlotV2
	9,   // 398: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.propagation:type_name -> xatu.PropagationV2
	130, // 399: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.aggregator_index:type_name -> google.protobuf.UInt64Value
	206, // 400: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	207, // 401: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.topic:type_name -> google.protobuf.StringValue
	137, // 402: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.message_size:type_name -> google.protobuf.UInt32Value
	207, // 403: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubAggregateAndProofData.message_id:type_name -> google.protobuf.StringValue
	4,   // 404: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.epoch:type_name -> xatu.EpochV2
	6,   // 405: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.slot:type_name -> xatu.SlotV2
	4,   // 406: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.wallclock_epoch:type_name -> xatu.EpochV2
	6,   // 407: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.wallclock_slot:type_name -> xatu.SlotV2
	9,   // 408: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.propagation:type_name -> xatu.PropagationV2
	206, // 409: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	207, // 410: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.topic:type_name -> google.protobuf.StringValue
	137, // 411: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.message_size:type_name -> google.protobuf.UInt32Value
	207, // 412: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubBlobSidecarData.message_id:type_name -> google.protobuf.StringValue
	4,   // 413: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.epoch:type_name -> xatu.EpochV2
	6,   // 414: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.slot:type_name -> xatu.SlotV2
	4,   // 415: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.wallclock_epoch:type_name -> xatu.EpochV2
	6,   // 416: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.wallclock_slot:type_name -> xatu.SlotV2
	9,   // 417: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.propagation:type_name -> xatu.PropagationV2
	206, // 418: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.metadata:type_name -> xatu.libp2p.TraceEventMetadata
	207, // 419: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.topic:type_name -> google.protobuf.StringValue
	137, // 420: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.message_size:type_name -> google.protobuf.UInt32Value
	207, // 421: xatu.ClientMeta.AdditionalLibP2PTraceGossipSubDataColumnSidecarData.message_id:type_name -> google.protobuf.StringValue
	4,   // 422: xatu.ClientMeta.AdditionalEthV1ValidatorsData.epoch:type_name -> xatu.EpochV2
	208, // 423: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData.relay:type_name -> xatu.mevrelay.Relay
	6,   // 424: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData.slot:type_name -> xatu.SlotV2
	6,   // 425: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData.wallclock_slot:type_name -> xatu.SlotV2
	4,   // 426: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData.epoch:type_name -> xatu.EpochV2
	4,   // 427: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData.wallclock_epoch:type_name -> xatu.EpochV2
	130, // 428: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData.requested_at_slot_time:type_name -> google.protobuf.UInt64Value
	130, // 429: xatu.ClientMeta.AdditionalMevRelayBidTraceBuilderBlockSubmissionData.response_at_slot_time:type_name -> google.protobuf.UInt64Value
	208, // 430: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData.relay:type_name -> xatu.mevrelay.Relay
	6,   // 431: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData.slot:type_name -> xatu.SlotV2
	6,   // 432: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData.wallclock_slot:type_name -> xatu.SlotV2
	4,   // 433: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData.epoch:type_name -> xatu.EpochV2
	4,   // 434: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData.wallclock_epoch:type_name -> xatu.EpochV2
	130, // 435: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData.requested_at_slot_time:type_name -> google.protobuf.UInt64Value
	130, // 436: xatu.ClientMeta.AdditionalMevRelayPayloadDeliveredData.response_at_slot_time:type_name -> google.protobuf.UInt64Value
	4,   // 437: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.epoch:type_name -> xatu.EpochV2
	6,   // 438: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.slot:type_name -> xatu.SlotV2
	130, // 439: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.transactions_count:type_name -> google.protobuf.UInt64Value
	130, // 440: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.transactions_total_bytes:type_name -> google.protobuf.UInt64Value
	130, // 441: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.transactions_total_bytes_compressed:type_name -> google.protobuf.UInt64Value
	130, // 442: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.total_bytes:type_name -> google.protobuf.UInt64Value
	130, // 443: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.total_bytes_compressed:type_name -> google.protobuf.UInt64Value
	130, // 444: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.request_duration_ms:type_name -> google.protobuf.UInt64Value
	131, // 445: xatu.ClientMeta.AdditionalEthV3ValidatorBlockData.requested_at:type_name -> google.protobuf.Timestamp
	208, // 446: xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData.relay:type_name -> xatu.mevrelay.Relay
	6,   // 447: xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData.slot:type_name -> xatu.SlotV2
	6,   // 448: xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData.wallclock_slot:type_name -> xatu.SlotV2
	4,   // 449: xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData.epoch:type_name -> xatu.EpochV2
	4,   // 450: xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData.wallclock_epoch:type_name -> xatu.EpochV2
	130, // 451: xatu.ClientMeta.AdditionalMevRelayValidatorRegistrationData.validator_index:type_name -> google.protobuf.UInt64Value
	4,   // 452: xatu.ClientMeta.AdditionalNodeRecordConsensusData.finalized_epoch:type_name -> xatu.EpochV2
	6,   // 453: xatu.ClientMeta.AdditionalNodeRecordConsensusData.head_slot:type_name -> xatu.SlotV2
	4,   // 454: xatu.ClientMeta.AdditionalNodeRecordConsensusData.head_epoch:type_name -> xatu.EpochV2
	4,   // 455: xatu.ClientMeta.AdditionalConsensusEngineAPINewPayloadData.epoch:type_name -> xatu.EpochV2
	6,   // 456: xatu.ClientMeta.AdditionalConsensusEngineAPINewPayloadData.slot:type_name -> xatu.SlotV2
	4,   // 457: xatu.ClientMeta.AdditionalConsensusEngineAPIGetBlobsData.epoch:type_name -> xatu.EpochV2
	6,   // 458: xatu.ClientMeta.AdditionalConsensusEngineAPIGetBlobsData.slot:type_name -> xatu.SlotV2
	7,   // 459: xatu.ClientMeta.Ethereum.Execution.fork_id:type_name -> xatu.ForkID
	131, // 460: xatu.ServerMeta.Event.received_date_time:type_name -> google.protobuf.Timestamp
	121, // 461: xatu.ServerMeta.Client.geo:type_name -> xatu.ServerMeta.Geo
	121, // 462: xatu.ServerMeta.Peer.geo:type_name -> xatu.ServerMeta.Geo
	123, // 463: xatu.ServerMeta.AdditionalBeaconP2PAttestationData.peer:type_name -> xatu.ServerMeta.Peer
	123, // 464: xatu.ServerMeta.AdditionalLibp2PTraceConnectedData.peer:type_name -> xatu.ServerMeta.Peer
	123, // 465: xatu.ServerMeta.AdditionalLibp2PTraceDisconnectedData.peer:type_name -> xatu.ServerMeta.Peer
	123, // 466: xatu.ServerMeta.AdditionalLibP2PTraceSyntheticHeartbeatData.peer:type_name -> xatu.ServerMeta.Peer
	121, // 467: xatu.ServerMeta.AdditionalNodeRecordConsensusData.geo:type_name -> xatu.ServerMeta.Geo
	121, // 468: xatu.ServerMeta.AdditionalNodeRecordExecutionData.geo:type_name -> xatu.ServerMeta.Geo
	1,   // 469: xatu.EventIngester.CreateEvents:input_type -> xatu.CreateEventsRequest
	2,   // 470: xatu.EventIngester.CreateEvents:output_type -> xatu.CreateEventsResponse
	470, // [470:471] is the sub-list for method output_type
	469, // [469:470] is the sub-list for method input_type
...
func file_pkg_proto_xatu_event_ingester_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_proto_xatu_event_ingester_proto_msgTypes[17].Exporter = func(v any, i int) any {
			switch v := v.(*ExecutionBlockStateMetrics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pkg_proto_xatu_event_ingester_proto_msgTypes[24].OneofWrappers = []any{
		...
		(*DecoratedEvent_ExecutionBlockStateMetrics)(nil),
	}
	type x struct{}
