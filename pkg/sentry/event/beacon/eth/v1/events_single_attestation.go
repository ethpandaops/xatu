...
func NewEventsSingleAttestation(log observability.ContextualLogger, event *electra.SingleAttestation, now time.Time, beacon *ethereum.BeaconNode, duplicateCache *ttlcache.Cache[string, time.Time], clientMeta *xatu.ClientMeta) (*EventsSingleAttestation, error) {
	if event == nil {
