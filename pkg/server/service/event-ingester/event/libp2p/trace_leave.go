...
func NewTraceLeave(log observability.ContextualLogger, event *xatu.DecoratedEvent) *TraceLeave {
	return &TraceLeave{
...
func (tlm *TraceLeave) Validate(ctx context.Context) error {
	if _, ok := tlm.event.Data.(*xatu.DecoratedEvent_Libp2PTraceLeave); !ok {
